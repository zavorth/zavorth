...
const EXAMPLES = [
  ...
  },
  {
    ...
    summary: 'Channel adapter template via bindChannel.',
  },
  {
    id: 'example-provider',
    moduleKind: 'provider',
    ...
    summary: 'Provider complete template via bindProvider.',
  },
  {
    id: 'example-memory',
    moduleKind: 'memory',
  ...
  },
  {
    ...
    summary: 'Media capability template (no network).',
  },
  {
    id: 'example-voice',
    moduleKind: 'voice',
    ...
    summary: 'Voice capability template (no audio I/O).',
  },
  {
    id: 'example-search',
    moduleKind: 'search',
    ...
    summary: 'Search query template (empty results).',
  },
  {
    id: 'example-bridge',
    moduleKind: 'bridge',
    ...
    summary: 'Bridge forward template (no outbound I/O).',
  },
  {
    id: 'example-sandbox',
    moduleKind: 'sandbox',
    ...
    summary: 'Sandbox run template (no process spawn).',
  },
  {
    id: 'example-qa',
    moduleKind: 'qa',
    ...
    summary: 'QA check template (always pass).',
  },
  {
    ...
    summary: 'Workspace info template.',
  },
];
