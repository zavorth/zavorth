...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new ZavorthClient()" to fix this error.`)
    }
    return instance
  }
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global Zavorth configuration settings and preferences.
   */
   ...
   *
   * Update global Zavorth configuration settings and preferences.
   */
...
export class Import extends HeyApiClient {
   ...
   *
   * Import sessions from external AI tools (Claude Code, Codex, zavorth) into zavorth. Idempotent; pass force to re-sync. Per-source failures are not thrown as HTTP errors — they are collected into the corresponding stats.errors[] while other sources continue.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the Zavorth server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the Zavorth system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all Zavorth instances, releasing all resources.
   */
   ...
   * Upgrade zavorth
   *
   * Upgrade zavorth to the specified version or latest if not specified.
   */
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the Zavorth system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the Zavorth system.
   */
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local Zavorth state.
   */
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with Zavorth.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that Zavorth is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by Zavorth.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current Zavorth configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update Zavorth configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all Zavorth sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new Zavorth session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific Zavorth session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current Zavorth instance, releasing all resources.
   */
...
export class Path extends HeyApiClient {
   ...
   * Get paths
   *
   * Retrieve the current working directory and related path information for the Zavorth instance.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the Zavorth system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class ZavorthClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<ZavorthClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    ZavorthClient.__registry.set(this, args?.key)
  }
