import type * as SDK from "@zavorth/sdk/v2"
...
const disabled = process.env["zavorth_DISABLE_SHARE"] === "true" || process.env["zavorth_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@zavorth/ShareNext") {}
