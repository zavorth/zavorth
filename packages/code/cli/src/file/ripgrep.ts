...
import { sanitizedProcessEnv } from "@/util/zavorth-process"
...
export class Service extends Context.Service<Service, Interface>()("@zavorth/Ripgrep") {}
    ...
    Effect.gen(function* () {
      ...
      const tree: Interface["tree"] = Effect.fn("Ripgrep.tree")(function* (input: TreeInput) {
        ...
        for (const file of list) {
          if (file.includes(".zavorth")) continue
