...
export const dict = {
  ...
  "tui.tips.share":
    "Выполните {highlight}/share{/highlight}, чтобы получить публичную ссылку на диалог на zavorth.dev",
  ...
  "tui.tips.config_files":
    "Создайте {highlight}zavorth.json{/highlight} для серверных настроек и {highlight}tui.json{/highlight} для настроек TUI",
  "tui.tips.global_config":
    "Поместите настройки TUI в {highlight}~/.config/zavorth/tui.json{/highlight} как глобальные",
  "tui.tips.schema":
  ...
  "tui.tips.mcp_oauth":
    "zavorth автоматически обрабатывает OAuth для удалённых MCP-серверов с авторизацией",
  "tui.tips.custom_command":
    "Добавляйте файлы {highlight}.md{/highlight} в {highlight}.zavorth/command/{/highlight} для повторно используемых пользовательских команд",
  ...
  "tui.tips.custom_agent":
    "Добавляйте файлы {highlight}.md{/highlight} в {highlight}.zavorth/agent/{/highlight} для специализированных AI-персон",
  ...
  "tui.tips.formatter":
    "zavorth автоматически форматирует файлы с помощью prettier, gofmt, ruff и других инструментов",
  ...
  "tui.tips.lsp": "zavorth использует LSP-серверы для интеллектуального анализа кода",
  "tui.tips.custom_tool":
    "Создавайте файлы {highlight}.ts{/highlight} в {highlight}.zavorth/tools/{/highlight}, чтобы определить новые LLM-инструменты",
  "tui.tips.tool_scripts":
    "Определения инструментов могут вызывать скрипты на Python, Go и других языках",
  "tui.tips.plugins":
    "Добавляйте файлы {highlight}.ts{/highlight} в {highlight}.zavorth/plugin/{/highlight} для подключения хуков событий",
  ...
  "tui.tips.plugin_protect":
    "Создайте плагин, который запретит zavorth читать чувствительные файлы",
  "tui.tips.run":
    "Используйте {highlight}zavorth run{/highlight} для неинтерактивных скриптов",
  "tui.tips.continue":
    "Используйте {highlight}zavorth --continue{/highlight}, чтобы продолжить последнюю сессию",
  "tui.tips.attach_cli":
    "Используйте {highlight}zavorth run -f file.ts{/highlight}, чтобы прикрепить файлы из командной строки",
  "tui.tips.format_json":
    "Используйте {highlight}--format json{/highlight} для машинно-читаемого вывода в скриптах",
  "tui.tips.serve":
    "Запустите {highlight}zavorth serve{/highlight} для headless-доступа к API zavorth",
  "tui.tips.attach_server":
    "Используйте {highlight}zavorth run --attach{/highlight}, чтобы подключиться к запущенному серверу",
  "tui.tips.upgrade":
    "Выполните {highlight}zavorth upgrade{/highlight}, чтобы обновиться до последней версии",
  "tui.tips.auth_list":
    "Выполните {highlight}zavorth auth list{/highlight}, чтобы увидеть всех настроенных провайдеров",
  "tui.tips.agent_create":
    "Выполните {highlight}zavorth agent create{/highlight}, чтобы создать агента в пошаговом режиме",
  "tui.tips.github_trigger":
    "Используйте {highlight}/zavorth{/highlight} в issue/PR на GitHub, чтобы запускать AI-действия",
  "tui.tips.github_install":
    "Выполните {highlight}zavorth github install{/highlight}, чтобы настроить GitHub-workflow",
  "tui.tips.github_oc":
  ...
  "tui.tips.theme_files":
    "Создавайте JSON-файлы тем в каталоге {highlight}.zavorth/themes/{/highlight}",
  ...
  "tui.tips.debug_config":
    "Выполните {highlight}zavorth debug config{/highlight}, чтобы диагностировать проблемы конфигурации",
  "tui.tips.print_logs":
  ...
  "tui.tips.docker":
    "Выполните {highlight}docker run -it --rm ghcr.io/zavorth/cli{/highlight} для контейнерного запуска",
  "tui.tips.zen":
    "Используйте {highlight}/connect{/highlight} с zavorth Code для подобранных и протестированных моделей",
  "tui.tips.agents_md":
  ...
  "tui.command.zavorth.status.title": "Посмотреть статус",
  ...
  "tui.model.zavorth_auto.name": "zavorth Auto (zavorth-V2.5, временно бесплатно)",
  ...
  "tui.voice.error.no_auth": "Используйте /connect для подключения к zavorth или настройте voice.asr_model для другого провайдера",
  ...
  "tui.dialog.login.zavorth_free.desc": "Анонимный бесплатный канал — вход не требуется",
  "tui.dialog.login.zavorth_free.success": "zavorth Auto (free) готов — модель по умолчанию: zavorth/zavorth-auto",
  "tui.dialog.login.zavorth_free.unavailable": "Провайдер zavorth Auto (free) не загружен",
  ...
  "cli.providers.zavorth.recommended_hint": "рекомендуется",
  "cli.providers.zavorth_free.hint": "Анонимный бесплатный канал / zavorth-auto",
  "cli.providers.zavorth_free.verifying": "Проверка канала zavorth Auto (free)...",
  "cli.providers.zavorth_free.ready": "Канал zavorth Auto (free) готов",
  "cli.providers.zavorth_free.failed": "Не удалось проверить zavorth Auto (free)",
  "cli.providers.zavorth_free.default_set": "Модель по умолчанию: zavorth/zavorth-auto (контекст 1M, бесплатно)",
  "cli.providers.zavorth_free.usage_hint":
    "Вход не требуется — просто запустите zavorth. Для платных/премиум-моделей выберите вход через браузер zavorth.",
  "cli.providers.zavorth_login.decrypt_retry": "Ошибка расшифровки, повторите попытку (осталось попыток: {remaining})",
  ...
  "tui.ritual.disabled": "Ритуальная серия скрыта",
  "tui.command.ritual.streak.title": "Переключить ритуальную серию",
  "tui.voice.chip_idle": "[ 🎙  Голос ]",
  "tui.voice.chip_listening": "[ 🎙  {{time}} ]",
  "tui.voice.chip_processing": "[ 🎙  .... ]",
  "tui.voice.rail_label": "голос",
  "tui.command.voice.slash.title": "Переключить голосовой ввод",
  "tui.companion.title": "Companion",
  "tui.companion.online": "онлайн",
  "tui.companion.offline": "офлайн",
  "tui.companion.synced": "синхронизирован",
  "tui.companion.sync_hint": "Синхронизировать состояние companion",
  "tui.command.companion.status.title": "Статус companion",
  "tui.slot.pulse.empty": "Пока нет данных pulse",
