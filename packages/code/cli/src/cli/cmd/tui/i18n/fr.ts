...
export const dict = {
  ...
  "tui.tips.share":
    "Exécutez {highlight}/share{/highlight} pour créer un lien public vers votre conversation avec Zavorth",
  ...
  "tui.tips.config_files":
    "Créez {highlight}zavorth.json{/highlight} pour la configuration serveur et {highlight}tui.json{/highlight} pour le TUI",
  "tui.tips.global_config":
    "Placez les paramètres TUI dans {highlight}~/.config/zavorth/tui.json{/highlight} comme configuration globale",
  ...
  "tui.tips.mcp_oauth":
    "zavorth gère automatiquement OAuth pour les serveurs MCP distants nécessitant une authentification",
  "tui.tips.custom_command":
    "Ajoutez des fichiers {highlight}.md{/highlight} dans {highlight}.zavorth/command/{/highlight} pour définir des invites personnalisées réutilisables",
  ...
  "tui.tips.custom_agent":
    "Ajoutez des fichiers {highlight}.md{/highlight} dans {highlight}.zavorth/agent/{/highlight} pour des personas IA spécialisés",
  ...
  "tui.tips.formatter": "zavorth formate automatiquement les fichiers avec prettier, gofmt, ruff, etc.",
  ...
  "tui.tips.lsp": "zavorth utilise des serveurs LSP pour une analyse de code intelligente",
  "tui.tips.custom_tool":
    "Créez des fichiers {highlight}.ts{/highlight} dans {highlight}.zavorth/tools/{/highlight} pour définir de nouveaux outils LLM",
  "tui.tips.tool_scripts": "Les définitions d'outils peuvent invoquer des scripts en Python, Go, etc.",
  "tui.tips.plugins":
    "Ajoutez des fichiers {highlight}.ts{/highlight} dans {highlight}.zavorth/plugin/{/highlight} pour des hooks d'événements",
  ...
  "tui.tips.plugin_protect":
    "Créez un plugin pour empêcher zavorth de lire des fichiers sensibles",
  "tui.tips.run": "Utilisez {highlight}zavorth run{/highlight} pour des scripts non interactifs",
  "tui.tips.continue": "Utilisez {highlight}zavorth --continue{/highlight} pour reprendre la dernière session",
  "tui.tips.attach_cli":
    "Utilisez {highlight}zavorth run -f file.ts{/highlight} pour joindre des fichiers via la CLI",
  "tui.tips.format_json":
    "Utilisez {highlight}--format json{/highlight} pour une sortie lisible par machine dans les scripts",
  "tui.tips.serve": "Exécutez {highlight}zavorth serve{/highlight} pour exposer l'API zavorth en mode headless",
  "tui.tips.attach_server":
    "Utilisez {highlight}zavorth run --attach{/highlight} pour vous connecter à un serveur en cours",
  "tui.tips.upgrade": "Exécutez {highlight}zavorth upgrade{/highlight} pour passer à la dernière version",
  "tui.tips.auth_list":
    "Exécutez {highlight}zavorth auth list{/highlight} pour voir tous les fournisseurs configurés",
  "tui.tips.agent_create":
    "Exécutez {highlight}zavorth agent create{/highlight} pour créer un agent en mode guidé",
  "tui.tips.github_trigger":
    "Utilisez {highlight}/zavorth{/highlight} dans les issues/PR GitHub pour déclencher des actions IA",
  "tui.tips.github_install":
    "Exécutez {highlight}zavorth github install{/highlight} pour configurer le workflow GitHub",
  "tui.tips.github_oc":
  ...
  "tui.tips.theme_files":
    "Créez des fichiers de thème JSON dans le dossier {highlight}.zavorth/themes/{/highlight}",
  ...
  "tui.tips.debug_config":
    "Exécutez {highlight}zavorth debug config{/highlight} pour diagnostiquer la configuration",
  "tui.tips.print_logs":
  ...
  "tui.tips.docker":
    "Exécutez {highlight}docker run -it --rm ghcr.io/zavorth/cli{/highlight} pour une utilisation conteneurisée",
  "tui.tips.zen":
    "Utilisez {highlight}/connect{/highlight} avec zavorth Code pour des modèles testés et sélectionnés",
  "tui.tips.agents_md":
  ...
  "tui.command.zavorth.status.title": "Voir l'état",
  ...
  "tui.model.zavorth_auto.name": "zavorth Auto (zavorth-V2.5, gratuit pour une durée limitée)",
  ...
  "tui.voice.error.no_auth": "Utilisez /connect pour vous connecter à zavorth, ou configurez voice.asr_model pour un autre fournisseur",
  ...
  "tui.dialog.login.zavorth_free.desc": "Canal anonyme gratuit — aucune connexion requise",
  "tui.dialog.login.zavorth_free.success": "zavorth Auto (free) est prêt — modèle par défaut défini sur zavorth/zavorth-auto",
  "tui.dialog.login.zavorth_free.unavailable": "Fournisseur zavorth Auto (free) non chargé",
  ...
  "cli.providers.zavorth.recommended_hint": "recommandé",
  "cli.providers.zavorth_free.hint": "Canal anonyme gratuit / zavorth-auto",
  "cli.providers.zavorth_free.verifying": "Vérification du canal zavorth Auto (free)...",
  "cli.providers.zavorth_free.ready": "Canal zavorth Auto (free) prêt",
  "cli.providers.zavorth_free.failed": "Échec de la vérification de zavorth Auto (free)",
  "cli.providers.zavorth_free.default_set": "Modèle par défaut défini sur zavorth/zavorth-auto (contexte 1M, gratuit)",
  "cli.providers.zavorth_free.usage_hint":
    "Aucune connexion requise — exécutez simplement zavorth. Pour les modèles payants/premium, choisissez plutôt la connexion navigateur zavorth.",
  "cli.providers.zavorth_login.decrypt_retry": "Échec du déchiffrement, veuillez réessayer ({remaining} tentatives restantes)",
  ...
  "trust.capabilities": "zavorth Code pourra lire, modifier et exécuter des fichiers ici.",
  ...
  "tui.ritual.disabled": "Série rituelle masquée",
  "tui.command.ritual.streak.title": "Basculer la série rituelle",
  "tui.voice.chip_idle": "[ 🎙  Voix ]",
  "tui.voice.chip_listening": "[ 🎙  {{time}} ]",
  "tui.voice.chip_processing": "[ 🎙  .... ]",
  "tui.voice.rail_label": "voix",
  "tui.command.voice.slash.title": "Basculer la saisie vocale",
  "tui.companion.title": "Companion",
  "tui.companion.online": "en ligne",
  "tui.companion.offline": "hors ligne",
  "tui.companion.synced": "synchronisé",
  "tui.companion.sync_hint": "Synchroniser l'état du companion",
  "tui.command.companion.status.title": "Statut du companion",
  "tui.slot.pulse.empty": "Pas encore de données pulse",
