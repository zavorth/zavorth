...
import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@zavorth/sdk/v2"
      ...
      map((provider) => {
        ...
        return {
          ...
          description: {
            ...
            "zavorth-go": "Low cost subscription for everyone",
          }[provider.id],
...
export async function runCustomProviderWizard(opts: {
  ...
  const nameRaw = await step(2, 6, "Display name", "e.g. zavorth Router", providerID)
          ...
          zavorth: (
            <box gap={1}>
              <text fg={theme.textMuted}>
                Zavorth Zen gives you access to all the best coding models at the cheapest prices with a single API
                key.
              </text>
              <text fg={theme.text}>
                Go to <span style={{ fg: theme.primary }}>https://zavorth.dev/zen</span> to get a key
              </text>
            </box>
          ),
          "zavorth-go": (
            <box gap={1}>
              <text fg={theme.textMuted}>
                Zavorth Go is a $10 per month subscription that provides reliable access to popular open coding models
                with generous usage limits.
              </text>
              <text fg={theme.text}>
                Go to <span style={{ fg: theme.primary }}>https://zavorth.dev/zen</span> and enable Zavorth Go
              </text>
            </box>
          ),
