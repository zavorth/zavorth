...
<html>
  ...
  <body>
    <div class="container">
      ...
      <p>You can close this window and return to Zavorth.</p>
    </div>
    <script>
...
export async function CodexAuthPlugin(input: PluginInput): Promise<Hooks> {
  return {
    ...
    "chat.headers": async (input, output) => {
      ...
      output.headers.originator = "zavorth"
      output.headers["User-Agent"] = `zavorth/${InstallationVersion} (${os.platform()} ${os.release()}; ${os.arch()})`
