...
export class Service extends Context.Service<Service, Interface>()("@zavorth/SystemPrompt") {}
  ...
  Effect.gen(function* () {
    ...
    return Service.of({
      environment(model, now) {
        ...
        return [
          [
            `You are zavorth Code Agent, built by the Zavorth Team. You are an interactive agent that helps users with software engineering tasks. Use the instructions below and the tools available to you to assist the user.`,
