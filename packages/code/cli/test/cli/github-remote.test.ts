...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/zavorth.git")).toEqual({ owner: "sst", repo: "zavorth" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/zavorth")).toEqual({ owner: "sst", repo: "zavorth" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/zavorth.git")).toEqual({ owner: "sst", repo: "zavorth" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/zavorth")).toEqual({ owner: "sst", repo: "zavorth" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/zavorth.git")).toEqual({ owner: "sst", repo: "zavorth" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/zavorth")).toEqual({ owner: "sst", repo: "zavorth" })
})
