...
process.env.zavorth_DISABLE_BUILTIN_SKILLS = "true"
...
describe("skill", () => {
  it.live("discovers skills from .zavorth/skill/ directory", () =>
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".zavorth", "skill", "test-skill", "SKILL.md"),
              `---
name: test-skill
      ...
      (dir) =>
        withHome(
          ...
          Effect.gen(function* () {
            yield* Effect.promise(() =>
              Bun.write(
                path.join(dir, ".zavorth", "skill", "dir-skill", "SKILL.md"),
                `---
name: dir-skill
...
`,
            ...
            expect(dirs).toContain(path.join(dir, ".zavorth", "skill", "dir-skill"))
  ...
  it.live("discovers multiple skills from .zavorth/skill/ directory", () =>
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Promise.all([
              Bun.write(
                path.join(dir, ".zavorth", "skill", "skill-one", "SKILL.md"),
                `---
name: skill-one
...
`,
              ...
              Bun.write(
                path.join(dir, ".zavorth", "skill", "skill-two", "SKILL.md"),
                `---
name: skill-two
    ...
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".zavorth", "skill", "no-frontmatter", "SKILL.md"),
              `# No Frontmatter
...
`,
              ...
              Bun.write(
                path.join(dir, ".zavorth", "skill", "agent-skill", "SKILL.md"),
                `---
name: zavorth-skill
description: A skill in the .zavorth/skill directory.
---
...
`,
              ...
              Bun.write(
                path.join(dir, ".zavorth", "skills", "agent-skill", "SKILL.md"),
                `---
name: zavorth-skill
description: A skill in the .zavorth/skills directory.
---
