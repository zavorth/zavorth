...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders ZAVORTH_CALLER", () => {
    process.env["ZAVORTH_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode ZAVORTH_CALLER", () => {
    process.env["ZAVORTH_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown ZAVORTH_CALLER", () => {
    process.env["ZAVORTH_CALLER"] = "unknown"
