...
> Status: documento histórico de exploração. A arquitetura vigente do runtime está em [architecture.md](./architecture.md) e no código de `src/index.ts`, `src/telegram/BotGateway.ts` e `src/telegram/commandCatalog.ts`.
