...
> Status: documento histórico de exploração. Em caso de divergência, prevalecem [architecture.md](./architecture.md), `src/telegram/BotGateway.ts` e `src/telegram/controllers`.
