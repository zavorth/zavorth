...
**Approval**
A confirmation step before Zavorth does something sensitive. Zavorth shows you what it wants to do, you say yes or no. See [Approvals](/docs/product/concepts/approvals).
...
**Skill**
A Markdown file (`SKILL.md`) that teaches Zavorth how to do a specific task. See [Skills](/docs/product/skills).
