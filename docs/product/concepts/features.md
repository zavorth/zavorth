...
<Columns>
  <Card title="Channels" icon="message-square" href="/docs/product/channels">
    Guided setup for Telegram, Discord, WhatsApp, Slack, Signal, iMessage, Teams, Email, and more.
  </Card>
  <Card title="AI models" icon="cpu" href="/docs/product/providers">
    Provider and model routing with readiness checks, live probes, and local fallback options.
  </Card>
  <Card title="Skills" icon="package" href="/docs/product/skills">
  ...
  <Card title="Approvals" icon="shield" href="/docs/product/concepts/approvals">
...
- [Channel setup](/docs/product/channels)
- [Provider setup](/docs/product/providers)
