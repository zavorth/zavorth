...
<Columns>
  <Card title="Get started" href="/docs/product/start/getting-started" icon="rocket">
    Install Zavorth and chat with it in under 5 minutes.
  </Card>
  <Card title="First use" href="/docs/product/start/first-use" icon="play">
    Um caminho simples para instalar, abrir o chat, conectar um modelo e entender aprovacoes.
  </Card>
  <Card title="Set it up your way" href="/docs/product/start/onboarding" icon="sparkles">
    Give Zavorth a name, a personality, and your preferred language.
  </Card>
  <Card title="Open the dashboard" href="/docs/product/interfaces/zavorthcontrol" icon="layout-dashboard">
...
<Columns>
  <Card title="Any channel" icon="message-square" href="/docs/product/channels">
    Telegram, Discord, WhatsApp, Slack, Signal, iMessage, Teams, Email, and more.
  </Card>
  <Card title="Any AI model" icon="cpu" href="/docs/product/providers">
    Gemini, GPT-4o, Claude, DeepSeek, local models — switch anytime without restarting.
  </Card>
  <Card title="Skills" icon="wrench" href="/docs/product/skills">
    Install ready-made skills or teach Zavorth new ones. It learns from your workflows.
  </Card>
  <Card title="Memory" icon="brain" href="/docs/product/concepts/memory">
    Zavorth remembers past decisions, project context, and your preferences — across sessions.
  </Card>
  <Card title="Your identity" icon="user" href="/docs/product/concepts/identity">
...
Want the full guide? See [Getting started](/docs/product/start/getting-started).

## Start here

<Columns>
  <Card title="Docs overview" href="/docs/product/start/what-is-zavorth" icon="book-open">
  ...
  <Card title="Choose a model" href="/docs/product/providers" icon="cpu">
    Gemini, Claude, GPT-4o, DeepSeek, or a local model.
  </Card>
  <Card title="Browse skills" href="/docs/product/skills" icon="package">
    Ready-made and custom skills.
  </Card>
  <Card title="Full feature list" href="/docs/product/concepts/features" icon="list">
    Every capability in one place.
  </Card>
  <Card title="Troubleshooting" href="/docs/product/help/troubleshooting" icon="life-buoy">
