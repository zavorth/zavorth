...
<Columns>
  <Card title="Telegram" href="/docs/product/channels/telegram" icon="send">
    The fastest channel to set up. Just a bot token and an allowlist.
  </Card>
  <Card title="Discord" href="/docs/product/channels/discord" icon="message-square">
    Native bot with slash commands, server allowlists, and doctor proof.
  </Card>
  <Card title="WhatsApp" href="/docs/product/channels/whatsapp" icon="smartphone">
    Cloud API or local Baileys bridge, both proof-gated before live use.
  </Card>
  <Card title="Slack" href="/docs/product/channels/slack" icon="hash">
    Native Slack bot or outbox/stub while setup is incomplete.
  </Card>
  <Card title="Signal" href="/docs/product/channels/signal" icon="lock">
    Local bridge via signal-cli. Dedicated account strongly recommended.
  </Card>
  <Card title="Email" href="/docs/product/channels/email" icon="mail">
...
- [Features](/docs/product/concepts/features)
