...
See [Getting started](/docs/produto/start/getting-started).
...
Telegram, Discord, WhatsApp, Slack, Signal, iMessage, Microsoft Teams, Email — and 20+ more that are catalogued for activation. See [Channels](/docs/produto/canais).
...
A skill is a Markdown file that teaches Zavorth how to do a specific task — like reviewing a PR, booking a calendar slot, or running a deployment. See [Skills](/docs/produto/skills).

### Can Zavorth learn from my habits?

Yes. When Zavorth notices repeated patterns, it suggests a skill. You approve or reject the suggestion. See [Creating skills](/docs/produto/skills/criar).
...
Before Zavorth does anything sensitive — writing files, running commands, sending messages — it shows you a preview and waits. You approve or reject. See [Approvals](/docs/produto/conceitos/aprovacoes).
