...
- the Command Center web surface at `/control`;
...
surface the same governed state as the CLI and Command Center.
...
1. A request enters through CLI, Command Center, API or a channel.
