module.exports = {
  ...
  testPathIgnorePatterns: [
    ...
    '/tests/tools/(ExtendedToolRealExecution|MnemosScopeTools|ReadFileTool|StreamingLLMService|ListDirectoryTool|DesktopAutomationTool\\.security)\\.test\\.ts$',
