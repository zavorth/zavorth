module.exports = {
  ...
  testPathIgnorePatterns: [
    ...
    '/tests/services/(?!ZavorthCapabilityUsageDocsService|ZavorthCapabilityActionSurfaceService|proof/|risk/|approval/|preview/|capability/|migration/|honesty/|memory/).*\\.test\\.ts$',
