module.exports = {
  ...
  testPathIgnorePatterns: [
    ...
    '/tests/services/(?!ZavorthCapabilityUsageDocsService|ZavorthCapabilityActionSurfaceService|ZavorthProductDemoService|ZavorthConnectorExperienceService|proof/|risk/|approval/|preview/|capability/|migration/|honesty/|memory/).*\\.test\\.ts$',
