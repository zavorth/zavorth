module.exports = {
  ...
  testPathIgnorePatterns: [
    ...
    '/tests/services/(?!ZavorthCapabilityUsageDocsService|ZavorthCapabilityActionSurfaceService|ZavorthProductDemoService|ZavorthConnectorExperienceService|ZavorthCliExperienceCertificationService|proof/|risk/|approval/|preview/|capability/|migration/|honesty/|memory/|security/).*\\.test\\.ts$',
