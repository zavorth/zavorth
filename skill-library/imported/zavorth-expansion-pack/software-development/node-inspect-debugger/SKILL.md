...
description: Zavorth-native capability route for Node Inspect Debugger.
---
...
- the user asks for Node Inspect Debugger.
- the task belongs to the software-development capability area.
- nearby skills include systematic-debugging, python-debugpy, debugging-zavorth-tui-commands.
...
- Risk: medium
- Tags: software-development, debugging, nodejs, node-inspect, cdp, breakpoints, ui-tui, node-inspect-debugger, node, inspect, debugger, debug, via
