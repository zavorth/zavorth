...
description: Zavorth-native capability route for Subagent Driven Development.
---
...
- the user asks for Subagent Driven Development.
- the task belongs to the software-development capability area.
- nearby skills include writing-plans, requesting-code-review, test-driven-development.
...
- Risk: high
- Tags: software-development, delegation, subagent, implementation, workflow, parallel, subagent-driven-development, driven, development, execute, plans, via, delegate_task
