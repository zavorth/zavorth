---
name: writing-plans
description: Zavorth-native capability route for Writing Plans.
---
...
- the user asks for Writing Plans.
- the task belongs to the software-development capability area.
- nearby skills include subagent-driven-development, test-driven-development, requesting-code-review.
...
- Risk: high
- Tags: software-development, planning, design, implementation, workflow, documentation, writing-plans, writing, plans, write, bite-sized, tasks
