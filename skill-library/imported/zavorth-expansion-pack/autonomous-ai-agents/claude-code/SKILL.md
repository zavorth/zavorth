---
name: claude-code
description: Zavorth-native capability route for Claude Code.
---
...
- the user asks for Claude Code.
- the task belongs to the autonomous-ai-agents capability area.
- nearby skills include codex, zavorth-agent, opencode.
...
- Risk: high
- Tags: autonomous-ai-agents, coding-agent, claude, anthropic, code-review, refactoring, pty, automation, claude-code, code, delegate, coding, cli
