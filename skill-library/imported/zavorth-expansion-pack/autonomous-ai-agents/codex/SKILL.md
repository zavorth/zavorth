---
name: codex
description: Zavorth-native capability route for Codex.
---
...
- nearby skills include claude-code, zavorth-agent.
...
- Risk: high
- Tags: autonomous-ai-agents, coding-agent, codex, openai, code-review, refactoring, delegate, coding, cli, features
