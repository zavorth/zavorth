---
name: honcho
description: Zavorth-native capability route for Honcho.
---
...
- Risk: high
- Tags: autonomous-ai-agents, honcho, memory, profiles, observation, dialectic, user-modeling, session-summary, configure, and, use, with
