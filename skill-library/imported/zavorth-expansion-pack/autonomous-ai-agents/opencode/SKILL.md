---
name: opencode
description: Zavorth-native capability route for Opencode.
---
...
- Risk: high
- Tags: autonomous-ai-agents, coding-agent, opencode, autonomous, refactoring, code-review, delegate, coding, cli, features, review
