---
name: openhue
description: Zavorth-native capability route for Openhue.
---
...
- the user asks for Openhue.
- the task belongs to the smart-home capability area.
...
- Risk: medium
- Tags: smart-home, hue, lights, iot, automation, openhue, control, philips, scenes, rooms
