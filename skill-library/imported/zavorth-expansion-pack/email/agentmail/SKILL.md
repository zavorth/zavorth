---
name: agentmail
description: Zavorth-native capability route for Agentmail.
---
...
- the user asks for Agentmail.
- the task belongs to the email capability area.
...
- Risk: high
- Tags: email, communication, agentmail, mcp, give, the, agent, its, own, dedicated
