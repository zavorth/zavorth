---
name: linear
description: Zavorth-native capability route for Linear.
---
...
- Risk: high
- Tags: productivity, linear, project-management, issues, graphql, api, manage, projects, teams, via
