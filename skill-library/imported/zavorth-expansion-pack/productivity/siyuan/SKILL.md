---
name: siyuan
description: Zavorth-native capability route for Siyuan.
---
...
- the user asks for Siyuan.
- the task belongs to the productivity capability area.
- nearby skills include obsidian, notion.
...
- Risk: high
- Tags: productivity, siyuan, notes, knowledge-base, pkm, api, note, for, searching, reading
