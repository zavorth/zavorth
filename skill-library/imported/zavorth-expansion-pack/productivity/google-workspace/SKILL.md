...
description: Zavorth-native capability route for Google Workspace.
---
...
- the user asks for Google Workspace.
- the task belongs to the productivity capability area.
- nearby skills include himalaya.
...
- Risk: high
- Tags: productivity, google, gmail, calendar, drive, sheets, docs, contacts, email, oauth, google-workspace, workspace
