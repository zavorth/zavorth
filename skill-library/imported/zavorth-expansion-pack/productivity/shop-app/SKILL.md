---
name: shop-app
description: Zavorth-native capability route for Shop App.
---
...
- the user asks for Shop App.
- the task belongs to the productivity capability area.
- nearby skills include shopify, maps.
...
- Risk: high
- Tags: productivity, shopping, e-commerce, shop-app, products, orders, returns, shop, app, product, search, order
