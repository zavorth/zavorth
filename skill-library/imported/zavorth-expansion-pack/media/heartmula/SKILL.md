---
name: heartmula
description: Zavorth-native capability route for Heartmula.
---
...
- the user asks for Heartmula.
- the task belongs to the media capability area.
- nearby skills include audiocraft.
...
- Risk: medium
- Tags: media, music, audio, generation, ai, heartmula, heartcodec, lyrics, songs, suno-like, song, from
