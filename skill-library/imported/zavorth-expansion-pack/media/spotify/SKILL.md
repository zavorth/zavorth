---
name: spotify
description: Zavorth-native capability route for Spotify.
---
...
- the user asks for Spotify.
- the task belongs to the media capability area.
- nearby skills include gif-search.
...
- Risk: low
- Tags: media, spotify, music, playback, playlists, play, search, queue, manage
