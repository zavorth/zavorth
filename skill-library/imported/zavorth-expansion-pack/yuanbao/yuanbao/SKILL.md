---
name: yuanbao
description: Zavorth-native capability route for Yuanbao.
---
...
- the user asks for Yuanbao.
- the task belongs to the yuanbao capability area.
...
- Risk: medium
- Tags: yuanbao, mention, at, group, members, groups, users, query, info
