---
name: stocks
description: Zavorth-native capability route for Stocks.
---
...
- the user asks for Stocks.
- the task belongs to the finance capability area.
- nearby skills include dcf-model, comps-analysis, lbo-model.
...
- Risk: high
- Tags: finance, stocks, market, crypto, investing, stock, quotes, history, search, compare
