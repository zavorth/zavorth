---
name: merger-model
description: Zavorth-native capability route for Merger Model.
---
...
- the user asks for Merger Model.
...
- Risk: high
- Tags: finance, m-and-a, merger, accretion-dilution, excel, openpyxl, modeling, investment-banking, merger-model, model, build, accretion, dilution, models
