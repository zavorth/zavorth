---
name: pptx-author
description: Zavorth-native capability route for Pptx Author.
---
...
- the user asks for Pptx Author.
- the task belongs to the finance capability area.
- nearby skills include excel-author, powerpoint.
...
- Risk: high
- Tags: finance, powerpoint, pptx, python-pptx, presentation, pptx-author, author, build, decks, headless, with
