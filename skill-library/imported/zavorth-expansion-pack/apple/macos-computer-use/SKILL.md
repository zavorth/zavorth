...
description: Zavorth-native capability route for Macos Computer Use.
---
...
- the user asks for Macos Computer Use.
- the task belongs to the apple capability area.
- nearby skills include browser.
...
- Risk: high
- Tags: apple, computer-use, macos, desktop, automation, gui, macos-computer-use, computer, use
