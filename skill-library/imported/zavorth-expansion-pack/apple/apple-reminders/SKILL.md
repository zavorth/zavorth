...
description: Zavorth-native capability route for Apple Reminders.
---
...
- the user asks for Apple Reminders.
...
- Risk: medium
- Tags: apple, reminders, tasks, todo, macos, apple-reminders, via, remindctl, add
