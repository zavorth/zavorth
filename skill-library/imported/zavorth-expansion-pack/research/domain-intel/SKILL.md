---
name: domain-intel
description: Zavorth-native capability route for Domain Intel.
---
...
- the user asks for Domain Intel.
...
- Risk: high
- Tags: research, domain-intel, domain, intel, passive, reconnaissance, using, python
