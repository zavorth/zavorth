---
name: arxiv
description: Zavorth-native capability route for Arxiv.
---
...
- the user asks for Arxiv.
- the task belongs to the research capability area.
- nearby skills include ocr-and-documents.
...
- Risk: high
- Tags: research, arxiv, papers, academic, science, api, search, keyword, author, category
