---
name: llm-wiki
description: Zavorth-native capability route for Llm Wiki.
---
...
- the user asks for Llm Wiki.
- the task belongs to the research capability area.
- nearby skills include obsidian, arxiv.
...
- Risk: medium
- Tags: research, wiki, knowledge-base, notes, markdown, rag-alternative, llm-wiki, llm, karpathy, build, query
