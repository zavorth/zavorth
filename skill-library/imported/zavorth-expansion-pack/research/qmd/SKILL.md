---
name: qmd
description: Zavorth-native capability route for Qmd.
---
...
- the user asks for Qmd.
- the task belongs to the research capability area.
- nearby skills include obsidian, native-mcp, arxiv.
...
- Risk: medium
- Tags: research, search, knowledge-base, rag, notes, mcp, local-ai, qmd, personal, knowledge, bases, docs
