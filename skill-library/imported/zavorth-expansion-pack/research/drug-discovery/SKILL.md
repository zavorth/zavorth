---
name: drug-discovery
description: Zavorth-native capability route for Drug Discovery.
---
...
- the user asks for Drug Discovery.
...
- Risk: high
- Tags: research, science, chemistry, pharmacology, health, drug-discovery, drug, discovery
