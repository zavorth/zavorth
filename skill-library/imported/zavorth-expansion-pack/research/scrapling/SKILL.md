---
name: scrapling
description: Zavorth-native capability route for Scrapling.
---
...
- the user asks for Scrapling.
- the task belongs to the research capability area.
- nearby skills include duckduckgo-search, domain-intel.
...
- Risk: high
- Tags: research, web-scraping, browser, cloudflare, stealth, crawling, spider, scrapling, web, scraping, with, http, fetching
