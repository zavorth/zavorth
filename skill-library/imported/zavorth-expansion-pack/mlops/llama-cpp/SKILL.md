---
name: llama-cpp
description: Zavorth-native capability route for Llama Cpp.
---
...
- Risk: medium
- Tags: mlops, llama-cpp, gguf, quantization, hugging-face-hub, cpu-inference, apple-silicon, edge-deployment, amd-gpus, intel-gpus, nvidia, url-first, llama, cpp, local, inference
