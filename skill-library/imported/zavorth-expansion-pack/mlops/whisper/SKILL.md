---
name: whisper
description: Zavorth-native capability route for Whisper.
---
...
- Risk: medium
- Tags: mlops, whisper, speech-recognition, asr, multimodal, multilingual, openai, speech-to-text, transcription, translation, audio-processing, general-purpose, speech, recognition, model, supports
