---
name: outlines
description: Zavorth-native capability route for Outlines.
---
...
- Risk: high
- Tags: mlops, prompt-engineering, outlines, structured-generation, json-schema, pydantic, local-models, grammar-based-generation, vllm, transformers, type-safety, structured, json, regex, llm
