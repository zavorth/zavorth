...
description: Zavorth-native capability route for Slime Rl Training.
---
...
- the user asks for Slime Rl Training.
...
- Risk: high
- Tags: mlops, reinforcement-learning, megatron-lm, sglang, grpo, post-training, glm, slime-rl-training, slime, training, provides, guidance, for, llm
