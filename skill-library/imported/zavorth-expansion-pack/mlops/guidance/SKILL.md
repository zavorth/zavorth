---
name: guidance
description: Zavorth-native capability route for Guidance.
---
...
- Risk: high
- Tags: mlops, prompt-engineering, guidance, constrained-generation, structured-output, json-validation, grammar, microsoft-research, format-enforcement, multi-step-workflows, control, llm, output, with, regex, and
