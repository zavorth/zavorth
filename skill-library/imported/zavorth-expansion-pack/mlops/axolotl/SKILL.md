---
name: axolotl
description: Zavorth-native capability route for Axolotl.
---
...
- Risk: medium
- Tags: mlops, fine-tuning, axolotl, llm, lora, qlora, dpo, kto, orpo, grpo, yaml, huggingface, deepspeed, multimodal
