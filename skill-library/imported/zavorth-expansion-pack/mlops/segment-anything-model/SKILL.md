...
description: Zavorth-native capability route for Segment Anything Model.
---
...
- the user asks for Segment Anything Model.
...
- Risk: high
- Tags: mlops, multimodal, image-segmentation, computer-vision, sam, zero-shot, segment-anything-model, segment, anything, model, image, segmentation
