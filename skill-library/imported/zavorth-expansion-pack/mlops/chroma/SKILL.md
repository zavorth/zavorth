---
name: chroma
description: Zavorth-native capability route for Chroma.
---
...
- Risk: medium
- Tags: mlops, rag, chroma, vector-database, embeddings, semantic-search, open-source, self-hosted, document-retrieval, metadata-filtering, embedding, database, for, applications, store
