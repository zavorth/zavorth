...
description: Zavorth-native capability route for Github Code Review.
---
...
- the user asks for Github Code Review.
...
- Risk: high
- Tags: github, code-review, pull-requests, git, quality, github-code-review, code, review, prs, diffs, inline
