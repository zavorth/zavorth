---
name: github-auth
description: Zavorth-native capability route for Github Auth.
---
...
- the user asks for Github Auth.
- the task belongs to the github capability area.
- nearby skills include github-pr-workflow, github-code-review, github-issues, github-repo-management.
...
- Risk: high
- Tags: github, authentication, git, gh-cli, ssh, setup, github-auth, auth, https, tokens
