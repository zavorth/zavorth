...
description: Zavorth-native capability route for Codebase Inspection.
---
...
- the user asks for Codebase Inspection.
- the task belongs to the github capability area.
- nearby skills include github-repo-management.
...
- Risk: medium
- Tags: github, loc, code-analysis, pygount, codebase, metrics, repository, codebase-inspection, inspection, inspect, codebases, languages
