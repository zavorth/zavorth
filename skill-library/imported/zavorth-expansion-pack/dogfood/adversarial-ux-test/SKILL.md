...
description: Zavorth-native capability route for Adversarial Ux Test.
---
...
- the user asks for Adversarial Ux Test.
- the task belongs to the dogfood capability area.
- nearby skills include dogfood.
...
- Risk: high
- Tags: dogfood, qa, ux, testing, adversarial, personas, user-testing, adversarial-ux-test, test, roleplay, the, most, difficult, tech-resistant
