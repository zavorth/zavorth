...
description: Zavorth-native capability route for Architecture Diagram.
---
...
- the user asks for Architecture Diagram.
- the task belongs to the creative capability area.
- nearby skills include concept-diagrams, excalidraw.
...
- Risk: high
- Tags: creative, architecture, diagrams, svg, html, visualization, infrastructure, cloud, architecture-diagram, diagram, dark-themed, infra
