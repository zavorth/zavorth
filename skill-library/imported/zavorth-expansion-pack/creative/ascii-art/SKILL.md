---
name: ascii-art
description: Zavorth-native capability route for Ascii Art.
---
...
- the user asks for Ascii Art.
- the task belongs to the creative capability area.
- nearby skills include excalidraw.
...
- Risk: high
- Tags: creative, ascii, art, banners, unicode, text-art, pyfiglet, figlet, cowsay, boxes, ascii-art
