---
name: sketch
description: Zavorth-native capability route for Sketch.
---
...
- the user asks for Sketch.
- the task belongs to the creative capability area.
- nearby skills include spike, claude-design, popular-web-designs, excalidraw.
...
- Risk: medium
- Tags: creative, sketch, mockup, design, ui, prototype, html, variants, exploration, wireframe, comparison, throwaway, mockups, 2-3
