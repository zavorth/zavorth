---
name: comfyui
description: Zavorth-native capability route for Comfyui.
---
...
- the user asks for Comfyui.
- the task belongs to the creative capability area.
- nearby skills include stable-diffusion-image-generation, image_gen.
...
- Risk: high
- Tags: creative, comfyui, generate, images, video, and, audio, with
