...
description: Zavorth-native capability route for Concept Diagrams.
---
...
- the user asks for Concept Diagrams.
- the task belongs to the creative capability area.
- nearby skills include architecture-diagram, excalidraw, generative-widgets.
...
- Risk: high
- Tags: creative, diagrams, svg, visualization, education, physics, chemistry, engineering, concept-diagrams, concept, generate, flat, minimal, light, dark-aware
