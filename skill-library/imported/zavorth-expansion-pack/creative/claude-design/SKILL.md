---
name: claude-design
description: Zavorth-native capability route for Claude Design.
---
...
- the user asks for Claude Design.
- the task belongs to the creative capability area.
- nearby skills include design-md, popular-web-designs, excalidraw, architecture-diagram.
...
- Risk: high
- Tags: creative, design, html, prototype, ux, ui, artifact, deck, motion, design-system, claude-design, claude, one-off, artifacts, landing
