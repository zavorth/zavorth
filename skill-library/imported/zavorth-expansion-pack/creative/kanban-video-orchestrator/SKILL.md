...
description: Zavorth-native capability route for Kanban Video Orchestrator.
---
...
- the user asks for Kanban Video Orchestrator.
- the task belongs to the creative capability area.
- nearby skills include kanban-orchestrator, kanban-worker, ascii-video, manim-video, p5js.
...
- Risk: medium
- Tags: creative, video, kanban, multi-agent, orchestration, production-pipeline, kanban-video-orchestrator, orchestrator, plan, set, and, monitor
