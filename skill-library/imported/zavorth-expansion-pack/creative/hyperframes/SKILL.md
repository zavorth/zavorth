---
name: hyperframes
description: Zavorth-native capability route for Hyperframes.
---
...
- the user asks for Hyperframes.
- the task belongs to the creative capability area.
- nearby skills include manim-video, meme-generation.
...
- Risk: high
- Tags: creative, video, animation, html, gsap, motion-graphics, hyperframes, create, html-based, compositions, animated, title
