---
name: pokemon-player
description: Zavorth-native capability route for Pokemon Player.
---
...
- the user asks for Pokemon Player.
...
- Risk: high
- Tags: gaming, pokemon, emulator, pyboy, gameplay, gameboy, pokemon-player, player, play, via, headless
