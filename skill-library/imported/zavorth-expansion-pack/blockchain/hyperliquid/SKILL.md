---
name: hyperliquid
description: Zavorth-native capability route for Hyperliquid.
---
...
- the user asks for Hyperliquid.
- the task belongs to the blockchain capability area.
...
- Risk: high
- Tags: blockchain, hyperliquid, crypto, trading, perpetuals, spot, defi, market, data, account, history, trade
