---
name: xurl
description: Zavorth-native capability route for Xurl.
---
...
- the user asks for Xurl.
- the task belongs to the social-media capability area.
...
- Risk: high
- Tags: social-media, twitter, x, xurl, official-api, via, cli, post, search
