...
description: Zavorth-native capability route for Inference Sh Cli.
---
...
- the user asks for Inference Sh Cli.
...
- Risk: medium
- Tags: devops, ai, image-generation, video, llm, search, inference, flux, veo, claude, inference-sh-cli, cli, run, 150, apps, via
