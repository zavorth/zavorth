...
description: Zavorth-native capability route for Webhook Subscriptions.
---
...
- the user asks for Webhook Subscriptions.
...
- Risk: high
- Tags: devops, webhook, events, automation, integrations, notifications, push, webhook-subscriptions, subscriptions, event-driven, agent, runs
