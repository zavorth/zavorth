...
description: Zavorth-native capability route for Kanban Orchestrator.
---
...
- the user asks for Kanban Orchestrator.
- the task belongs to the devops capability area.
- nearby skills include kanban-worker.
...
- Risk: high
- Tags: devops, kanban, multi-agent, orchestration, routing, kanban-orchestrator, orchestrator, decomposition, playbook, anti-temptation, rules, for
