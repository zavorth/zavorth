import { SharedSurfaceParityService } from '../../src/services/SharedSurfaceParityService';

describe('SharedSurfaceParityService', () => {
  it('builds a parity manifest for web, Telegram and Discord', () => {
    const service = new SharedSurfaceParityService({
