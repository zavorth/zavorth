...
describe('RemoteTransportDoctorService', () => {
  ...
  it('writes a persisted report and validates ready remote transports', async () => {
        ...
        buildSnapshot: jest.fn(() => ({
          ...
          entries: [
            ...
            },
            {
              ...
              available: false,
              endpoint: null,
              operatorSummary: 'Disabled on this host.',
              actionHint: null,
              telemetry: {
                updatedAt: null,
                pendingWork: 0,
                lastError: null,
                statusLine: 'Sidecar disabled.',
              },
              details: [],
              actions: [],
            },
          ...
          suggestedActions: [],
          narrative: {
            headline: 'Zavorth exposes remote transports.',
            operatorSummary: 'Remote summary.',
          },
        })),
      } as any,
    });
    ...
    expect(report.summary).toContain('operational pending items');
          ...
          entries: [
            {
              ...
              available: false,
              endpoint: null,
              operatorSummary: 'Discord transport disabled in this runtime.',
              actionHint: null,
              telemetry: {
                updatedAt: null,
                pendingWork: 0,
                lastError: null,
                statusLine: 'Bridge disabled.',
              },
              details: [],
              actions: [],
            },
          ...
          entries: [
            {
              ...
              operatorSummary: 'AIGateway exists locally but has not yet confirmed health readiness.',
              actionHint: '/connect AIGateway',
              telemetry: {
