...
describe('DashboardService integration hub', () => {
  ...
  it('serves the integrations endpoint while the classic dashboard is retired', async () => {
  ...
  it('exposes authenticated integration hub endpoints for the web app', async () => {
    ...
    const [
      ...
      fetchDashboardJson(baseUrl, '/api/web/integrations', { token }),
      fetchDashboardJson(baseUrl, '/api/web/integrations/connect', {
        token,
        init: {
          method: 'POST',
          headers: {
      ...
      fetchDashboardJson(baseUrl, '/api/web/integrations/actions', {
        token,
        init: {
          method: 'POST',
          headers: {
      ...
      fetchDashboardJson(baseUrl, '/api/operations/integrations/actions', {
        init: {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
