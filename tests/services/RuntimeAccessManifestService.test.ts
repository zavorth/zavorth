...
describe('RuntimeAccessManifestService', () => {
  it('builds an operator-friendly manifest from readiness data', async () => {
    const readiness: RuntimeAccessReadinessReport = {
      ...
      recommendations: ['Use o /control local como superficie principal para operar e aprovar o Zavorth.'],
      nextSteps: [
        {
          id: 'connect-remote-frontend',
          title: 'Conectar o frontend remoto',
          description: 'Abra o app publicado e conecte ao runtime.',
          blocking: false,
        },
      ],
    ...
    expect(manifest).toEqual(
      expect.objectContaining({
        ...
        local: expect.objectContaining({
          ...
          controlUrl: 'http://127.0.0.1:33333/control',
        ...
        remote: expect.objectContaining({
          ...
          appUrl: 'https://zavorth.example.com/control',
          requiresHttps: false,
          controlUrl: 'https://zavorth.example.com/control',
        ...
        launchers: expect.arrayContaining([
          expect.objectContaining({
            id: 'best',
            label: 'Abrir Control UI',
            kind: 'url',
            value: 'http://127.0.0.1:33333/control',
            ready: true,
            primary: true,
          }),
          expect.objectContaining({
            ...
            kind: 'url',
            value: 'https://zavorth.example.com/control',
            ready: true,
          }),
          expect.objectContaining({
            id: 'telegram',
        ...
        surfaces: expect.arrayContaining([
          expect.objectContaining({
            ...
            remoteEntry: 'https://zavorth.example.com/control',
            ready: true,
          }),
          expect.objectContaining({
            id: 'telegram',
    ...
    expect(manifest.guides.local[7]).toContain('http://127.0.0.1:33333/control');
  ...
  it('keeps the best launcher command-based when the next official step is still ops:go', () => {
    const readiness: RuntimeAccessReadinessReport = {
      ...
      local: {
        ...
        appUrl: 'http://127.0.0.1:33333/control',
        ready: false,
        issues: ['A superficie web do Zavorth nao respondeu em http://127.0.0.1:33333/control.'],
      },
      remote: {
        baseUrl: 'https://zavorth.example.com',
        appUrl: 'https://zavorth.example.com/control',
  ...
  it('surfaces stale health as warnings and keeps dormant Discord non-blocking', () => {
    const readiness = {
      ...
      recommendations: [],
      nextSteps: [],
      summary: 'Zavorth pronto para uso local com avisos operacionais.',
