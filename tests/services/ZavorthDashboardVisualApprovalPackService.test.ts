import type { ZavorthDashboardProviderCockpitProjection } from '../../src/contracts/ZavorthDashboardProviderCockpitContract.js';
import { ZavorthDashboardVisualApprovalPackService } from '../../src/services/ZavorthDashboardVisualApprovalPackService.js';

describe('ZavorthDashboardVisualApprovalPackService', () => {
...
function cockpitFixture(): ZavorthDashboardProviderCockpitProjection {
  return {
