import { DashboardOperationalSnapshotService } from '../../src/domain/surface/presentation/dashboard/DashboardOperationalSnapshotService.js';

describe('DashboardOperationalSnapshotService', () => {
  it('exposes execution lifecycle as an operational dashboard snapshot', () => {
    const service = new DashboardOperationalSnapshotService();
    const deps = {
