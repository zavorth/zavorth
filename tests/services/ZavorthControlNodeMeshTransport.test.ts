...
describe('ZavorthControl node mesh transport routes', () => {
  ...
  it('exposes node mesh claim, heartbeat and invoke routes across zavorthControl and web surfaces', async () => {
    ...
    const operationsInvokeResult = await fetchZavorthControlJson(baseUrl, '/api/operations/nodes/invoke', {
      token: 'web-secret',
      init: {
        method: 'POST',
        headers: {
    ...
    const webInvokeResult = await fetchZavorthControlJson(baseUrl, '/api/web/nodes/invoke', {
      token: 'web-secret',
      init: {
        method: 'POST',
        headers: {
  ...
  it('protects live node mesh snapshot behind zavorthControl auth', async () => {
    config.zavorthWebAuthToken = 'web-secret';
    const nodeMeshService = {
      buildSnapshot: jest.fn(() => ({
    ...
    const authenticated = await fetchZavorthControlJson(baseUrl, '/api/node-mesh/live/snapshot', {
      token: 'web-secret',
    });
    await service.stopAsync();
  ...
  it('accepts profile-aware pairing drafts through the zavorthControl operations surface', async () => {
    config.zavorthWebAuthToken = 'web-secret';
    ...
    await service.start();
    const result = await fetchZavorthControlJson(service.getUrl(), '/api/operations/nodes/pairing-draft', {
      token: 'web-secret',
      init: {
        method: 'POST',
        headers: {
  ...
  it('supports approve and revoke through the zavorthControl operations surface', async () => {
    config.zavorthWebAuthToken = 'web-secret';
    const nodePairingService = {
    ...
    const approveResult = await fetchZavorthControlJson(baseUrl, '/api/operations/nodes/pairing/approve', {
      token: 'web-secret',
      init: {
        method: 'POST',
        headers: {
    ...
    const approveInvalidResult = await fetchZavorthControlJson(baseUrl, '/api/operations/nodes/pairing/approve', {
      token: 'web-secret',
      init: {
        method: 'POST',
        headers: {
    ...
    const revokeResult = await fetchZavorthControlJson(baseUrl, '/api/operations/nodes/pairing/revoke', {
      token: 'web-secret',
      init: {
        method: 'POST',
        headers: {
    ...
    const revokeInvalidResult = await fetchZavorthControlJson(baseUrl, '/api/operations/nodes/pairing/revoke', {
      token: 'web-secret',
      init: {
        method: 'POST',
        headers: {
  ...
  it('exposes node activity and capabilities through the zavorthControl operations surface', async () => {
    config.zavorthWebAuthToken = 'web-secret';
    const nodeMeshService = {
      buildSnapshot: jest.fn(),
    ...
    const activityResult = await fetchZavorthControlJson(baseUrl, '/api/operations/nodes/oracle-node/activity', {
      token: 'web-secret',
    });
    const capabilitiesResult = await fetchZavorthControlJson(baseUrl, '/api/operations/nodes/oracle-node/capabilities', {
      token: 'web-secret',
    });
  ...
  it('exposes node mesh doctor and recover through the zavorthControl operations surface', async () => {
    ...
    await service.start();
    const baseUrl = service.getUrl();
    const doctorResult = await fetchZavorthControlJson(baseUrl, '/api/operations/nodes/doctor', {
      token: 'web-secret',
    });
    const recoverResult = await fetchZavorthControlJson(baseUrl, '/api/operations/nodes/recover', {
      token: 'web-secret',
      init: {
        method: 'POST',
        headers: {
  ...
  it('allows doctor and recover on the loopback zavorthControl operations surface without explicit token', async () => {
    config.zavorthWebAuthToken = 'web-secret';
    const nodeMeshService = {
      buildSnapshot: jest.fn(() => ({
  ...
  it('exposes approve and revoke through the zavorthControl operations surface', async () => {
    config.zavorthWebAuthToken = 'web-secret';
    const nodePairingService = {
  ...
  it('returns 400 on invalid approve and revoke requests on the zavorthControl operations surface', async () => {
    config.zavorthWebAuthToken = 'web-secret';
    const nodePairingService = {
  ...
  it('queues node host maintenance through the zavorthControl operations recover surface', async () => {
    ...
    await service.start();
    const result = await fetchZavorthControlJson(service.getUrl(), '/api/operations/nodes/recover', {
      token: 'web-secret',
      init: {
        method: 'POST',
        headers: {
  ...
  it('updates approved capabilities on the zavorthControl operations surface', async () => {
    config.zavorthWebAuthToken = 'web-secret';
    const nodePairingService = {
    ...
    await service.start();
    const result = await fetchZavorthControlJson(service.getUrl(), '/api/operations/nodes/oracle-node/approved-capabilities', {
      token: 'web-secret',
      init: {
        method: 'POST',
        headers: {
