...
import { ChannelExperienceParityService } from '../../src/services/ChannelExperienceParityService';
...
describe('ChannelExperienceParityService', () => {
  it('certifies rich channel experience coverage without claiming missing Instagram support', () => {
    ...
    const service = new ChannelExperienceParityService({
      now: () => new Date('2026-05-10T12:00:00.000Z'),
      channelMeshService,
    ...
    expect(snapshot.contractVersion).toBe('channel-experience-parity.v1');
  ...
  it('renders a selected channel parity report for operators', () => {
    const channelMeshService = new ZavorthChannelMeshService({
      channelAdapterRegistryService: {
