import { ZavorthControlContractAdapterService } from '../../src/services/ZavorthControlContractAdapterService';

describe('ZavorthControlContractAdapterService', () => {
  it('builds the ZavorthControl projection from canonical API v1 contracts', async () => {
    const publicApi = {
    ...
    const service = new ZavorthControlContractAdapterService(publicApi as any);
