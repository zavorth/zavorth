import { ZavorthControlOperationsOverviewReaderBridgeService } from '../../src/domain/surface/presentation/zavorthControl/ZavorthControlOperationsOverviewReaderBridgeService.js';

describe('ZavorthControlOperationsOverviewReaderBridgeService', () => {
  it('delegates all canonical overview reads through the shared snapshot service', async () => {
    ...
    const bridge = new ZavorthControlOperationsOverviewReaderBridgeService(getDeps, snapshots);
