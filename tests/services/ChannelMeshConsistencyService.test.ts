...
describe('ChannelMeshConsistencyService Credential vault', () => {
  it('builds channel.message consistency coverage for the private channel inventory', () => {
    const service = new ChannelMeshConsistencyService({
  ...
  it('simulates inbound and outbound envelopes without live channel sends', () => {
    const entry = new ChannelMeshConsistencyService({
      adapterStatuses: [],
