...
function createReadinessReport(overrides: Record<string, any> = {}) {
  const report = {
    ...
    local: { baseUrl: 'http://127.0.0.1:33333', dashboardUrl: 'http://127.0.0.1:33333/', appUrl: 'http://127.0.0.1:33333/control', ready: true, issues: [] },
    remote: { baseUrl: 'https://zavorth.example.com', appUrl: 'https://zavorth.example.com/control', ready: true, issues: [] },
