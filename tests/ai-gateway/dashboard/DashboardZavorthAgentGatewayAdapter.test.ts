...
describe('DashboardZavorthAgentGatewayAdapter', () => {
  it('projects a Universal Agent Runtime snapshot into the Dashboard view model', async () => {
        ...
        memorySignals: [
          {
            ...
            layer: 'semantic',
            summary: 'Prefere Dashboard como entrada oficial.',
            confidence: 0.95,
          },
        ],
        artifacts: [
