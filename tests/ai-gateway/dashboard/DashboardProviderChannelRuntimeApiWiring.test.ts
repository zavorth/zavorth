...
import {
  getChannelRows,
  getProviderRows,
} from '../../../src/ai-gateway/app/(dashboard)/dashboard/dashboardPageClient.utils';
...
describe('Dashboard provider and channel Runtime API v1 wiring', () => {
  ...
  it('routes provider tests and channel actions through governed Dashboard actions', () => {
    ...
    expect(hook).toContain('"/api/web/dashboard/actions"');
