...
describe('Dashboard Run Observatory Run Observatory', () => {
    ...
    const viewModel = buildDashboardDashboardViewModel({
      ...
      runObservatory: {
        ...
        health: {
          status: 'degraded',
          issues: ['1 run falhou.'],
          nextSafeAction: 'Abrir /dashboard?status=failed.',
        ...
        diffPreviews: [
          {
            ...
            actions: {
              ...
              dashboardPath: '/dashboard?runId=run-failed',
            },
          },
        ],
        ...
        surface: {
          dashboardPath: '/dashboard?status=failed',
