...
const controlDir = join(appDir, '(dashboard)/dashboard');

describe('DashboardOfficialEntry', () => {
  ...
  it('removes /dashboard as a routable product entry while keeping internals available for refactor', () => {
