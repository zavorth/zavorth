...
} from '../../../src/ai-gateway/app/(dashboard)/dashboard/dashboard/styles/dashboardVisualContract.js';

const cssPath = join(
  process.cwd(),
  'src/ai-gateway/app/(dashboard)/dashboard/dashboard/styles/dashboard.css',
);

describe('DashboardVisualSystem', () => {
  it('keeps the Dashboard visual tokens from the prototype direction', () => {
