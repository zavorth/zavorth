...
describe('Command Center Run Observatory Run Observatory', () => {
  it('keeps Run Observatory receipts, timeline, replay and health in the dashboard contract', () => {
    const viewModel = buildDashboardCommandCenterViewModel({
      ...
      runObservatory: {
        ...
        health: {
          status: 'degraded',
          issues: ['1 run falhou.'],
          nextSafeAction: 'Abrir /control?status=failed.',
        ...
        diffPreviews: [
          {
            ...
            actions: {
              ...
              approveApplyInstruction: 'Peça ao Zavorth: aplicar rascunho plan-dashboard-diff.',
              ...
              commandCenterPath: '/control?runId=run-failed',
            },
          },
        ],
        ...
        surface: {
          commandCenterPath: '/control?status=failed',
