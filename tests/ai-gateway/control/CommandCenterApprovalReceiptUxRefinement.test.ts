...
import { getApprovals, getReceiptCards } from '../../../src/ai-gateway/app/(dashboard)/control/controlPageClient.utils';
...
describe('Command Center approval inbox and receipt UX refinement', () => {
