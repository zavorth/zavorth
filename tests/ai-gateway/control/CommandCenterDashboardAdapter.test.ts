...
describe('CommandCenterDashboardAdapter', () => {
  it('maps current control state into Command Center contracts without using demo metrics', () => {
      ...
      memoryRecallSources: [
        {
          ...
          layer: 'semantic',
          summary: 'Dashboard fake vira referencia visual oficial.',
          confidence: 0.91,
        },
      ],
      ...
      logs: [
        {
          ...
          level: 'info',
          source: 'runtime',
          message: 'Command Center hidratado.',
