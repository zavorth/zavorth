...
describe('ZavorthControl Release Candidate Pre-Canary Gate Pre-Canary Gate', () => {
  it('projects releaseCandidatePreCanaryGate metadata into the zavorthControl view model', () => {
