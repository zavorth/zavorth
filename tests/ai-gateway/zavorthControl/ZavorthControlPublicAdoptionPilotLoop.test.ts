...
function publicMetadata() {
  return {
    ...
    pilotLoop: {
      ...
      artifacts: { feedbackPreviewPath: '.qa/pilot-loop/feedback-preview-redacted.json', pilotLedgerPath: '.qa/pilot-loop/pilot-ledger.json', zavorthControlPath: '.qa/pilot-loop/support-zavorthControl.json' },
...
describe('ZavorthControl Public Adoption Pilot Loop Public Adoption Pilot', () => {
  it('projects publicAdoptionPilotLoop metadata into the zavorthControl view model', () => {
