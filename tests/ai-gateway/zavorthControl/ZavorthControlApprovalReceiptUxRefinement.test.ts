...
import { getApprovals, getReceiptCards } from '../../../src/zavorth-control/app/(zavorthControl)/control/zavorthControlPageClient.utils';
...
describe('ZavorthControl approval inbox and receipt UX refinement', () => {
  it('prefers Runtime API v1 approvals and receipts over legacy zavorthControl-only snapshots', () => {
    const state = {
      runtimeApiV1: {
        contracts: {
          approvals: {
