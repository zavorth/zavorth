...
describe('ZavorthControl Feedback Telemetry Product Loop Feedback Telemetry', () => {
  it('projects feedbackTelemetryProductLoop metadata into the zavorthControl view model', () => {
