...
describe('ZavorthControlRuntimeProjection', () => {
  it('projects ZavorthAgentGateway snapshots through a formal projection before the ViewModel', async () => {
    ...
    const projection = buildZavorthControlRuntimeProjectionFromZavorthAgentGatewaySnapshot(snapshot);
    const adapterInput = buildZavorthControlAdapterInputFromZavorthAgentGatewaySnapshot(snapshot);
    const adapterInputFromProjection = buildZavorthControlAdapterInputFromZavorthControlRuntimeProjection(projection);
    const viewModel = buildZavorthControlViewModelFromZavorthAgentGatewaySnapshot(snapshot);
  ...
  it('projects Run Observatory queries from the gateway snapshot into the ZavorthControl view model', async () => {
    const gateway = new ZavorthAgentGateway({
  ...
  it('projects automatic subagent decision telemetry for the zavorthControl', async () => {
    const gateway = new ZavorthAgentGateway({
