...
import type { IZavorthTool } from '../../src/tool-runtime/types/IZavorthTool';
import { z } from 'zod';
import {
  isOperatorContinuityEnvelope,
} from '../../src/runtime/operator/OperatorContinuityEnvelope';

jest.mock('../../src/tool-runtime/tools/iot/HomeAssistantBridge', () => ({
...
jest.mock('../../src/tool-runtime/tools/iot/MQTTPublisher', () => ({
