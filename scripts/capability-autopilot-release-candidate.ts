...
function main(): void {
  try {
    ...
    const snapshot = service.buildReleaseCandidateSnapshot(source, {
      ...
      autoPromoteEnabled,
      actorId: 'phase-80-gate',
      releaseCandidateReceiptId: 'phase-80-release-candidate',
      trialReportId: 'phase-80-trial-report',
      incidentReviewId: 'phase-80-incident-review',
      rolloutPlanId: stagedRolloutPlanReady ? 'phase-80-staged-rollout-plan' : null,
      killSwitchReceiptId: killSwitchReady ? 'phase-80-kill-switch' : null,
      telemetryReviewId: telemetryReviewPassed ? 'phase-80-telemetry-review' : null,
      privacyReviewId: privacyReviewPassed ? 'phase-80-privacy-review' : null,
      reason: 'phase-80-release-candidate-gate',
    });
