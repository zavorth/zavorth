...
const steps = [
  ...
  {
    label: 'Fase 5 - Node Mesh 2.0 e companions',
    command: commandFor('npx'),
    args: [
      'jest',
...
console.log('\n[phases-1-6-check] As fases 1 a 6 passaram na validacao oficial.');
