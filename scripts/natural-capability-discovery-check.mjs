...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/ai-gateway/dashboard/DashboardNaturalCapabilityDiscovery.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'dashboard-projects-discovery',
    label: 'Dashboard projects discovery',
    target: '/dashboard reads capabilityDiscovery from runtime metadata and renders recommendations',
    files: [
