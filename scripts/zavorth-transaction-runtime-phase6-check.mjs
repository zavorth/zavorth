...
const env = {
  ...process.env,
  ZAVORTH_TRANSACTION_APPROVAL_SIGNING_KEY: 'phase6-check-signing-key-000000000000000000000000000000',
};
...
const requiredPackageScripts = [
  ...
  'zavorth:transaction-runtime:phase6:check',
...
try {
  ...
  for (const marker of ['zavorth-transaction-runtime/phase-6', 'externalSideEffects: false', 'credential-validation', 'typed-connector']) {
  ...
  if (failures.length > 0) {
    console.error('[transaction-runtime-phase6-check] failed');
  ...
  console.log('[transaction-runtime-phase6-check] ok');
