...
- ZAVORTH_IOS_VERSION = exact canonical iOS version
- ZAVORTH_MARKETING_VERSION = short iOS/App Store version
- ZAVORTH_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
ZAVORTH_IOS_VERSION = ${IOS_VERSION}
ZAVORTH_MARKETING_VERSION = ${MARKETING_VERSION}
ZAVORTH_BUILD_VERSION = ${BUILD_NUMBER}
EOF
