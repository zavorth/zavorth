...
const rules = [
  ...
  ruleContainsAcross({
    id: 'dashboard-projects-run-observatory',
    label: 'Dashboard projects Run Observatory',
    target: '/dashboard preserves receipts, sidecars, timeline, replay and health from the runtime snapshot',
    files: [
