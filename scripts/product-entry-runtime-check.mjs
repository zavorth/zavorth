...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/ai-gateway/dashboard/DashboardProductEntryRuntime.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'dashboard-projects-product-entry-runtime',
    label: 'Dashboard projects product entry runtime',
    target: '/dashboard reads productEntryRuntime and renders first-run/handoff readiness',
    files: [
