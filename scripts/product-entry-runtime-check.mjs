...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/zavorth-control/zavorthControl/ZavorthControlProductEntryRuntime.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'zavorthControl-projects-product-entry-runtime',
    label: 'ZavorthControl projects product entry runtime',
    target: '/zavorthControl reads productEntryRuntime and renders first-run/handoff readiness',
    files: [
    ...
    needles: [
      'ZavorthControlProductEntryRuntimeSnapshot',
      'productEntryRuntime',
