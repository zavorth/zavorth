...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/zavorth-control/zavorthControl/ZavorthControlRunArtifactReceiptReplay.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'zavorthControl-projects-replay-hardening',
    label: 'ZavorthControl projects replay hardening',
    target: '/zavorthControl reads runArtifactReceiptReplay and renders overview/docs surfaces',
    files: [
    ...
    needles: [
      'ZavorthControlRunArtifactReceiptReplaySnapshot',
      'runArtifactReceiptReplay',
