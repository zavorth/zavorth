...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/ai-gateway/dashboard/DashboardRunArtifactReceiptReplay.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'dashboard-projects-replay-hardening',
    label: 'Dashboard projects replay hardening',
    target: '/dashboard reads runArtifactReceiptReplay and renders overview/docs surfaces',
    files: [
