...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/ai-gateway/control/CommandCenterAgentTeamCompiler.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'command-center-projects-agent-team-compiler',
    label: 'Command Center projects Agent Team Compiler',
    target: '/control reads agentTeamCompiler from run metadata and renders it in overview/config surfaces',
    files: [
