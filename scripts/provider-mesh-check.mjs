...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/ai-gateway/control/CommandCenterProviderMeshConsolidation.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'command-center-projects-provider-mesh',
    label: 'Command Center projects Provider Mesh consolidation',
    target: '/control reads providerMeshConsolidation from run metadata and renders overview/config surfaces',
    files: [
