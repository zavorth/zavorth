...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/ai-gateway/dashboard/DashboardProviderMeshConsolidation.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'dashboard-projects-provider-mesh',
    label: 'Dashboard projects Provider Mesh consolidation',
    target: '/dashboard reads providerMeshConsolidation from run metadata and renders overview/config surfaces',
    files: [
