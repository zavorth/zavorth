...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/ai-gateway/dashboard/DashboardAskBeforeAssumptionPolicy.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'dashboard-projects-ask-before-assumption',
    label: 'Dashboard projects Ask Before Assumption Policy',
    target: '/dashboard reads askBeforeAssumptionPolicy from run metadata and renders it in overview/config surfaces',
    files: [
