...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/zavorth-control/zavorthControl/ZavorthControlAskBeforeAssumptionPolicy.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'zavorthControl-projects-ask-before-assumption',
    label: 'ZavorthControl projects Ask Before Assumption Policy',
    target: '/zavorthControl reads askBeforeAssumptionPolicy from run metadata and renders it in overview/config surfaces',
    files: [
    ...
    needles: [
      'ZavorthControlAskBeforeAssumptionPolicySnapshot',
      'askBeforeAssumptionPolicy',
