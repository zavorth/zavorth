...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/ai-gateway/control/CommandCenterFeedbackTelemetryProductLoop.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'command-center-projects-feedback-product-loop',
    label: 'Command Center projects feedback product loop',
    target: '/control reads feedbackTelemetryProductLoop and renders opt-in policy',
    files: [
