...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/ai-gateway/dashboard/DashboardFeedbackTelemetryProductLoop.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'dashboard-projects-feedback-product-loop',
    label: 'Dashboard projects feedback product loop',
    target: '/dashboard reads feedbackTelemetryProductLoop and renders opt-in policy',
    files: [
