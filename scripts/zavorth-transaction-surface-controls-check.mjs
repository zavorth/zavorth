...
const env = {
  ...process.env,
  ZAVORTH_TRANSACTION_APPROVAL_SIGNING_KEY: 'surface-controls-check-signing-key-000000000000000000000000000000',
};
...
const requiredPackageScripts = [
  ...
  'zavorth:transaction-surface:check',
...
try {
  ...
  if (failures.length > 0) {
    console.error('[transaction-surface-surface-controls-check] failed');
  ...
  console.log('[transaction-surface-surface-controls-check] ok');
