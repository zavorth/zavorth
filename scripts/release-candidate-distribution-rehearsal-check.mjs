...
const rules = [
  ...
  ruleContainsAll({
    ...
    target: 'Service consumes Phase 16, models dry-run/operator steps, forbids publication side effects and emits receipts',
...
if (asJson) {
  ...
  console.log('[release-candidate-distribution-rehearsal] checking Phase 17');
