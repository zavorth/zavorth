...
if ($Completions) {
  Write-Host " ${CLR_INFO}$CHAR_INFO Optional Shell Completions:${CLR_RESET}"
  Write-Host "  To enable tab completions, run:"
  Write-Host "   - ${CLR_MUTED}zavorth completions powershell --install${CLR_RESET}"
  Write-Host ""
}
