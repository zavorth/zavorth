...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/ai-gateway/dashboard/DashboardUniversalIntentTrust.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'dashboard-projects-uni-trust',
    label: 'Dashboard projects UNI / Trust enforcement',
    target: '/dashboard reads universalIntentTrustEnforcement and renders overview/config surfaces',
    files: [
