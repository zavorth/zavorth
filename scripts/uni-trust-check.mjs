...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/zavorth-control/zavorthControl/ZavorthControlUniversalIntentTrust.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'zavorthControl-projects-uni-trust',
    label: 'ZavorthControl projects UNI / Trust enforcement',
    target: '/zavorthControl reads universalIntentTrustEnforcement and renders overview/config surfaces',
    files: [
    ...
    needles: [
      'ZavorthControlUniversalIntentTrustEnforcementSnapshot',
      'universalIntentTrustEnforcement',
