...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/ai-gateway/control/CommandCenterCrossChannelContinuity.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'command-center-projects-cross-channel-continuity',
    label: 'Command Center projects Cross-Channel Continuity',
    target: '/control reads crossChannelContinuity from run metadata and renders it in overview/channels surfaces',
    files: [
