...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/ai-gateway/dashboard/DashboardCrossChannelContinuity.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'dashboard-projects-cross-channel-continuity',
    label: 'Dashboard projects Cross-Channel Continuity',
    target: '/dashboard reads crossChannelContinuity from run metadata and renders it in overview/channels surfaces',
    files: [
