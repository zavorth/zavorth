...
const env = {
  ...process.env,
  ZAVORTH_TRANSACTION_APPROVAL_SIGNING_KEY: 'phase9-check-signing-key-000000000000000000000000000000',
};
...
const requiredPackageScripts = [
  ...
  'zavorth:transaction-certification:phase9:check',
...
try {
  ...
  for (const marker of [
    'zavorth-transaction-certification/phase-9',
    'web-trade-approval',
    'secret-redaction',
    'no-live-execution',
  ...
  if (failures.length > 0) {
    console.error('[transaction-certification-phase9-check] failed');
  ...
  console.log('[transaction-certification-phase9-check] ok');
