...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/zavorth-control/zavorthControl/ZavorthControlToolRehearsal.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'zavorthControl-projects-tool-rehearsal',
    label: 'ZavorthControl projects Tool Rehearsal',
    target: '/zavorthControl reads toolRehearsal from run metadata and renders it in skills sector',
    files: [
    ...
    needles: [
      'ZavorthControlToolRehearsalSnapshot',
      'toolRehearsal',
      'buildToolRehearsal',
      'mapToolRehearsal',
      'Tool Rehearsal',
