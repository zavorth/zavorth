...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/ai-gateway/control/CommandCenterToolRehearsal.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'command-center-projects-tool-rehearsal',
    label: 'Command Center projects Tool Rehearsal',
    target: '/control reads toolRehearsal from run metadata and renders it in skills sector',
    files: [
