...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/zavorth-control/zavorthControl/ZavorthControlCapabilityNegotiation.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'zavorthControl-projects-capability-negotiation',
    label: 'ZavorthControl projects Capability Negotiation',
    target: '/zavorthControl reads capabilityNegotiation from run metadata and renders it in skills sector',
    files: [
    ...
    needles: [
      'ZavorthControlCapabilityNegotiationSnapshot',
      'capabilityNegotiation',
