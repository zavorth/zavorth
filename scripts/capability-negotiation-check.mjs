...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/ai-gateway/dashboard/DashboardCapabilityNegotiation.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'dashboard-projects-capability-negotiation',
    label: 'Dashboard projects Capability Negotiation',
    target: '/dashboard reads capabilityNegotiation from run metadata and renders it in skills sector',
    files: [
