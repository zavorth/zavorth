...
const env = {
  ...process.env,
  ZAVORTH_TRANSACTION_APPROVAL_SIGNING_KEY: 'phase3-check-signing-key-000000000000000000000000000000',
};
...
const requiredPackageScripts = [
  ...
  'zavorth:transaction-approval:phase3:check',
...
try {
  ...
  if (failures.length > 0) {
    console.error('[transaction-approval-phase3-check] failed');
