...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/zavorth-control/zavorthControl/ZavorthControlBlueprintCompletion.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'zavorthControl-projects-blueprint-completion',
    label: 'ZavorthControl projects blueprint completion',
    target: '/zavorthControl reads blueprintCompletionGate and renders final gates and safeguards',
    files: [
    ...
    needles: [
      'ZavorthControlBlueprintCompletionGateSnapshot',
      'blueprintCompletionGate',
