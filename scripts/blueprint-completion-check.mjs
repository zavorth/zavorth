...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/ai-gateway/control/CommandCenterBlueprintCompletion.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'command-center-projects-blueprint-completion',
    label: 'Command Center projects blueprint completion',
    target: '/control reads blueprintCompletionGate and renders final gates and safeguards',
    files: [
