...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/ai-gateway/dashboard/DashboardPublicAdoptionPilotLoop.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'dashboard-projects-public-adoption-pilot-loop',
    label: 'Dashboard projects public adoption pilot loop',
    target: '/dashboard reads publicAdoptionPilotLoop and renders pilot policy',
    files: [
