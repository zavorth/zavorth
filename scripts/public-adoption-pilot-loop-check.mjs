...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/ai-gateway/control/CommandCenterPublicAdoptionPilotLoop.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    ...
    target: 'zavorth public-adoption-pilot-loop renders pilot readiness, ledger and dashboard in text or JSON',
    files: [
  ...
  ruleContainsAcross({
    id: 'command-center-projects-public-adoption-pilot-loop',
    label: 'Command Center projects public adoption pilot loop',
    target: '/control reads publicAdoptionPilotLoop and renders pilot policy',
    files: [
