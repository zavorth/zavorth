...
const channels = [
  {
    ...
    requiredGates: ['runtime:check', 'terminal-presentation:check', 'installer-parity:check'],
  ...
  },
  {
    ...
    requiredGates: ['runtime:check', 'terminal-presentation:check', 'installer-parity:check', 'zavorth:cli-approval-diff:check'],
  ...
  },
  {
    ...
    requiredGates: ['runtime:check', 'terminal-presentation:check', 'installer-parity:check', 'zavorth:cli-approval-diff:check', 'security:prepush'],
