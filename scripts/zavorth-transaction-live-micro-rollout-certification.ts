...
type CliOptions = ZavorthTransactionLiveMicroRolloutCertificationInput & {
  json: boolean;
  ledgerFile?: string;
...
const service = new ZavorthTransactionLiveMicroRolloutCertificationService({
...
process.exit(result.status === 'micro-rollout-certified' ? 0 : 1);
