...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/zavorth-control/zavorthControl/ZavorthControlSkillMcpQuarantine.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'zavorthControl-projects-skill-mcp-quarantine',
    label: 'ZavorthControl projects Skill/MCP Quarantine',
    target: '/zavorthControl reads skillMcpQuarantine from run metadata and renders quarantine in skills sector',
    files: [
    ...
    needles: [
      'ZavorthControlSkillMcpQuarantineSnapshot',
      'skillMcpQuarantine',
