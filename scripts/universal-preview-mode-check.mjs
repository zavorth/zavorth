...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/ai-gateway/control/CommandCenterUniversalPreviewMode.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'command-center-projects-preview',
    label: 'Command Center projects Universal Preview',
    target: '/control reads universalPreviewMode from run metadata and renders plan steps',
    files: [
