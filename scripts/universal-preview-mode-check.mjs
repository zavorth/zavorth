...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/zavorth-control/zavorthControl/ZavorthControlUniversalPreviewMode.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'zavorthControl-projects-preview',
    label: 'ZavorthControl projects Universal Preview',
    target: '/zavorthControl reads universalPreviewMode from run metadata and renders plan steps',
    files: [
    ...
    needles: [
      'ZavorthControlUniversalPreviewModeSnapshot',
      'universalPreviewMode',
