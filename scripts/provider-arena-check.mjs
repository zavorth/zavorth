...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/ai-gateway/dashboard/DashboardProviderArena.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'dashboard-projects-provider-arena',
    label: 'Dashboard projects Provider Arena',
    target: '/dashboard reads providerArena from run metadata and renders it in config sector',
    files: [
