...
function ruleFilesExist() {
  ...
  return rule('channel-capability-files', 'Surface controls files exist', missing.length === 0, `${missing.length}/${files.length}`, 'contract, service, CLI, check, tests and docs are present', missing);
}
