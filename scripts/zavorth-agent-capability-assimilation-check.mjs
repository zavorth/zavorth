...
function ruleFilesExist() {
  ...
  return rule('assimilation-files', 'Intent model files exist', missing.length === 0, `${missing.length}/${files.length}`, 'contract, service, CLI, check, tests and docs are present', missing);
}
