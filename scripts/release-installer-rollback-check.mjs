...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/ai-gateway/dashboard/DashboardReleaseInstallerRollbackPath.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'dashboard-projects-release-path',
    label: 'Dashboard projects release path',
    target: '/dashboard reads releaseInstallerRollbackPath and renders release/installer/rollback policy',
    files: [
