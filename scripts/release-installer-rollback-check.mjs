...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/ai-gateway/control/CommandCenterReleaseInstallerRollbackPath.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'command-center-projects-release-path',
    label: 'Command Center projects release path',
    target: '/control reads releaseInstallerRollbackPath and renders release/installer/rollback policy',
    files: [
