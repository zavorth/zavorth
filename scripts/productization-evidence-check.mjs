...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/ai-gateway/dashboard/DashboardProductizationEvidence.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'dashboard-projects-productization-evidence',
    label: 'Dashboard projects productization evidence',
    target: '/dashboard reads productizationEvidence and renders release readiness',
    files: [
