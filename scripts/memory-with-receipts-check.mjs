...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/ai-gateway/dashboard/DashboardMemoryWithReceipts.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'dashboard-projects-memory-with-receipts',
    label: 'Dashboard projects Memory With Receipts',
    target: '/dashboard reads memoryWithReceipts from run metadata and renders provenance in dreams sector',
    files: [
