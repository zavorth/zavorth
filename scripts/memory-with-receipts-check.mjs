...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/zavorth-control/zavorthControl/ZavorthControlMemoryWithReceipts.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'zavorthControl-projects-memory-with-receipts',
    label: 'ZavorthControl projects Memory With Receipts',
    target: '/zavorthControl reads memoryWithReceipts from run metadata and renders provenance in dreams sector',
    files: [
    ...
    needles: [
      'ZavorthControlMemoryWithReceiptsSnapshot',
      'memoryWithReceipts',
