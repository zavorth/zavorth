...
const staticRules = [
  ...
  ruleContainsAcross({
    id: 'intelligence-fabric-dashboard-apply-action',
    label: 'Dashboard can apply governed draft previews',
    ...
    files: [
      ...
      'src/ai-gateway/app/(dashboard)/dashboard/dashboard/components/DashboardOverviewSector.tsx',
  ...
  ruleContainsAcross({
    id: 'intelligence-fabric-risk-3-observability-dashboard',
    label: 'Dashboard shows Risk 3 draft observability before apply',
    ...
    files: [
      ...
      'src/ai-gateway/app/(dashboard)/dashboard/dashboard/contracts/dashboardDashboardObservabilityContracts.ts',
      'src/ai-gateway/app/(dashboard)/dashboard/dashboard/adapters/dashboardDashboardRunObservatory.ts',
      'src/ai-gateway/app/(dashboard)/dashboard/dashboard/components/DashboardOverviewSector.tsx',
    ],
    needles: [
      'draftObservability',
  ...
  ruleContainsAcross({
    id: 'intelligence-fabric-post-default-health-dashboard',
    label: 'Fabric post-default health is exposed in Run Observatory and Dashboard',
    target: 'Run Observatory publishes Fabric health and Dashboard renders status, recommendation, latency and rollback hint',
    files: [
      'src/runtime/agent/RunObservatory.ts',
      'src/ai-gateway/app/(dashboard)/dashboard/dashboard/contracts/dashboardDashboardObservabilityContracts.ts',
      'src/ai-gateway/app/(dashboard)/dashboard/dashboard/adapters/dashboardDashboardRunObservatory.ts',
      'src/ai-gateway/app/(dashboard)/dashboard/dashboard/components/DashboardOverviewSector.tsx',
      'tests/ai-gateway/dashboard/DashboardRunObservatory.test.ts',
  ...
  ruleContainsAcross({
    id: 'intelligence-fabric-controlled-demote-dashboard',
    label: 'Dashboard can request controlled Fabric demotion',
    ...
    files: [
      'src/domain/surface/presentation/web-app/WebAppRuntimeInteractionRouteService.ts',
      'src/ai-gateway/app/(dashboard)/dashboard/dashboard/components/DashboardDemoteFabricAction.ts',
      'src/ai-gateway/app/(dashboard)/dashboard/dashboard/components/DashboardControlShell.tsx',
      'src/ai-gateway/app/(dashboard)/dashboard/dashboard/components/DashboardOverviewSector.tsx',
      'tests/services/WebAppRuntimeInteractionRouteService.test.ts',
    ],
  ...
  ruleContainsAcross({
    ...
    target: 'degraded health leads to explicit Dashboard demotion, request-scoped disabled mode and documented rollback',
    files: [
      'scripts/intelligence-fabric-operational-cycle-gate.ts',
      'docs/README.md',
    ],
    needles: [
      ...
      'dashboard-demote-route-is-owner-confirmed',
...
const dynamicOperationalCycleRule = {
  ...
  target: 'degraded health, Dashboard controlled demote and explicit rollback stay non-destructive and auditable',
