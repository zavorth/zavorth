...
const staticRules = [
  ...
  ruleContainsAcross({
    id: 'intelligence-fabric-zavorthControl-apply-action',
    label: 'ZavorthControl can apply governed draft previews',
    ...
    files: [
      ...
      'src/ai-gateway/app/(zavorthControl)/zavorthControl/zavorthControl/components/ZavorthControlOverviewSector.tsx',
  ...
  ruleContainsAcross({
    id: 'intelligence-fabric-risk-3-observability-zavorthControl',
    label: 'ZavorthControl shows Risk 3 draft observability before apply',
    ...
    files: [
      ...
      'src/ai-gateway/app/(zavorthControl)/zavorthControl/zavorthControl/contracts/zavorthControlZavorthControlObservabilityContracts.ts',
      'src/ai-gateway/app/(zavorthControl)/zavorthControl/zavorthControl/adapters/zavorthControlZavorthControlRunObservatory.ts',
      'src/ai-gateway/app/(zavorthControl)/zavorthControl/zavorthControl/components/ZavorthControlOverviewSector.tsx',
    ],
    needles: [
      'draftObservability',
  ...
  ruleContainsAcross({
    id: 'intelligence-fabric-post-default-health-zavorthControl',
    label: 'Fabric post-default health is exposed in Run Observatory and ZavorthControl',
  ...
  ruleContainsAcross({
    id: 'intelligence-fabric-controlled-demote-zavorthControl',
    label: 'ZavorthControl can request controlled Fabric demotion',
    ...
    files: [
      'src/domain/surface/presentation/web-app/WebAppRuntimeInteractionRouteService.ts',
      'src/ai-gateway/app/(zavorthControl)/zavorthControl/zavorthControl/components/ZavorthControlDemoteFabricAction.ts',
      'src/ai-gateway/app/(zavorthControl)/zavorthControl/zavorthControl/components/ZavorthControlControlShell.tsx',
      'src/ai-gateway/app/(zavorthControl)/zavorthControl/zavorthControl/components/ZavorthControlOverviewSector.tsx',
      'tests/services/WebAppRuntimeInteractionRouteService.test.ts',
    ],
  ...
  ruleContainsAcross({
    ...
    target: 'degraded health leads to explicit ZavorthControl demotion, request-scoped disabled mode and documented rollback',
    files: [
      'scripts/intelligence-fabric-operational-cycle-gate.ts',
      'docs/README.md',
    ],
    needles: [
      ...
      'zavorthControl-demote-route-is-owner-confirmed',
...
const dynamicOperationalCycleRule = {
  ...
  target: 'degraded health, ZavorthControl controlled demote and explicit rollback stay non-destructive and auditable',
