...
const rules = [
  ruleFilesExist({
    ...
    label: 'Remaining Runtime Decisions gate files exist',
  ...
  ruleContainsAll({
    ...
    label: 'Memory artifact consistency closes wiki and vector backend decisions',
    target: 'Memory consistency reports MemoryWikiService and MemoryVectorStore as backend-ready runtime decisions',
  ...
  ruleContainsAll({
    ...
    target: 'Satellite consistency records PWA-first as the signed wrapper strategy',
  ...
  ruleContainsAll({
    ...
    target: 'Tests cover four closed decisions, zero underlying gaps and certified consistency',
    ...
    needles: [
      ...
      'makes the underlying consistency snapshots report zero gaps',
      'sourceP1Gaps: 0',
      'sourceP2Gaps: 0',
    ],
  }),
