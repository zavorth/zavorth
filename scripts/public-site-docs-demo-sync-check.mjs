...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/zavorth-control/zavorthControl/ZavorthControlPublicSiteDocsDemoSync.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'zavorthControl-projects-public-sync',
    label: 'ZavorthControl projects public sync',
    target: '/zavorthControl reads publicSiteDocsDemoSync and renders public preview policy',
    files: [
    ...
    needles: [
      'ZavorthControlPublicSiteDocsDemoSyncSnapshot',
      'publicSiteDocsDemoSync',
