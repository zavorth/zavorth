...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/ai-gateway/dashboard/DashboardPublicSiteDocsDemoSync.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'dashboard-projects-public-sync',
    label: 'Dashboard projects public sync',
    target: '/dashboard reads publicSiteDocsDemoSync and renders public preview policy',
    files: [
