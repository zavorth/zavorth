...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/zavorth-control/zavorthControl/ZavorthControlArtifactMemory.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'zavorthControl-projects-artifact-memory',
    label: 'ZavorthControl projects Artifact Memory',
    target: '/zavorthControl reads artifactMemory from run metadata and renders it in dreams sector',
    files: [
    ...
    needles: [
      'ZavorthControlArtifactMemorySnapshot',
      'artifactMemory',
      'buildArtifactMemory',
      'mapArtifactMemory',
      'Artifact Memory',
