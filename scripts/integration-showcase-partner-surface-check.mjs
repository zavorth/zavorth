...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/ai-gateway/control/CommandCenterIntegrationShowcasePartnerSurface.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'command-center-projects-integration-showcase',
    label: 'Command Center projects integration showcase',
    target: '/control reads integrationShowcasePartnerSurface and renders fixture-first partner policy',
    files: [
