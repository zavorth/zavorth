...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/ai-gateway/dashboard/DashboardIntegrationShowcasePartnerSurface.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'dashboard-projects-integration-showcase',
    label: 'Dashboard projects integration showcase',
    target: '/dashboard reads integrationShowcasePartnerSurface and renders fixture-first partner policy',
    files: [
