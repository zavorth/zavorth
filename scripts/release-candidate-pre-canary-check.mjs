...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/ai-gateway/dashboard/DashboardReleaseCandidatePreCanaryGate.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'dashboard-projects-pre-canary',
    label: 'Dashboard projects pre-canary gate',
    target: '/dashboard reads releaseCandidatePreCanaryGate and renders evidence, Autopilot and no-canary policy',
    files: [
