...
if (failures.length > 0) {
  console.error('[defork-wave3] failed');
...
console.log('[defork-wave3] ok: auth/storage planes, backup compatibility, import validation, and canonical schema guard passed.');
