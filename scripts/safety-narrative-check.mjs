...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/ai-gateway/control/CommandCenterSafetyNarrative.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'command-center-projects-safety-narrative',
    label: 'Command Center projects Safety Narrative',
    target: '/control reads safetyNarrative from run metadata and renders reasons',
    files: [
