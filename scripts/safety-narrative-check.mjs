...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/zavorth-control/zavorthControl/ZavorthControlSafetyNarrative.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'zavorthControl-projects-safety-narrative',
    label: 'ZavorthControl projects Safety Narrative',
    target: '/zavorthControl reads safetyNarrative from run metadata and renders reasons',
    files: [
    ...
    needles: [
      'ZavorthControlSafetyNarrativeSnapshot',
      'safetyNarrative',
