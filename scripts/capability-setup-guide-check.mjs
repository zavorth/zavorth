...
const rules = [
  ruleFilesExist({
    ...
    label: 'Capability Setup Guide Surface controls files exist',
  ...
  ruleContainsAll({
    ...
    target: 'npm scripts expose setup guide CLI and gate',
    files: ['package.json'],
    needles: [
...
if (asJson) {
  ...
  console.log('[capability-setup-guide] checking Surface controls');
