...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/zavorth-control/zavorthControl/ZavorthControlPersonalOpsAutopilot.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'zavorthControl-projects-personal-ops-autopilot',
    label: 'ZavorthControl projects Personal Ops Autopilot',
    target: '/zavorthControl reads personalOpsAutopilot from run metadata and renders it in overview/config surfaces',
    files: [
    ...
    needles: [
      'ZavorthControlPersonalOpsAutopilotSnapshot',
      'personalOpsAutopilot',
