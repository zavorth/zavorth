...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/ai-gateway/dashboard/DashboardPersonalOpsAutopilot.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'dashboard-projects-personal-ops-autopilot',
    label: 'Dashboard projects Personal Ops Autopilot',
    target: '/dashboard reads personalOpsAutopilot from run metadata and renders it in overview/config surfaces',
    files: [
