...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/ai-gateway/control/CommandCenterReleaseAdoptionReadiness.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'command-center-projects-release-adoption',
    label: 'Command Center projects release adoption readiness',
    target: '/control reads releaseAdoptionReadiness and renders release/adoption policy',
    files: [
