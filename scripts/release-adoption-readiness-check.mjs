...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/zavorth-control/zavorthControl/ZavorthControlReleaseAdoptionReadiness.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    id: 'zavorthControl-projects-release-adoption',
    label: 'ZavorthControl projects release adoption readiness',
    target: '/zavorthControl reads releaseAdoptionReadiness and renders release/adoption policy',
    files: [
      'src/zavorth-control/app/(zavorthControl)/control/zavorth-control/contracts/zavorthControlZavorthControlContracts.ts',
      'src/zavorth-control/app/(zavorthControl)/control/zavorth-control/contracts/index.ts',
    ...
    needles: [
      'ZavorthControlReleaseAdoptionReadinessSnapshot',
      'releaseAdoptionReadiness',
