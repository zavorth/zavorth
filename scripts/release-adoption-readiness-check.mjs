...
const rules = [
  ruleFilesExist({
    ...
    files: [
      ...
      'tests/ai-gateway/zavorthControl/ZavorthControlReleaseAdoptionReadiness.test.ts',
      'docs/README.md',
    ],
  }),
  ruleContainsAll({
  ...
  ruleContainsAcross({
    ...
    files: [
      ...
      'src/ai-gateway/app/(zavorthControl)/control/zavorth-control/contracts/index.ts',
