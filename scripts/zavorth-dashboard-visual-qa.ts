...
import { ZavorthDashboardVisualQaService } from '../src/services/ZavorthDashboardVisualQaService.js';
...
async function main(): Promise<void> {
  ...
  if (requireEvidence && !snapshot.summary.evidenceReady) {
    process.stderr.write('Zavorth dashboard visual QA evidence is not complete.\n');
    process.exitCode = 1;
  }
}
