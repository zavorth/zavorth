...
const env = {
  ...process.env,
  ZAVORTH_TRANSACTION_APPROVAL_SIGNING_KEY: 'credential-vault-check-signing-key-000000000000000000000000000000',
};
...
const requiredPackageScripts = [
  ...
  'zavorth:transaction-credential:check',
...
try {
  ...
  if (failures.length > 0) {
    console.error('[transaction-credential-credential-vault-check] failed');
  ...
  console.log('[transaction-credential-credential-vault-check] ok');
