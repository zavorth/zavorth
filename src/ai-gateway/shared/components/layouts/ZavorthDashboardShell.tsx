...
const tabs = [
  { label: "Inbox", href: "/dashboard", exact: true },
  { label: "Tasks", href: "/dashboard/cli-tools" },
  { label: "Approvals", href: "/dashboard/logs" },
  { label: "Providers", href: "/dashboard/providers" },
  { label: "Mnemos", href: "/dashboard/memory" },
  { label: "Gateway", href: "/dashboard/routing" },
...
export default function ZavorthDashboardShell({ children }) {
