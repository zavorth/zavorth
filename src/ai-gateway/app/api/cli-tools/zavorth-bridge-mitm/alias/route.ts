...
export async function GET(request) {
  ...
  } catch (error: unknown) {logger.info("Error fetching MITM aliases:", (error as unknown as Record<string, unknown>).message);
...
export async function PUT(request) {
  ...
  } catch (error: unknown) {logger.info("Error saving MITM aliases:", (error as unknown as Record<string, unknown>).message);
