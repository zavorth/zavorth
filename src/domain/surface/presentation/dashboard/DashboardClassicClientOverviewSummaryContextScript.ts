...
function dashboardClassicClientOverviewSummaryContext() {
...
export function getDashboardClassicClientOverviewSummaryContextScript(): string {
  return extractFunctionBody(dashboardClassicClientOverviewSummaryContext);
}
