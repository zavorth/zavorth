...
function dashboardClassicClientOverviewOperationsCockpit() {
...
export function getDashboardClassicClientOverviewOperationsCockpitScript(): string {
  return extractFunctionBody(dashboardClassicClientOverviewOperationsCockpit);
}
