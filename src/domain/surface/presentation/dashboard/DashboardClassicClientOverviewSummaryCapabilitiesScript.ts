...
function dashboardClassicClientOverviewSummaryCapabilities() {
...
export function getDashboardClassicClientOverviewSummaryCapabilitiesScript(): string {
  return extractFunctionBody(dashboardClassicClientOverviewSummaryCapabilities);
}
