...
export class DashboardClassicAssetService {
  public render(input: DashboardClassicAssetInput): string {
    ...
    const webAppBlock = '<p class="muted" style="margin-top:0;">Entrada web principal: <a href="/dashboard">/dashboard</a>. As antigas rotas /app e /classic foram removidas.</p>';
    ...
    <div id="view-overview" class="view active">
      ...
      <div id="classic-legacy-banner" class="card" style="margin-bottom:24px;">
        <div style="display:grid; gap:8px;">
          ...
          <span class="muted">Use <a href="/dashboard">/dashboard</a> como unica entrada web do Zavorth. As antigas rotas <code>/app</code> e <code>/classic</code> foram removidas.</span>
