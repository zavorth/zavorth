...
export class DashboardClassicAssetService {
  public render(input: DashboardClassicAssetInput): string {
    ...
    const webAppBlock = '<p class="muted" style="margin-top:0;">Entrada web principal: <a href="/dashboard">/dashboard</a>. Este painel classico e interno e so deve existir como fallback de manutencao.</p>';
    ...
    <div id="view-overview" class="view active">
      ...
      <div id="classic-legacy-banner" class="card" style="margin-bottom:24px;">
        <div style="display:grid; gap:8px;">
          ...
          <span class="muted">Use <a href="/dashboard">/dashboard</a> como entrada principal do Zavorth. O shell <code>/app</code> e o classic dashboard ficam escondidos do usuario normal e existem apenas como fallback interno de manutencao.</span>
