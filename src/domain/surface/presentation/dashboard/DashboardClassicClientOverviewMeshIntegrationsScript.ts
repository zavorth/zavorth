...
function dashboardClassicClientOverviewMeshIntegrations() {
...
export function getDashboardClassicClientOverviewMeshIntegrationsScript(): string {
  return extractFunctionBody(dashboardClassicClientOverviewMeshIntegrations);
}
