...
function dashboardClassicClientOverviewMeshTeams() {
...
export function getDashboardClassicClientOverviewMeshTeamsScript(): string {
  return extractFunctionBody(dashboardClassicClientOverviewMeshTeams);
}
