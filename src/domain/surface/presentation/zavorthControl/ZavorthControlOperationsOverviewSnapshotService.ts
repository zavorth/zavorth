  ...
  private buildTrustOverviewFallback(
    ...
    return {
      ...
      cards: [
        {
          ...
          posture: 'attention',
          summary: 'Governance overview in degraded mode.',
        ...
        },
        {
          ...
          label: 'Trust Plane',
          posture: 'attention',
          summary: String(securityMesh?.narrative?.operatorSummary || 'Trust plane partial in zavorthControl.'),
          nextAction: 'Revalidate trust boundary and security mesh.',
          command: '/trust',
          source: 'trust',
        },
        {
          ...
          nextAction: String(tenants?.narrative?.nextAction || 'Complete onboarding of main tenants.'),
          command: '/tenants',
          source: 'tenants',
        },
      ],
      ...
      narrative: {
        ...
        operatorSummary: 'Trust overview in fail-soft mode, preserving essential tenancy and boundary signals.',
        nextAction: String(tenants?.narrative?.nextAction || 'review trust, governance and tenants.'),
      },
    };
  }
  ...
  private async buildProductOverviewFallback(
    ...
    return {
      ...
      cards: [
        {
          ...
          nextAction: 'Revalidate hub and catalogs.',
        ...
        },
        {
          ...
          posture: 'attention',
          summary: `${Number(platform?.summary?.total || 0) || 0} platform entry(s) in fallback.`,
          nextAction: 'Revalidate ecosystem and SDKs.',
        ...
        },
        {
          ...
          nextAction: 'review scorecards and product regressions.',
          command: null,
          source: 'evals',
        },
        {
          ...
          posture: 'attention',
          summary: 'Rollout gate degraded for partial read.',
      ...
      narrative: {
        ...
        operatorSummary: 'Product overview in fail-soft mode, preserving hub, platform and observability signals.',
        nextAction: 'review hub, ecosystem, evals and rollout readiness.',
      },
    };
  }
