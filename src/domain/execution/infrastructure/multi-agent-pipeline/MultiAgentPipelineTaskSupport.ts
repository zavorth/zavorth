...
export class MultiAgentPipelineTaskSupport {
  ...
  public createPlan(
    ...
    return {
      ...
      assumptions: [
        `${stage.label} must act only in the approved workspace.`,
        ...(workspaceContext?.active_focus ? [`Respect the active workspace focus: ${workspaceContext.active_focus.summary}`] : []),
      ],
      ...
      steps: [
        {
          ...
          expected_output: 'Summary of what was done and remaining risk.',
          sensitive: false,
        },
      ],
      validation_steps: [],
      success_condition: 'Stage completes without violating policies.',
