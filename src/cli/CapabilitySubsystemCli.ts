/**
 * Unified CLI for the Universal Capability Subsystem.
 *
...
export async function runCapabilitySubsystemCli(rawArgs: string[] = []): Promise<number> {
...
export { runCapabilitySubsystemCli as runCapabilityFabricCli, runCapabilitySubsystemCli as runImportWorkspaceCli };
