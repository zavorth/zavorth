    ...
    sections: [
      {
        ...
        entries: [
          ...
          { summary: 'Registra provider/modelo como placeholder seguro sem pedir token bruto.' },
          { summary: 'Grava somente arquivos Zavorth-owned depois de resumo e confirmacao.' },
        ],
      },
      {
        title: 'Preview',
      ...
      },
      {
        ...
        entries: [
          ...
          { command: 'zavorth workflows status|process [limit] [--json]', summary: 'Inspeciona ou roda a fila duravel de approvals retomaveis.' },
            ...
            { command: 'zavorth release status [--json]', summary: 'Mostra canal, versao, risco, rollback e presenca remota da Fase 31.' },
    ...
    sections: [
      ...
      },
      {
        ...
        entries: [
          ...
          { command: 'zavorth ops quality [--json] [--live]', summary: 'Resume score operacional, budgets e gates.' },
            ...
            { command: 'zavorth heal --preview|--apply|report [--json]', summary: 'Self-Heal da Fase 30 com probes, outbox, budgets e relatorio diario.' },
            { command: 'zavorth release status|diff|rollback|presence [--json]', summary: 'Fase 31: release channels, changelog, diff, rollback preview e remote presence.' },
      ...
      },
      {
        ...
        entries: [
          ...
          { command: 'zavorth memory review [--json]', summary: 'Mostra o Workspace Memory OS da Fase 29 com retencao e redacao.' },
  ...
  return {
    ...
    sections: [
      ...
      },
      {
        title: 'Safety',
        entries: [
          { command: 'zavorth go --dry-run', summary: 'Preview the launch path without starting anything persistent.' },
          { command: 'zavorth doctor --simple', summary: 'Show the daily-use product doctor with safe sandbox fallback language.' },
          { command: 'zavorth doctor --advanced', summary: 'Show policy, sandbox, mission and receipt details for operators.' },
          { command: 'zavorth doctor --json', summary: 'Read diagnostics from another tool without scraping text.' },
          { summary: 'Sensitive actions stay behind policy, dry-run, approval, and receipts.' },
        ],
      },
    ],
    notesTitle: 'Next',
