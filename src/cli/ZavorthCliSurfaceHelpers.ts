...
const CLI_COMMAND_HELP_PAGES: Record<Exclude<CliHelpTopic, 'root'>, CliHelpPage> = {
  ...
  advanced: {
    ...
    summary: 'Platform / operator surface. Day-to-day users should stay on "zavorth help" (anyone path).',
    sections: [
      {
        title: 'Back to anyone path',
        entries: [
          { command: 'zavorth help', summary: 'Short human entry (setup, ask, learn, ready).' },
          { command: 'zavorth anyone', summary: 'Human product snapshot.' },
          { command: 'zavorth learn', summary: 'Learning digest (same as anyone digest).' },
        ],
      },
      {
