export const ZAVORTH_CAPABILITY_CERTIFICATION_PACK_CONTRACT_VERSION =
  'zavorth-capability-certification-pack/1' as const;
...
export type ZavorthCapabilityCertificationSnapshot = {
  generatedAt: string;
  contractVersion: typeof ZAVORTH_CAPABILITY_CERTIFICATION_PACK_CONTRACT_VERSION;
  ...
  summary: {
    ...
    requiredProviderCertificationRoutes: number;
    missingProviderCertificationRoutes: string[];
