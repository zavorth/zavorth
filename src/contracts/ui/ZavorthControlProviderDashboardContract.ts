...
export const ZAVORTH_ZAVORTH_CONTROL_PROVIDER_DASHBOARD_CONTRACT_VERSION = '2026-05-13.gate-6' as const;
export const ZAVORTH_ZAVORTH_CONTROL_PROVIDER_COCKPIT_CONTRACT_VERSION = ZAVORTH_ZAVORTH_CONTROL_PROVIDER_DASHBOARD_CONTRACT_VERSION;

export type ZavorthControlProviderDashboardStatus = 'ready' | 'attention' | 'blocked';
export type ZavorthControlProviderCockpitStatus = ZavorthControlProviderDashboardStatus;

export type ZavorthControlProviderDashboardAction = {
  id: string;
  label: string;
  command: string;
...
export type ZavorthControlProviderCockpitAction = ZavorthControlProviderDashboardAction;

export type ZavorthControlProviderDashboardCard = {
  id: string;
  providerId: string;
  title: string;
  ...
  actions: ZavorthControlProviderDashboardAction[];
};
export type ZavorthControlProviderCockpitCard = ZavorthControlProviderDashboardCard;
...
export type ZavorthControlProviderCockpitProjection = ZavorthControlProviderDashboardProjection;
