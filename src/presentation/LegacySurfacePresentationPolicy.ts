...
export function renderLegacySurfaceBanner(pathname: string): string | null {
  ...
  return `The ${label} surface is frozen as ${reason}. Use /dashboard as the main entry; new product work must land in the Runtime API, Gateway Contract and official dashboard.`;
}
