...
const STATIC_COMMAND_CATALOG: CommandCatalogEntry[] = [
  ...
  { command: 'ready', description: 'Zavorth Ready To Go: verifica se pode usar remoto agora.', section: 'monitoring', privateMenu: true, groupMenu: true },
  { command: 'stayonline', description: 'Zavorth Stay Online: monitora e avisa se o uso remoto cair.', section: 'monitoring', privateMenu: true, groupMenu: true },
  ...
  { command: 'evals', description: 'Eval observability: scorecards, traces e historico operacional.', section: 'monitoring', usage: '[workspace X|surface Y|executor Z|workflow W]', privateMenu: true, groupMenu: false },
  { command: 'qa', description: 'Budgets, smokes, regressions e release gates da QA release.', section: 'monitoring', usage: '[alpha|beta]', privateMenu: true, groupMenu: false },
  { command: 'governance', description: 'Tenants, trust decisions, allowlists e policy da Governance.', section: 'monitoring', usage: '[limit N]', privateMenu: true, groupMenu: false },
  { command: 'replayloop', description: 'Replay, artifacts reutilizaveis e learning loop da Replay learning.', section: 'monitoring', usage: '[limit N]', privateMenu: true, groupMenu: false },
  { command: 'ecosystem', description: 'SDKs, guides, publish e receitas publicas da Ecosystem.', section: 'monitoring', usage: '[id|filtro]', privateMenu: true, groupMenu: false },
  { command: 'fleet', description: 'Channels, fleet, transports e superficies da Distributed runtime.', section: 'monitoring', usage: '[id|filtro]', privateMenu: true, groupMenu: false },
  ...
  { command: 'setupagent', description: 'Natural setup: setup natural-first de canais por linguagem humana.', section: 'monitoring', usage: '[pedido natural]', privateMenu: true, groupMenu: false },
  { command: 'watchmode', description: 'Watch mode: policy, approvals e replay do Watch Mode supervisionado.', section: 'monitoring', usage: '[status|strict on|strict off|allow-app <janela>|allow-site <host>]', privateMenu: true, groupMenu: false },
  ...
  { command: 'automations', description: 'Scheduled runs: automacoes naturais, maintenance e scheduled runs.', section: 'monitoring', usage: '[status|maintenance on|maintenance off|maintenance run|pause <id>|resume <id>|remove <id>|<pedido natural>]', privateMenu: true, groupMenu: false },
