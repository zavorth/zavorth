...
import { TelegramExecutionDirectService } from './TelegramExecutionDirectService.js';
import type { ToolRuntimeService } from '../../services/tools/ToolRuntimeService.js';
import { TelegramExecutionArtifactDeliveryService } from './TelegramExecutionArtifactDeliveryService.js';
import { TelegramExecutionGatewayPlanService } from './TelegramExecutionGatewayPlanService.js';
import { TelegramExecutionGatewaySubmissionService } from './TelegramExecutionGatewaySubmissionService.js';
import { TelegramExecutionLifecycleService } from './TelegramExecutionLifecycleService.js';
import { TelegramExecutionPlannedTaskService } from './TelegramExecutionPlannedTaskService.js';
import { TelegramExecutionPlanningService } from './TelegramExecutionPlanningService.js';
import { TelegramExecutionResearchService } from './TelegramExecutionResearchService.js';
import { TelegramExecutionResultService } from './TelegramExecutionResultService.js';
import { isExternalCommand } from '../ExternalExecutorIdentity.js';
...
export class TelegramExecutionController {
  ...
  private formatExecutionOutput(label: string, workspace: string, result: any): string {
  ...
  private storeExecutionResult(task: Task, result: any): void {
