...
type TelegramGroupAdminWarnServiceDeps = {
  warnService: WarnService;
  moderationService: GroupModerationService;
};

export class TelegramGroupAdminWarnService {
  constructor(private readonly deps: TelegramGroupAdminWarnServiceDeps) {}
