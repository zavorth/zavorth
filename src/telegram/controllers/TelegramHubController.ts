...
import { TelegramHubActionService } from './TelegramHubActionService.js';
import { HubSection, TelegramHubRenderService } from './TelegramHubRenderService.js';
...
export type TelegramHubControllerDeps = {
  ...
  getHealthStats: () => any;
  formatSystemStatusReply: (stats: any) => string;
