...
export class WorkspaceApplyPatchTool extends BaseTool {
  ...
  public readonly description = 'Prepares a unified patch in the workspace through Disk Mutation Gate; apply requires approval and receipt.';
  public readonly parameters: ToolDefinition['parameters'] = {
    type: 'object',
    properties: {
      filepath: {
        type: 'string',
        description: 'Relative path inside the workspace write scope.',
      },
      patch: {
        type: 'string',
      ...
      dryRun: {
        type: 'boolean',
        description: 'Mantido por compatibilidade; o gate sempre retorna preview without gravar before do approval.',
      },
      previewId: {
        type: 'string',
      ...
      approvalPhrase: {
        type: 'string',
        description: 'Exact approval phrase required by the Disk Mutation Gate.',
      },
    },
    required: [],
  };
  ...
  public async execute(args: Record<string, unknown>): Promise<string> {
    ...
    return JSON.stringify({
          ...
          error: errorMessage(error, 'Failed to apply preview through the Disk Mutation Gate.'),
        });
  }
    }
