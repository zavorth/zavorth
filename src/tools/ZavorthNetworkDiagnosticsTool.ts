...
export class ZavorthNetworkDiagnosticsTool extends BaseTool {
  ...
  private async traceroute(args: Record<string, unknown>): Promise<string> {
    ...
    try {
      ...
      return `Traceroute error: ${error instanceof Error ? error.message : String(error)}`;
    }
  }
  ...
  private async portScan(args: Record<string, unknown>): Promise<string> {
    ...
    try {
      ...
      return `Port scan error: ${error instanceof Error ? error.message : String(error)}`;
    }
  }
  ...
  private async dnsLookup(args: Record<string, unknown>): Promise<string> {
    ...
    try {
      ...
      return `DNS error: ${error instanceof Error ? error.message : String(error)}`;
    }
  }
  ...
  private async sslCheck(args: Record<string, unknown>): Promise<string> {
    ...
    try {
      ...
      return `SSL check error: ${error instanceof Error ? error.message : String(error)}`;
    }
  }
  ...
  private async speedTest(args: Record<string, unknown>): Promise<string> {
    try {
      ...
      return `Speed test error: ${error instanceof Error ? error.message : String(error)}`;
    }
  }
  ...
  private async latencyTest(args: Record<string, unknown>): Promise<string> {
    ...
    try {
      ...
      return `Latency test error: ${error instanceof Error ? error.message : String(error)}`;
    }
  }
  ...
  private async bandwidthMonitor(args: Record<string, unknown>): Promise<string> {
    ...
    try {
      ...
      return `Bandwidth monitor error: ${error instanceof Error ? error.message : String(error)}`;
    }
  }
  ...
  private async mtr(args: Record<string, unknown>): Promise<string> {
    ...
    try {
      ...
      return `MTR error: ${error instanceof Error ? error.message : String(error)}`;
    }
  }
  ...
  private async dig(args: Record<string, unknown>): Promise<string> {
    ...
    try {
      ...
      return `DIG error: ${error instanceof Error ? error.message : String(error)}`;
    }
  }
  ...
  private async curlDebug(args: Record<string, unknown>): Promise<string> {
    ...
    try {
      ...
      return `CURL debug error: ${error instanceof Error ? error.message : String(error)}`;
    }
  }
  ...
  private async tcpCheck(args: Record<string, unknown>): Promise<string> {
    ...
    try {
      ...
      return `TCP ${host}:${port} is CLOSED or TIMEOUT`;
    }
  }
  ...
  private async httpHeaders(args: Record<string, unknown>): Promise<string> {
    ...
    try {
      ...
      return `HTTP headers error: ${error instanceof Error ? error.message : String(error)}`;
    }
  }
}
