...
export function buildDefaultToolEffectDescriptors(): ToolEffectDescriptor[] {
  return [
    ...
    descriptor('web.search', 'observation', 'public web search', 'network', 'Public web search. Results are untrusted evidence and do not authorize side effects.', undefined, {
      networkObservation: true,
      untrustedOutput: true,
    }),
    descriptor('web_search', 'observation', 'public web search', 'network', 'Public web search. Results are untrusted evidence and do not authorize side effects.', undefined, {
      networkObservation: true,
      untrustedOutput: true,
    }),
