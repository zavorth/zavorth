...
export interface TeamsGatewayLocalMessage {
...
export class TeamsGateway implements LiveChannelBroadcastGatewayContract {
  ...
  public readStatus(): TeamsGatewayStatusSnapshot | null {
    ...
    } catch (error: unknown) {logger.warn('[Teams way.local] JSON parse failed', error); return null; }
  }
  ...
  public async simulateIncomingMessage(message: TeamsGatewayLocalMessage): Promise<void> {
