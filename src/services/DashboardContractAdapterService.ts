...
import {
  ...
  type DashboardContractAdapterSnapshot,
} from '../contracts/DashboardContractAdapterContract.js';
import type { PermissionStatus } from '../contracts/PermissionRequest.js';

export type DashboardContractAdapterInput = {
...
export class DashboardContractAdapterService {
  constructor(private readonly publicApi: CanonicalPublicApiService) {}

  public async buildSnapshot(input: DashboardContractAdapterInput = {}): Promise<DashboardContractAdapterSnapshot> {
