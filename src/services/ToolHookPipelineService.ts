...
const BUILTIN_EVENTS = [
  ...
  { name: 'session.before_send', label: 'Antes de enviar para uma session', scope: 'session' as const },
  { name: 'session.after_send', label: 'Depois de enviar para uma session', scope: 'session' as const },
  { name: 'session.before_spawn', label: 'Antes de abrir uma nova session', scope: 'session' as const },
  { name: 'session.after_spawn', label: 'Depois de abrir uma nova session', scope: 'session' as const },
  { name: 'tool.before_execute', label: 'Antes de run uma tool', scope: 'tool' as const },
  { name: 'tool.after_execute', label: 'Depois de run uma tool', scope: 'tool' as const },
  ...
  { name: 'integration.before_action', label: 'Antes de acionar uma integration', scope: 'integration' as const },
  { name: 'integration.after_action', label: 'Depois de acionar uma integration', scope: 'integration' as const },
  ...
  { name: 'transport.before_action', label: 'Antes de acionar um transporte remote', scope: 'transport' as const },
  { name: 'transport.after_action', label: 'Depois de acionar um transporte remote', scope: 'transport' as const },
  { name: 'llm.before_request', label: 'Antes de chamar o LLM', scope: 'runtime' as const },
  { name: 'llm.after_request', label: 'Depois de chamar o LLM', scope: 'runtime' as const },
  { name: 'agent.before_turn', label: 'Antes do turn do agente', scope: 'runtime' as const },
