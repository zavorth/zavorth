  ...
  private addManualCapabilities(capabilities: CapabilityEntry[]): void {
    const manual: Array<Omit<CapabilityEntry, 'discoveredAt'>> = [
      ...
      },
      {
        ...
        category: 'agent',
        description: 'Register, manage, and invoke external agents (Claude, Codex, Hermes, OpenClaw, any CLI/HTTP/ACP agent)',
        status: 'available',
      ...
      },
      {
        ...
        category: 'media',
        description: 'Render interactive UI components in chat (like OpenClaw Live Canvas)',
        status: 'available',
        source: 'src/canvas/',
