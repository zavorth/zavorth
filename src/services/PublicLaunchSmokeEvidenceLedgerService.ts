  ...
  private entries(): PublicLaunchSmokeEvidenceEntry[] {
    return [
      ...
      dryEntry({
        ...
        evidence: 'Provider Mesh parity gate proves provider routes without live provider calls.',
        dependsOn: ['release-profile-hardening'],
      }),
      dryEntry({
        ...
        evidence: 'Channel Mesh parity gate proves connector routes without live sends.',
        dependsOn: ['release-profile-hardening'],
      }),
      dryEntry({
        ...
        evidence: 'Satellite PWA parity gate proves pairing, heartbeat, offline queue, and browser capability coverage.',
        dependsOn: ['release-profile-hardening'],
      }),
      dryEntry({
        ...
        evidence: 'Memory and artifact parity gate proves receipts, replay, wiki, and vector backend decisions.',
        dependsOn: ['release-profile-hardening'],
      }),
      dryEntry({
