...
const ENVELOPE_SCHEMAS: ZavorthExternalRuntimeEnvelopeSchema[] = [
  schema('runtime', 'ZavorthExternalRuntimeDescriptorContract', 'ZavorthExternalRuntimeDescriptorService', 'CommandCenterExternalRuntimeDescriptor', ['kind', 'sourceRuntimeId', 'sourceRef'], 'capability-discovery', 'medium', false, true, ['source_identity_leak', 'missing_provenance']),
  schema('capability', 'ZavorthExternalCapabilityEnvelopeContract', 'ZavorthExternalCapabilityEnvelopeService', 'CommandCenterExternalCapabilityEnvelope', ['kind', 'sourceRuntimeId', 'sourceRef', 'provenance.evidence'], 'capability-discovery', 'medium', false, true, ['source_identity_leak', 'missing_provenance']),
  schema('skill', 'ZavorthExternalSkillEnvelopeContract', 'ZavorthExternalSkillEnvelopeService', 'CommandCenterExternalSkillEnvelope', ['kind', 'sourceRuntimeId', 'sourceRef', 'provenance.evidence'], 'capability-discovery', 'high', true, true, ['direct_tool_exposure', 'live_execution_requested', 'missing_provenance']),
  schema('tool', 'ZavorthExternalToolEnvelopeContract', 'ZavorthExternalToolEnvelopeService', 'CommandCenterExternalToolEnvelope', ['kind', 'sourceRuntimeId', 'sourceRef', 'provenance.evidence'], 'tool-preview', 'high', true, true, ['direct_tool_exposure', 'raw_secret_value', 'live_execution_requested']),
  schema('channel', 'ZavorthExternalChannelEnvelopeContract', 'ZavorthExternalChannelEnvelopeService', 'CommandCenterExternalChannelEnvelope', ['kind', 'sourceRuntimeId', 'sourceRef', 'provenance.evidence'], 'capability-discovery', 'high', true, true, ['source_identity_leak', 'raw_secret_value', 'live_execution_requested']),
  schema('session', 'ZavorthExternalSessionEnvelopeContract', 'ZavorthExternalSessionEnvelopeService', 'CommandCenterExternalSessionEnvelope', ['kind', 'sourceRuntimeId', 'sourceRef', 'provenance.evidence'], 'memory-recall', 'medium', false, true, ['source_identity_leak', 'missing_provenance']),
  schema('event', 'ZavorthExternalEventEnvelopeContract', 'ZavorthExternalEventEnvelopeService', 'CommandCenterExternalEventEnvelope', ['kind', 'sourceRuntimeId', 'sourceRef', 'provenance.evidence'], 'governed-execution', 'medium', false, true, ['missing_provenance', 'live_execution_requested']),
  schema('artifact', 'ZavorthExternalArtifactEnvelopeContract', 'ZavorthExternalArtifactEnvelopeService', 'CommandCenterExternalArtifactEnvelope', ['kind', 'sourceRuntimeId', 'sourceRef', 'provenance.evidence'], 'memory-recall', 'low', false, true, ['missing_provenance', 'raw_secret_value']),
  schema('approval', 'ZavorthExternalApprovalEnvelopeContract', 'ZavorthExternalApprovalEnvelopeService', 'CommandCenterExternalApprovalEnvelope', ['kind', 'sourceRuntimeId', 'sourceRef', 'provenance.evidence'], 'approval-proposal', 'high', true, true, ['source_identity_leak', 'live_execution_requested']),
  schema('health', 'ZavorthExternalHealthEnvelopeContract', 'ZavorthExternalHealthEnvelopeService', 'CommandCenterExternalHealthEnvelope', ['kind', 'sourceRuntimeId', 'sourceRef'], 'capability-discovery', 'low', false, false, ['source_identity_leak']),
  schema('worker', 'ZavorthExternalWorkerEnvelopeContract', 'ZavorthExternalWorkerEnvelopeService', 'CommandCenterExternalWorkerEnvelope', ['kind', 'sourceRuntimeId', 'sourceRef', 'provenance.evidence'], 'governed-execution', 'high', true, true, ['direct_tool_exposure', 'live_execution_requested', 'missing_provenance']),
];
