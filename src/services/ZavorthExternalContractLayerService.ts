...
const ENVELOPE_SCHEMAS: ZavorthExternalRuntimeEnvelopeSchema[] = [
  schema('runtime', 'ZavorthExternalRuntimeDescriptorContract', 'ZavorthExternalRuntimeDescriptorService', 'DashboardExternalRuntimeDescriptor', ['kind', 'sourceRuntimeId', 'sourceRef'], 'capability-discovery', 'medium', false, true, ['source_identity_leak', 'missing_provenance']),
  schema('capability', 'ZavorthExternalCapabilityEnvelopeContract', 'ZavorthExternalCapabilityEnvelopeService', 'DashboardExternalCapabilityEnvelope', ['kind', 'sourceRuntimeId', 'sourceRef', 'provenance.evidence'], 'capability-discovery', 'medium', false, true, ['source_identity_leak', 'missing_provenance']),
  schema('skill', 'ZavorthExternalSkillEnvelopeContract', 'ZavorthExternalSkillEnvelopeService', 'DashboardExternalSkillEnvelope', ['kind', 'sourceRuntimeId', 'sourceRef', 'provenance.evidence'], 'capability-discovery', 'high', true, true, ['direct_tool_exposure', 'live_execution_requested', 'missing_provenance']),
  schema('tool', 'ZavorthExternalToolEnvelopeContract', 'ZavorthExternalToolEnvelopeService', 'DashboardExternalToolEnvelope', ['kind', 'sourceRuntimeId', 'sourceRef', 'provenance.evidence'], 'tool-preview', 'high', true, true, ['direct_tool_exposure', 'raw_secret_value', 'live_execution_requested']),
  schema('channel', 'ZavorthExternalChannelEnvelopeContract', 'ZavorthExternalChannelEnvelopeService', 'DashboardExternalChannelEnvelope', ['kind', 'sourceRuntimeId', 'sourceRef', 'provenance.evidence'], 'capability-discovery', 'high', true, true, ['source_identity_leak', 'raw_secret_value', 'live_execution_requested']),
  schema('session', 'ZavorthExternalSessionEnvelopeContract', 'ZavorthExternalSessionEnvelopeService', 'DashboardExternalSessionEnvelope', ['kind', 'sourceRuntimeId', 'sourceRef', 'provenance.evidence'], 'memory-recall', 'medium', false, true, ['source_identity_leak', 'missing_provenance']),
  schema('event', 'ZavorthExternalEventEnvelopeContract', 'ZavorthExternalEventEnvelopeService', 'DashboardExternalEventEnvelope', ['kind', 'sourceRuntimeId', 'sourceRef', 'provenance.evidence'], 'governed-execution', 'medium', false, true, ['missing_provenance', 'live_execution_requested']),
  schema('artifact', 'ZavorthExternalArtifactEnvelopeContract', 'ZavorthExternalArtifactEnvelopeService', 'DashboardExternalArtifactEnvelope', ['kind', 'sourceRuntimeId', 'sourceRef', 'provenance.evidence'], 'memory-recall', 'low', false, true, ['missing_provenance', 'raw_secret_value']),
  schema('approval', 'ZavorthExternalApprovalEnvelopeContract', 'ZavorthExternalApprovalEnvelopeService', 'DashboardExternalApprovalEnvelope', ['kind', 'sourceRuntimeId', 'sourceRef', 'provenance.evidence'], 'approval-proposal', 'high', true, true, ['source_identity_leak', 'live_execution_requested']),
  schema('health', 'ZavorthExternalHealthEnvelopeContract', 'ZavorthExternalHealthEnvelopeService', 'DashboardExternalHealthEnvelope', ['kind', 'sourceRuntimeId', 'sourceRef'], 'capability-discovery', 'low', false, false, ['source_identity_leak']),
  schema('worker', 'ZavorthExternalWorkerEnvelopeContract', 'ZavorthExternalWorkerEnvelopeService', 'DashboardExternalWorkerEnvelope', ['kind', 'sourceRuntimeId', 'sourceRef', 'provenance.evidence'], 'governed-execution', 'high', true, true, ['direct_tool_exposure', 'live_execution_requested', 'missing_provenance']),
];
