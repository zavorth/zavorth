...
const PROVIDER_RUNTIME_P0: ProviderRuntimeActivationDescriptor[] = [
  ...
  compatible('cerebras', 'openai-compatible', 'src/adapters/providers/ProviderP0LiveClients.ts#OpenAICompatibleProviderLiveClient', 'llama-3.3-70b', ['CEREBRAS_API_KEY'], ['CEREBRAS_BASE_URL']),
  compatible('github-models', 'openai-compatible', 'src/providers/GatewayProvider.ts', 'openai/gpt-4.1', ['GITHUB_MODELS_TOKEN'], ['GITHUB_MODELS_BASE_URL']),
  compatible('cohere', 'openai-compatible', 'src/providers/GatewayProvider.ts', 'command-a-plus-05-2026', ['COHERE_API_KEY'], ['COHERE_BASE_URL']),
  compatible('sambanova', 'openai-compatible', 'src/providers/GatewayProvider.ts', 'Meta-Llama-3.3-70B-Instruct', ['SAMBANOVA_API_KEY'], ['SAMBANOVA_BASE_URL']),
  compatible('falcon', 'openai-compatible', 'src/providers/GatewayProvider.ts', 'tiiuae/falcon-180B-chat', ['FALCON_API_KEY'], ['FALCON_BASE_URL']),
  compatible('jais', 'openai-compatible', 'src/providers/GatewayProvider.ts', 'core42/jais-13b-chat', ['JAIS_API_KEY'], ['JAIS_BASE_URL']),
