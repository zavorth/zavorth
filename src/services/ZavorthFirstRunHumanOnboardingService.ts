...
function normalizeYesNo(raw: string): boolean | null {
  ...
  if (learning === 'on' || learning === 'true' || learning === 'yes' || learning === 'y' || learning === '1') return true;
  if (learning === 'off' || learning === 'false' || learning === 'no' || learning === 'n' || learning === '0') return false;
  return null;
}
