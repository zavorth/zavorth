...
export const gateway_en: GatewayCatalogSection = {
  "common": {
    "save": "Save",
    "cancel": "Cancel",
    "delete": "Delete",
  ...
  "sidebar": {
    ...
    "shutdown": "Shutdown",
    "restart": "Restart",
    "shutdownConfirm": "Shut down ZavorthGateway...",
    "restartConfirm": "Restart ZavorthGateway...",
    "version": "v{version}",
    "debug": "Debug",
    "system": "System",
    "help": "Help",
  ...
  "header": {
    ...
    "home": "Home",
    "homeDescription": "Welcome to Zavorth",
    "endpoint": "Endpoints",
  ...
  "cliTools": {
    ...
    "zavorthBridgeHowWorksDesc": "ZavorthBridge sends requests to Google's endpoint. MITM intercepts and redirects them to ZavorthGateway.",
    "zavorthBridgeStep1": "1. Start MITM to route requests through ZavorthGateway.",
    "zavorthBridgeStep2Prefix": "2. Add",
    "zavorthBridgeStep2Suffix": "to your hosts file as 127.0.0.1.",
    "zavorthBridgeStep3": "3. Open ZavorthBridge and requests will be proxied.",
    ...
    "failed": "Failed",
    "resetDone": "Reset!",
    "ZavorthGatewayConfiguredOpenAiCompatible": "ZavorthGateway is configured as OpenAI-compatible provider",
    "provider": "Provider",
    "model": "Model",
    "providers": "Providers",
    "auth": "Auth",
    "noApiKeysAvailable": "No API keys available",
    "usingDefaultZavorthGateway": "Using default: sk_ZavorthGateway",
    ...
    "toolUseCases": {
      ...
      "cline": "Use when you configure coding agents inside editors and want guided setup with ZavorthGateway models.",
      "kilo": "Use when your workflow depends on Kilo Code commands and fast iterative edits.",
      "cursor": "Use when coding in Cursor and you need custom OpenAI-compatible models through ZavorthGateway.",
      ...
      "kiro": "Use when integrating Kiro and controlling model routing centrally from ZavorthGateway.",
      "zavorthBridge": "Use when ZavorthBridge/Kiro traffic must be intercepted through MITM and routed to ZavorthGateway.",
      "copilot": "Use when you want Copilot chat style UX while enforcing ZavorthGateway keys and routing rules.",
      "external-executor": "Use when you want a governed local or WSL coding executor routed through ZavorthGateway policies."
    },
    "toolDescriptions": {
      "zavorthBridge": "Google ZavorthBridge IDE with MITM",
    ...
    "guides": {
      ...
      "opencode": {
        ...
        "notes": {
          ...
          "1": "Set the base URL to your ZavorthGateway endpoint."
        }
      },
      "kiro": {
        "steps": {
  ...
  "combos": {
    ...
    "contextRelayHandoffThresholdHelp": "When quota usage reaches this threshold, ZavorthGateway generates a structured handoff summary before the active account is exhausted.",
  ...
  "health": {
    "title": "System Health",
    "description": "Real-time monitoring of your ZavorthGateway instance",
    "healthy": "Healthy",
    "degraded": "Degraded",
    "down": "Down",
    "uptime": "Uptime",
    ...
    "providers": "Providers",
    "configuredProvidersLabel": "Configured in zavorthControl",
    "configuredProvidersHint": "Providers with credentials saved in /zavorthControl/providers, regardless of runtime state.",
  ...
  "onboarding": {
    ...
    "goToZavorthControl": "Go to ZavorthControl →",
    "welcomeDesc": "ZavorthGateway is your local AI API proxy. It routes requests to multiple AI providers with load balancing, failover, and usage tracking.",
    "multiProvider": "Multi-Provider",
    "usageTracking": "Usage Tracking",
    "apiKeyMgmt": "API Key Mgmt",
    "securityDesc": "Set a password to protect your zavorthControl, or skip for now.",
    ...
    "noProviderFound": "No provider found. You can add one from the zavorthControl later.",
    "testFailed": "Test failed, but you can configure this later.",
    "couldNotTest": "Could not test right now. You can test from the zavorthControl.",
    "doneDesc": "You're all set! Your ZavorthGateway instance is configured and ready to proxy AI requests.",
  ...
  "settings": {
    ...
    "requireLoginDesc": "When ON, zavorthControl requires password. When OFF, access without login.",
  ...
  "translator": {
    ...
    "modeDescriptionPlayground": "Paste any API request body and see how ZavorthGateway translates it between provider formats (OpenAI ↔ Claude ↔ Gemini ↔ Responses API)",
    "modeDescriptionChatTester": "Send real chat requests through ZavorthGateway and inspect the full round-trip: input, translated request, provider response, and translated output.",
    "modeDescriptionTestBench": "Run predefined scenarios and compare compatibility across providers and models.",
    "modeDescriptionLiveMonitor": "Watch translation events in real time as requests flow through ZavorthGateway.",
    "modeDescriptionFallback": "Debug, test, and visualize how ZavorthGateway translates API requests between providers.",
    ...
    "paused": "Paused",
    "eventsAppearHint": "Translation events appear here as requests flow through ZavorthGateway. Use any of these methods to generate events:",
    ...
    "formatConverterDescription": "Paste or type a JSON request body. The translator will auto-detect the source format and convert it to the target format. Use this to debug how ZavorthGateway translates requests between formats (OpenAI ↔ Claude ↔ Gemini ↔ Responses API).",
    "input": "Input",
    "output": "Output",
    "auto": "Auto",
    ...
    "liveMonitorDescriptionPrefix": "Shows translation events as API calls flow through ZavorthGateway. Events come from the in-memory buffer (resets on restart). Use",
  ...
  "usage": {
    ...
    "run": "Run",
    "runStepDescription": "Execute test cases against your LLM endpoints through ZavorthGateway. Each case is sent as a real API request.",
    "evaluate": "Evaluate",
    ...
    "runEvalHint": "Click \"Run Eval\" to execute all cases against your LLM endpoint. Each test sends a real request through ZavorthGateway.",
    ...
    "evalsHeroDescription": "Test and validate your LLM endpoints by running predefined evaluation suites. Each suite contains test cases that send real prompts through ZavorthGateway and compare responses against expected criteria — helping you detect regressions, compare models, and ensure response quality across providers.",
  ...
  "auth": {
    ...
    "configureInstance": "Let's get your ZavorthGateway instance configured",
    ...
    "setPasswordDescription": "Set a password to protect your zavorthControl and secure your API endpoints from unauthorized access.",
    ...
    "resetDescription": "Choose a method to recover access to your zavorthControl",
    "stopServer": "Stop the ZavorthGateway server",
    ...
    "methodCliDescription": "Run the following command on the server where ZavorthGateway is running:",
    ...
    "nodeIncompatibleDesc": "You are running Node.js {version}, which is not compatible with Zavorth. The native SQLite module (better-sqlite3) requires Node.js 18-22 LTS.",
    "nodeIncompatibleFixLabel": "Fix: install Node.js 22 LTS",
    "nodeIncompatibleHint": "Zavorth requires Node.js >=18 and <24. Node 22 LTS is recommended for stability."
  },
  "landing": {
    "brandName": "Zavorth",
    ...
    "heroDescription": "AI endpoint proxy with web zavorthControl - A JavaScript port of CLIProxyAPI. Works seamlessly with Claude Code, OpenAI Codex, Cline, RooCode, and other CLI tools.",
    "getStarted": "Get Started",
    ...
    "featureZavorthControlDesc": "Visual zavorthControl for real-time traffic analysis.",
    "howItWorks": "How Zavorth Works",
    ...
    "getStartedDescription": "Install Zavorth, configure your providers via web zavorthControl, and start routing AI requests.",
    "installZavorthGateway": "Install Zavorth",
    "installStepDescription": "Run npx command to start the server instantly",
    "openZavorthControl": "Open ZavorthControl",
    "openZavorthControlStepDescription": "Configure providers and API keys via web interface",
    "routeRequests": "Route Requests",
    "routeRequestsStepDescription": "Point your CLI tools to {endpoint}",
    "terminal": "terminal",
    "copy": "Copy",
    "copied": "✓ Copied",
    "startingZavorthGateway": "Starting Zavorth...",
    "serverRunningOnLabel": "Server running on",
    "zavorthControlLabel": "ZavorthControl",
    "readyToRoute": "Ready to route! ✓",
    "configureProvidersNote": "📝 Configure providers in zavorthControl or use environment variables",
    ...
    "copyright": "... {year} Zavorth. All rights reserved.",
    ...
    "ctaDescription": "Join developers who are streamlining their AI integrations with Zavorth. Open source and free to start.",
  ...
  "docs": {
    ...
    "featureCliText": "Manage IDE configurations, export/import backups, discover codex profiles, and configure settings from the zavorthControl.",
    ...
    "useCaseFallbackText": "Create combo models in ZavorthControl and keep client config stable while providers rotate internally.",
    ...
    "troubleshootingTestConnection": "Use ZavorthControl > Providers > Test Connection before testing from IDEs or external clients.",
  ...
  "legal": {
    ...
    "privacyMetadataTitle": "Privacy Policy | Zavorth",
    "privacyMetadataDescription": "Privacy policy for the Zavorth AI API control plane.",
    "termsMetadataTitle": "Terms of Service | Zavorth",
    "termsMetadataDescription": "Terms of service for the Zavorth AI API control plane.",
    ...
    "privacySection1Text": "Zavorth is designed as a local-first application. All data processing and storage occurs entirely on your machine. There is no centralized server collecting your information.",
    ...
    "privacySection3Text": "Zavorth does not collect telemetry, analytics, or crash reports. No data is sent to us or any third party. Your usage patterns, API calls, and configurations remain entirely private.",
    "privacySection4Title": "4. Third-Party AI Providers",
    "privacySection4Text": "When you make API calls through Zavorth, your requests are forwarded to the AI providers you have configured (for example: OpenAI, Anthropic, Google). These providers have their own privacy policies that govern how they handle your data. Please review:",
    ...
    "privacyLoggingIntro": "Request logs can be configured through the zavorthControl settings. You can:",
    ...
    "privacySection7TextEnd": "directory or using the database backup and restore features in the zavorthControl.",
    "termsSection1Title": "1. Overview",
    "termsSection1Text": "Zavorth is a local-first AI API control plane that operates entirely on your machine. It routes requests to multiple AI providers with load balancing, failover, and usage tracking.",
    ...
    "termsResponsibilityCompliance": "You must comply with the terms of service of each AI provider whose API you access through Zavorth.",
    "termsResponsibilitySecurity": "You are responsible for the security of your local Zavorth installation, including setting a password and restricting network access.",
    "termsSection3Title": "3. How It Works",
    "termsSection3Text": "Zavorth acts as an intermediary control plane. API calls sent to Zavorth are translated and forwarded to your configured AI providers. Zavorth does not modify the content of your requests or responses beyond the necessary protocol translation.",
    "termsSection4Title": "4. Data Handling",
    "termsDataStoredLocally": "All data is stored locally on your machine in a SQLite database.",
    "termsNoTransmission": "Zavorth does not transmit any data to external servers unless you explicitly enable cloud sync features.",
    "termsDataLocationText": "Usage logs, API keys, and configuration are stored in",
    "termsSection5Title": "5. Disclaimer",
    "termsSection5Text": "Zavorth is provided \"as is\" without warranty of any kind. We are not responsible for any costs incurred through API usage, service disruptions, or data loss. Always maintain backups of your configuration.",
    "termsSection6Title": "6. Open Source",
    "termsSection6Text": "Zavorth is open-source software. You are free to inspect, modify, and distribute it under the terms of its license."
  },
  "agents": {
    "title": "CLI Agents",
