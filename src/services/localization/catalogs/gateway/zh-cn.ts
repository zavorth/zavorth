...
export const gateway_zh_cn: GatewayCatalogSection = {
  "common": {
    "save": "保存",
    "cancel": "取消",
    "delete": "删除",
    ...
    "proxyId": "代理 ID",
    "connectionId": "连接 ID",
    "resolveConnectionId": "解析连接 ID",
    "resolve_connection_id": "解析连接 ID",
    "scope_id": "作用域 ID",
    "scopeId": "作用域 ID",
    "jwtSecret": "JWT 密钥",
    "keytar": "keytar",
  ...
  "sidebar": {
    ...
    "shutdown": "停止服务",
    "restart": "重启服务",
    "shutdownConfirm": "确定要停止 ZavorthGateway 吗？",
    "restartConfirm": "确定要重启 ZavorthGateway 吗？",
    "version": "v{version}",
    "debug": "调试",
    "system": "系统",
    "help": "帮助",
  ...
  "header": {
    ...
    "home": "首页",
    "homeDescription": "欢迎使用 Zavorth",
    "endpoint": "端点",
    "endpointDescription": "管理代理端点、MCP、A2A 和 API 端点",
    "mcp": "MCP",
  ...
  "home": {
    ...
    "step1Desc": "前往 <endpoint>端点</endpoint> -> 已注册密钥。为每个环境生成一个独立密钥。",
    "step2Title": "2. 连接提供商",
    "step2Desc": "在 <providers>提供商</providers> 中添加账户。支持 OAuth、API Key 和免费套餐。",
    "step3Title": "3. 配置客户端",
    ...
    "configuredOf": "{total} 个可用提供商中已配置 {configured} 个",
  ...
  "apiManager": {
    ...
    "usageTips": "使用提示",
    "tipAuth": "在 Authorization 请求头中以 Bearer YOUR_KEY 的形式使用 API 密钥",
  ...
  "media": {
    ...
    "error": "生成失败",
    "result": "结果",
    "imageDescription": "使用 OpenAI、xAI、Together、Hyperbolic、SD WebUI、ComfyUI 等根据文本提示生成图像。",
    "videoDescription": "通过 ComfyUI 或 SD WebUI 使用 AnimateDiff、Stable Video Diffusion 创建视频。",
    "musicDescription": "通过 ComfyUI 使用 Stable Audio Open 或 MusicGen 生成音乐。"
  },
  "search": {
    "searchQuery": "搜索词",
    "searchResults": "搜索结果",
  ...
  "cliTools": {
    ...
    "defaultZavorthGatewayKey": "sk_ZavorthGateway（默认）",
    "selectModel": "选择模型",
    ...
    "clear": "清除",
    "comingSoon": "即将推出",
    "checkingRuntime": "正在检查运行时状态...",
    "guideOnlyIntegration": "仅指南集成（无需本地运行时）",
    "cliRuntimeDetected": "CLI 运行时已检测到并准备就绪",
    "cliFoundNotRunnable": "CLI 已找到但无法运行{reason}",
    "cliRuntimeNotDetected": "未检测到 CLI 运行时",
    "binary": "二进制",
    "configPath": "配置路径",
    "configPathShort": "配置",
    "failedCheckRuntimeStatus": "无法检查运行时状态。",
    "copy": "复制",
    "copied": "已复制",
    "copyConfig": "复制配置",
    "saveConfig": "保存配置",
    "selectionSaved": "选择已保存",
    "guide": "指南",
    "detected": "检测到",
    "notReady": "还没准备好",
    "active": "活跃",
    ...
    "howItWorks": "工作原理：",
    "zavorthBridgeHowWorksDesc": "ZavorthBridge 会向 Google 端点发起请求，MITM 会拦截这些请求并重定向到 ZavorthGateway。",
    "zavorthBridgeStep1": "1. 启动 MITM，让请求通过 ZavorthGateway 路由。",
    "zavorthBridgeStep2Prefix": "2. 添加",
    "zavorthBridgeStep2Suffix": "添加到您的主机文件中作为 127.0.0.1。",
    "zavorthBridgeStep3": "3. 打开 ZavorthBridge，请求就会被代理。",
    "mitmHowWorksDesc": "{toolName} 会先向原始提供商端点发起请求，随后由 MITM 拦截并重定向到 ZavorthGateway。",
    "mitmStep1": "1. 启动 MITM，让请求经由 ZavorthGateway 路由。",
    "mitmStep2Prefix": "2. 将",
    ...
    "failedApplySettings": "无法应用设置",
    "settingsReset": "设置重置成功！",
    "failedResetSettings": "重置设置失败",
    "backupRestored": "备份已恢复！",
    "failedRestore": "恢复失败",
    "checkingCli": "正在检查 {tool} CLI...",
    "cliNotRunnable": "{tool} CLI 已安装但无法运行",
    "cliNotInstalled": "{tool} CLI 未安装",
    "cliNotDetected": "未检测到 {tool} CLI",
    ...
    "backups": "备份",
    "configBackups": "配置备份",
    "noBackupsYet": "还没有备份。每次应用或重置之前都会自动创建备份。",
    "restore": "恢复",
    "backupRestoredReloading": "备份已恢复！正在重新加载状态...",
    "failedRestoreBackup": "恢复备份失败",
    "applied": "已应用！",
    "failed": "失败",
    "resetDone": "重置！",
    "ZavorthGatewayConfiguredOpenAiCompatible": "ZavorthGateway 已配置为 OpenAI 兼容提供商",
    "provider": "提供商",
    "model": "模型",
    "providers": "提供商",
    "auth": "授权",
    "noApiKeysAvailable": "没有可用的 API 密钥",
    "usingDefaultZavorthGateway": "使用默认值：sk_ZavorthGateway",
    "updateConfig": "更新配置",
    "applyConfig": "应用配置",
    ...
    "toolUseCases": {
      ...
      "cline": "当您在编辑器内配置编码代理并希望使用 ZavorthGateway 模型进行引导设置时使用。",
      "kilo": "当您的工作流程依赖于 Kilo Code 命令和快速迭代编辑时使用。",
      "cursor": "在 Cursor 中编码并且需要通过 ZavorthGateway 自定义 OpenAI 兼容模型时使用。",
      "continue": "在 IDE 中运行“Continue”并且需要可移植的基于 JSON 的提供程序配置时使用。",
      "opencode": "当您更喜欢通过 OpenCode 进行终端本机代理运行和脚本自动化时使用。",
      "kiro": "在集成 Kiro 并从 ZavorthGateway 集中控制模型路由时使用。",
      "zavorthBridge": "当必须通过 MITM 拦截 ZavorthBridge/Kiro 流量并将其路由到 ZavorthGateway 时使用。",
      "copilot": "当您想要 Copilot 聊天风格的 UX 同时强制执行 ZavorthGateway 键和路由规则时使用。",
      "external-executor": "Use when you want a governed local or WSL coding executor routed through ZavorthGateway policies."
    },
    "toolDescriptions": {
      "zavorthBridge": "带 MITM 的 Google ZavorthBridge IDE",
    ...
    "guides": {
      ...
      "opencode": {
        ...
        "notes": {
          ...
          "1": "将基础 URL 设置为您的 ZavorthGateway 端点。"
        }
      },
      "kiro": {
        "steps": {
          ...
          "2": {
            "title": "Base URL",
            "desc": "粘贴你的 ZavorthGateway 端点 URL"
          },
          "3": {
            "title": "API 密钥"
          },
  ...
  "combos": {
    ...
    "contextRelay": "上下文接力",
    "contextRelayDesc": "在账户轮换时通过交接摘要保持会话连续性",
    ...
    "contextRelayHandoffThreshold": "交接阈值",
    "contextRelayHandoffThresholdHelp": "当配额使用达到该阈值时，ZavorthGateway 会在当前活跃账户耗尽前生成结构化交接摘要。",
    "contextRelayMaxMessages": "摘要最大消息数",
    "contextRelayMaxMessagesHelp": "限制压缩进接力摘要中的最近历史消息数量。",
    "contextRelaySummaryModel": "摘要模型",
    "contextRelaySummaryModelHelp": "仅用于生成交接摘要的可选覆盖模型。留空则复用当前活跃的 combo 模型。",
    "contextRelayProviderNote": "Context Relay 当前主要为 Codex 账户轮换生成交接摘要。与同一提供商的多个账户配合使用时，连续性效果最佳。",
    ...
    "templateFreeStackDesc": "在所有免费提供商之间进行轮询：Kiro（Claude）、Qoder（5 个模型）、Qwen（4 个模型）、Gemini CLI。零成本，编码不中断。",
    "auto": "自动组合",
  ...
  "endpoint": {
    ...
    "quickStart": "快速开始",
    "openMcpZavorthControl": "打开 MCP 管理",
    "openA2aZavorthControl": "打开 A2A 管理",
    "mcpQuickStartTitle": "MCP 快速开始",
    "mcpQuickStartStep1": "通过 `ZavorthGateway --mcp` 启动 MCP 服务。",
    "mcpQuickStartStep2": "将你的 MCP 客户端配置为通过 stdio 传输连接。",
    "mcpQuickStartStep3": "调用 `ZavorthGateway_get_health`、`ZavorthGateway_list_combos` 等工具验证连通性。",
    "a2aQuickStartTitle": "A2A 快速开始",
    "a2aQuickStartStep1": "通过 `/.well-known/agent.json` 发现 Agent Card。",
    "a2aQuickStartStep2": "向 `POST /a2a` 发送 `message/send` 或 `message/stream` JSON-RPC 请求。",
    "a2aQuickStartStep3": "使用 `tasks/get` 与 `tasks/cancel` 跟踪和控制任务。",
  ...
  "mcpZavorthControl": {
    ...
    "tableAudit": "审计",
    "auditLog": "审计日志",
    "auditSummary": "调用数：{total}｜第 {page} / {totalPages} 页",
    "allTools": "全部工具",
    "allResults": "全部结果",
    "success": "成功",
    "failure": "失败",
  ...
  "a2aZavorthControl": {
    ...
    "taskManagement": "任务管理",
    "taskSummary": "任务总数：{total}｜第 {page} / {totalPages} 页",
    "allStates": "全部状态",
    "allSkills": "全部技能",
    "loadingTasks": "正在加载任务...",
  ...
  "health": {
    "title": "系统健康状况",
    "description": "实时监控您的 ZavorthGateway 实例",
    "healthy": "健康",
    "degraded": "降级",
    "down": "下线",
    "uptime": "正常运行时间",
    ...
    "refreshAll": "全部刷新",
    "checkNow": "立即查看",
    "loadingHealth": "正在加载健康数据...",
    "failedToLoad": "无法加载健康数据：{error}",
    "retry": "重试",
    "allOperational": "所有系统均可运行",
    "issuesDetected": "检测到系统问题",
    "updatedAt": "更新了 {time}",
    "latency": "延迟",
    "latencyP50": "p50",
    "latencyP95": "p95",
    ...
    "configuredProvidersHint": "指已在 /zavorthControl/providers 中配置凭证的提供商，无论当前运行时状态如何。",
  ...
  "onboarding": {
    ...
    "setupComplete": "设置完成！",
    "goToZavorthControl": "转到仪表板→",
    "welcomeDesc": "ZavorthGateway 是您的本地 AI API 代理。它通过负载均衡、故障转移和使用情况跟踪将请求路由到多个 AI 提供商。",
    "multiProvider": "多提供商",
    ...
    "doneDesc": "你都准备好了！您的 ZavorthGateway 实例已配置并准备好代理 AI 请求。",
    "yourEndpoint": "您的端点：",
    "continue": "继续",
    "retry": "重试",
  ...
  "providers": {
    ...
    "compatibleProviders": "API 密钥兼容提供商",
    "testAll": "测试全部",
    "testAllOAuth": "测试所有 OAuth 连接",
    "testAllFree": "测试所有免费连接",
    "testAllApiKey": "测试所有 API 密钥连接",
    "testAllCompatible": "测试所有兼容连接",
    "connected": "{count} 已连接",
    ...
    "apiKeySecure": "您的 API 密钥将被加密并安全存储。",
    "oauth2Connect": "使用 OAuth2 连接",
    "oauth2Label": "OAuth2",
    "oauth2Desc": "使用 OAuth2 身份验证连接您的帐户。",
    "displayName": "显示名称",
    ...
    "testedCount": "{count} 已测试",
    "millisecondsAbbr": "{value}ms",
    "okShort": "好的",
    "errorShort": "错误",
    "noActiveConnectionsInGroup": "未找到该组的活动连接。",
    "allTestsPassed": "所有 {total} 测试均已通过",
    ...
    "enableRateLimitProtection": "单击启用速率限制保护",
    "disableRateLimitProtection": "单击以禁用速率限制保护",
    "productionKey": "生产密钥",
    ...
    "errorTypeUpstreamAuth": "上游授权",
    "errorTypeMissingCredential": "缺少凭证",
    "errorTypeRefreshFailed": "刷新失败",
    "errorTypeTokenExpired": "令牌已过期",
    "errorTypeRateLimited": "速率有限",
    "errorTypeUpstreamUnavailable": "上游不可用",
    ...
    "compatProtocolHint": "以下选项在 ZavorthGateway 识别到该请求形态（OpenAI Chat、Responses API 或 Anthropic Messages）时生效。",
    ...
    "compatUpstreamHeadersHint": "与修改厂商连接/API 配置同属高权限能力，仅可信管理员应使用。这些头会在 ZavorthGateway 按厂商 API Key 自动加好鉴权头之后再合并。若「名称」与系统已加的头相同（例如都叫 Authorization），则以你填的值为准，会整段替换自动那条（含 Bearer 令牌），上游请求里不再使用面板里保存的密钥来生成 Authorization。填错可能导致 401，请谨慎。每个请求头单独一行；部分网关需要额外 Authentication 等可在此加。鼠标移入或聚焦「值」可暂时看明文。点空白处、关闭本面板或切走焦点即保存。",
    ...
    "groupLabel": "环境",
    "groupPlaceholder": "例如：eKaizen、Personal",
  ...
  "settings": {
    ...
    "lightMode": "浅色模式",
    "memoryTitle": "记忆",
    "memoryDesc": "跨会话持久化对话记忆",
    "memoryEnabled": "启用记忆",
    "memoryEnabledDesc": "启用后，ZavorthGateway 会注入相关的历史上下文。",
    "maxTokens": "最大 Tokens",
    "retentionDays": "保留时长",
    "recent": "最近",
    "recentDesc": "按时间顺序的时间窗",
    "semantic": "语义",
    "semanticDesc": "向量搜索",
    "hybrid": "混合",
    "hybridDesc": "最近 + 语义",
    ...
    "skillsDesc": "供模型调用的工具",
    "skillsEnabled": "启用技能",
    "skillsEnabledDesc": "允许智能体触发函数。",
    "skillsComingSoon": "技能市场即将推出。",
    "memorySkillsTitle": "记忆与技能",
    "memorySkillsDesc": "持久化上下文与能力",
    "modelsDevTitle": "模型数据库",
    "modelsDevDesc": "从 models.dev 自动同步定价、能力和规格",
    "modelsDevEnabled": "启用 models.dev 同步",
    "modelsDevEnabledDesc": "从开源的 models.dev 数据库获取模型定价、能力和规格",
    "modelsDevInterval": "同步间隔",
    "syncNow": "立即同步",
    "syncing": "同步中...",
    "lastSync": "上次同步",
    "never": "从未",
    "justNow": "刚才",
    "modelsDevStats": "同步统计",
    "modelsDevStatsDesc": "当前 models.dev 数据覆盖情况",
    "providers": "提供商",
    "modelsWithPricing": "已有定价的模型",
    "capabilities": "能力",
    "lastSyncCount": "上次同步数量",
    "lastSyncFull": "上次完整同步",
    "modelsDevInfo": "工作原理",
    "modelsDevInfoDesc": "models.dev 是由 SST/OpenCode 团队维护的开源 AI 模型规格数据库，提供 100+ 提供商、4,000+ 模型的定价、能力、上下文限制和模态信息。",
    "modelsDevInfoResolution": "定价解析顺序（优先级从高到低）：",
    "modelsDevInfoOrder": "用户覆盖 → models.dev → LiteLLM → 硬编码默认值",
    "systemTheme": "系统主题",
    "debugToggle": "启用调试模式",
    ...
    "retryDelay": "重试延迟",
    "timeoutMs": "超时（毫秒）",
    "enableSystemPrompt": "启用系统提示",
    "systemPromptText": "系统提示文字",
    ...
    "importData": "导入数据",
    "clearData": "清除所有数据",
    "clearDataConfirm": "这将永久删除所有数据。你确定吗？",
    "enableRequestLogs": "启用请求日志",
    "logRetention": "日志保留",
    "ipWhitelist": "IP白名单",
    "ipBlacklist": "IP黑名单",
    "addIP": "添加IP",
    ...
    "themeCyan": "青色",
    "whitelabeling": "品牌定制",
    "whitelabelingDesc": "自定义应用名称和 Logo",
    "appName": "应用名称",
    "appNameDesc": "显示在侧边栏和浏览器标签页中的名称",
    "customLogo": "自定义 Logo URL",
    "customLogoDesc": "你的自定义 Logo 图片地址",
    "uploadLogo": "上传 Logo",
    "resetLogo": "恢复默认",
    "logoPreview": "预览",
    "customFavicon": "浏览器 Favicon",
    "customFaviconDesc": "你的自定义 Favicon 地址（显示在浏览器标签页中）",
    "uploadFavicon": "上传 Favicon",
    "resetFavicon": "重置 Favicon",
    ...
    "saved": "已保存",
    "systemPromptPlaceholder": "输入要注入所有请求的系统提示...",
    "systemPromptHint": "此提示会添加到每个请求的系统消息之前。用于全局说明、安全指南或响应格式规则。",
    "chars": "{count} 字符",
    ...
    "auto": "自动",
    "autoDesc": "丢弃所有思考配置，由提供商自行决定",
    "custom": "定制",
    "customDesc": "为所有请求设置固定的 Token 预算",
    "adaptive": "自适应",
    "adaptiveDesc": "根据请求复杂性调整预算",
    "effortNone": "无（0 Tokens）",
    "effortLow": "低（1K Tokens）",
    "effortMedium": "中（10K Tokens）",
    "effortHigh": "高（128K Tokens）",
    "tokenBudget": "Token 预算",
    "tokens": "Tokens",
    "baseEffortLevel": "基本努力水平",
    "adaptiveHint": "自适应模式根据消息计数、工具使用情况和提示长度从此基本级别进行扩展。",
    "requireLogin": "需要登录",
    "requireLoginDesc": "当打开时，仪表板需要密码。当关闭时，无需登录即可访问。",
    ...
    "updatePassword": "更新密码",
    "setPassword": "设置密码",
    "apiEndpointProtection": "API 端点保护",
    "requireAuthModels": "/models 需要 API 密钥",
    "requireAuthModelsDesc": "开启后，`/v1/models` 对未认证请求返回 404，从而阻止未授权用户发现模型。",
    "blockedProviders": "被阻止的提供商",
    "blockedProvidersDesc": "在 `/v1/models` 响应中隐藏指定提供商。被隐藏的提供商不会出现在模型列表中。",
    "providersBlocked": "{count} 个提供商/模型已屏蔽",
    "blockProviderTitle": "屏蔽 {provider}",
    "unblockProviderTitle": "取消屏蔽 {provider}",
    ...
    "routingStrategy": "路由策略",
    "routingAdvancedGuideTitle": "高级路由指南",
    "routingAdvancedGuideHint1": "需要可预测优先级时使用 Fill First，需要公平分配时使用 Round Robin，需要延迟弹性时使用 P2C。",
    "routingAdvancedGuideHint2": "如果各提供商在质量或成本上差异明显，后台任务可优先考虑“成本优化”，需要均衡消耗时可从“最少使用”开始。",
    "fillFirst": "优先填满",
    "fillFirstDesc": "按优先级顺序使用账户",
    "roundRobin": "轮询",
    "roundRobinDesc": "在所有账户之间轮流分配",
    "p2c": "P2C",
    "p2cDesc": "随机选2个，使用更健康的一个",
    "random": "随机",
    "randomDesc": "每次请求随机选择账户",
    "leastUsed": "最少使用",
    "leastUsedDesc": "优先选择最近使用最少的账户",
    "costOpt": "成本优化",
    "costOptDesc": "优先选择成本最低的可用账户",
    "strictRandom": "严格随机",
    ...
    "logout": "退出",
    "clearLocalDataConfirm": "清除所有本地数据？这将重置您的首选项。",
    "unknown": "未知",
    "systemActor": "系统",
    ...
    "addIpAddress": "添加IP地址",
    "ipAddressPlaceholder": "192.168.1.0/24 或 10.0.*.*",
    "block": "+ 屏蔽",
    "allow": "+ 允许",
    "blocked": "已被阻止 ({count})",
    "allowed": "允许 ({count})",
    "temporaryBans": "临时禁令 ({count})",
    "minLeft": "还剩 {min}m",
    "auditLog": "审核日志",
    ...
    "defaultStrategyDesc": "应用于没有明确策略的新组合",
    "comboStrategyAria": "组合策略",
    "priority": "优先级",
    "weighted": "加权",
    "contextRelay": "上下文接力",
    "contextRelayDesc": "在账户轮换发生时，采用优先级风格路由并自动执行上下文交接",
    "maxRetriesLabel": "最大重试次数",
    "retryDelayLabel": "重试延迟（毫秒）",
    "timeoutLabel": "超时（毫秒）",
    "healthCheck": "健康检查",
    ...
    "contextRelayMaxMessages": "摘要最大消息数",
    "contextRelaySummaryModel": "摘要模型",
    "contextRelayProviderNote": "Context Relay 当前会为 Codex 账户生成交接摘要，并将这些值作为新的或未配置 combo 的全局默认值。",
    "providerProfiles": "提供商策略配置",
    "providerProfilesDesc": "为 OAuth（基于会话）和 API Key（计费型）提供商分别设置弹性策略。由于速率限制更低，OAuth 提供商通常采用更严格的阈值。",
    "oauthProviders": "OAuth 提供商",
    "apiKeyProviders": "API 密钥提供商",
    "transientCooldown": "瞬时故障冷却",
    "rateLimitCooldown": "限流冷却",
    "maxBackoffLevel": "最大退避级别",
    "cbThreshold": "熔断阈值",
    "cbResetTime": "熔断重置时间",
    "rateLimiting": "速率限制",
    ...
    "minGap": "最小间隔",
    "maxConcurrent": "最大并发数",
    "activeLimiters": "活动限流器",
    "noActiveLimiters": "尚无活动的速率限制器。",
    "reservoir": "令牌池",
    "running": "运行中",
    "queued": "排队中",
    "circuitBreakers": "断路器",
    "breakerStateClosed": "闭合",
    "breakerStateOpen": "断开",
    "breakerStateHalfOpen": "半开",
    "tripped": "{count} 已触发",
    "healthy": "{count} 健康",
    "resetAll": "全部重置",
    "noCircuitBreakers": "尚未激活断路器。当请求流经组合管道时，它们会自动创建。",
    "failures": "{count} 失败",
    ...
    "unlocking": "解锁...",
    "failedUnlock": "解锁失败",
    "failedLoadWithStatus": "加载失败：{status}",
    "failedLoadResilience": "无法加载弹性状态",
    "saveFailed": "保存失败",
    "resetFailed": "重置失败",
    "loadingResilience": "正在加载弹性状态...",
    "retry": "重试",
    "systemStorage": "系统与存储",
    "allDataLocal": "所有数据都存储在本地计算机上",
    "databasePath": "数据库路径",
    "exportDatabase": "导出数据库",
    "exportAll": "全部导出 (.tar.gz)",
    "importDatabase": "导入数据库",
    "confirmDbImport": "确认数据库导入",
    "confirmDbImportDesc": "这会将所有当前数据替换为 {file} 中的内容。导入前将自动创建备份。",
    "yesImport": "是的，导入",
    "lastBackup": "上次备份",
    "noBackupYet": "还没有备份",
    "backupNow": "立即备份",
    ...
    "viewBackups": "查看备份",
    "hide": "隐藏",
    "backupRetentionDesc": "数据库快照会在还原之前自动创建，并且在数据更改时每 15 分钟自动创建一次。保留：24 小时 + 30 每日备份，智能轮换。",
    "loadingBackups": "正在加载备份...",
    "noBackupsYet": "尚无可用的备份。当数据发生变化时，将自动创建备份。",
    "backupsAvailable": "{count} 可用备份",
    "refresh": "刷新",
    "confirm": "确认？",
    "yes": "是的",
    "no": "否",
    ...
    "backupCreated": "创建备份：{file}",
    "restoreSuccess": "恢复完成！共恢复 {connections} 个连接、{nodes} 个节点、{combos} 个组合、{apiKeys} 个 API 密钥。",
    "importSuccess": "数据库导入完成！共导入 {connections} 个连接、{nodes} 个节点、{combos} 个组合、{apiKeys} 个 API 密钥。",
    ...
    "withPricing": "已配置定价",
    "policiesCircuitBreakers": "策略与断路器",
    ...
    "pricingDescReasoning": "推理：思考 Tokens（默认回退到输出费率）",
    ...
    "tokenTypes": "Token 类型",
    "inputTokenDesc": "标准提示 Tokens",
    "outputTokenDesc": "补全 / 响应 Tokens",
    "cachedTokenDesc": "缓存输入 Tokens（通常按输入费率的 50% 计）",
    "reasoningTokenDesc": "特殊推理 / 思考 Tokens（回退到输出费率）",
    "cacheCreationTokenDesc": "用于创建缓存条目的 Tokens（回退到输入费率）",
  ...
  "translator": {
    "title": "翻译器",
    "metaTitle": "翻译器游乐场 | ZavorthGateway",
    "metaDescription": "调试、测试和可视化提供商之间的 API 格式转换",
    "playgroundTitle": "翻译器游乐场",
    "playground": "游乐场",
    "realtime": "实时翻译活动",
    "chatTester": "聊天测试仪",
    "testBench": "测试台",
    "liveMonitor": "实时监控",
    "modeDescriptionPlayground": "粘贴任意 API 请求体，查看 ZavorthGateway 如何在不同提供商格式之间进行转换（OpenAI ↔ Claude ↔ Gemini ↔ Responses API）。",
    "modeDescriptionChatTester": "通过 ZavorthGateway 发送真实聊天请求，并检查完整往返流程：输入、转换后的请求、提供商响应以及转换后的输出。",
    "modeDescriptionTestBench": "运行预定义的场景并比较提供商和模型之间的兼容性。",
    "modeDescriptionLiveMonitor": "实时查看请求流经 ZavorthGateway 时产生的翻译事件。",
    "modeDescriptionFallback": "调试、测试并可视化 ZavorthGateway 如何在提供商之间转换 API 请求。",
    ...
    "paused": "已暂停",
    "eventsAppearHint": "请求流经 ZavorthGateway 时，翻译事件会显示在这里。你可以通过下面任一方式生成事件：",
    "chatTesterTab": "聊天测试选项卡",
    "testBenchTab": "测试台选项卡",
    "externalApiCalls": "外部API调用",
    "ideCliIntegrations": "IDE/CLI 集成",
    "inMemoryNote": "注意：事件存储在内存中，并在服务器重新启动时重置。",
    "ok": "好的",
    "errorShort": "错误率",
    "formatConverter": "格式转换器",
    "formatConverterDescription": "粘贴或输入 JSON 请求体。翻译器会自动识别源格式并将其转换为目标格式。你可以借此调试 ZavorthGateway 在各种格式之间的转换行为（OpenAI ↔ Claude ↔ Gemini ↔ Responses API）。",
    "input": "输入",
    "output": "输出",
    "auto": "汽车",
    "swapFormats": "交换格式",
    "translateAction": "翻译",
    "clear": "清除",
    "inputPlaceholder": "在此处粘贴请求正文或选择下面的模板...",
    "exampleTemplates": "示例模板",
    "exampleTemplatesHint": "— 点击加载",
    ...
    "passedIconLabel": "✅ 通过",
    "chunks": "块",
    "scenarioSimpleChat": "简单聊天",
    "scenarioToolCalling": "工具调用",
    "scenarioMultiTurn": "多圈",
    "scenarioThinking": "思考",
    "scenarioSystemPrompt": "系统提示",
    "scenarioStreaming": "流媒体",
    "templateNames": {
      "simple-chat": "简单聊天",
      "tool-calling": "工具调用",
      "multi-turn": "多圈",
    ...
    "templateDescriptions": {
      ...
      "multi-turn": "与历史对话",
      "thinking": "扩展思维/推理",
      "system-prompt": "复杂系统指令",
      "streaming": "SSE 流请求"
    },
    "templatePayloads": {
      "simpleChat": {
        "system": "你是一个有用的助手。",
        "userGreeting": "你好！你今天怎么样？"
      },
      "toolCalling": {
        "userWeather": "圣保罗 的天气怎么样？",
        "toolDescription": "获取某个位置的当前天气",
        "cityNameDescription": "城市名称"
      },
      "multiTurn": {
        "system": "你是一名编码助理。",
    ...
    "chatTesterFlow": "客户端请求 → 格式检测 → OpenAI 中间格式 → 提供商格式 → 响应",
    ...
    "formatDetectedDescription": "ZavorthGateway 会根据请求结构自动识别 API 格式",
    ...
    "liveMonitorDescriptionPrefix": "这里会显示 API 调用流经 ZavorthGateway 时产生的翻译事件。事件来自内存缓冲区（重启后会重置）。使用",
  ...
  "usage": {
    ...
    "budgetSaved": "已保存预算限制",
    "budgetSaveFailed": "未能节省预算",
    "loadingBudgetData": "正在加载预算数据...",
    "noApiKeysTitle": "没有 API 密钥",
    "noApiKeysDescription": "首先添加 API 密钥以设置预算限制。",
    "apiKey": "API密钥",
    "todaysSpend": "今天的花费",
    "thisMonth": "本月",
    "setLimits": "设定限制",
    "dailyLimitUsd": "每日限额（美元）",
    "monthlyLimitUsd": "每月限额（美元）",
    "warningThresholdPercent": "警告阈值 (%)",
    "dailyLimitPlaceholder": "例如5.00",
    "monthlyLimitPlaceholder": "例如50.00",
    "warningThresholdPlaceholder": "80",
    "saveLimits": "保存限制",
    "budgetOk": "预算正常 — 剩余 {remaining}",
    "budgetExceeded": "超出预算 - 请求可能被阻止",
    "totalRequests": "请求总数",
    "noDataYet": "还没有数据",
    "latency": "延迟",
    "latencyP50": "p50",
    ...
    "lockedCount": "{count, plural, one {# 个锁定项} other {# 个锁定项}}",
    "timeLeft": "剩余 {time}",
    "howItWorks": "工作原理",
    ...
    "run": "运行",
    "runStepDescription": "通过 ZavorthGateway 对你的 LLM 端点执行测试用例。每个案例都会作为真实 API 请求发送。",
    "evaluate": "评估",
    ...
    "passRate": "通过率",
    "summaryBreakdown": "{passed} 通过 · {failed} 失败 · {total} 总计",
    "passedIconLabel": "✅ 通过",
    "failedIconLabel": "❌ 失败",
    "detailsContains": "包含：“{term}”",
    "detailsRegex": "正则表达式：{pattern}",
    "detailsExpected": "预期：“{expected}”",
    "noResultsYet": "还没有结果",
    "testCasesCount": "测试用例 ({count})",
    "noTestCasesDefined": "没有定义测试用例",
    "runEvalHint": "点击“运行评测”即可对你的 LLM 端点执行所有案例。每次测试都会通过 ZavorthGateway 发送真实请求。",
    ...
    "modelEvals": "模型评估",
    "evalsHeroDescription": "通过运行预定义评测套件来测试和验证你的 LLM 端点。每个套件都包含多个测试用例，会经由 ZavorthGateway 发送真实提示，并将响应与预期标准进行比较，帮助你发现回归、比较模型，并确保跨提供商的响应质量。",
  ...
  "modals": {
    ...
    "awsRegion": "AWS 区域",
    "autoDetecting": "自动检测令牌...",
    "readingFromCache": "从 AWS SSO 缓存中读取",
    "readingFromCursor": "从 Cursor IDE 数据库读取",
    "initializing": "正在初始化...",
    "pricingConfig": "定价配置",
    "loadingPricing": "正在加载定价数据...",
  ...
  "loggers": {
    ...
    "noPayloadData": "此日志条目没有可用的有效负载数据。",
    "proxyEvent": "代理事件",
    "proxy": "代理",
    "level": "等级",
    "directNative": "直接（本地）",
  ...
  "auth": {
    ...
    "unifiedAiApiProxyDesc": "通过单个端点将请求路由到多个 AI 提供商。内置负载均衡、故障转移和使用情况跟踪。",
    "passwordNotEnabled": "未启用密码保护",
    "loading": "正在加载...",
    "invalidPassword": "密码无效",
    "errorOccurredRetry": "发生错误。请再试一次。",
    "configureInstance": "开始配置你的 ZavorthGateway 实例",
    ...
    "continue": "继续",
    "windowWillClose": "该窗口将自动关闭...",
    "closeTabNow": "您现在可以关闭此选项卡。",
    "copyUrlManual": "请复制地址栏中的 URL 并将其粘贴到应用程序中。",
    "accessDeniedDescription": "您无权访问此资源。检查您的 API 密钥或联系管理员。",
    "goToZavorthControl": "转到仪表板",
    "featureMultiProviderTitle": "多提供商",
    "featureMultiProviderDesc": "OpenAI、Anthropic、Google 等",
    ...
    "stopServer": "停止 ZavorthGateway 服务器",
    "processing": "处理中...",
    "pleaseWait": "我们正在完成授权，请稍候。",
    "authSuccess": "授权成功！",
    "copyUrl": "复制此网址",
    "accessDenied": "访问被拒绝",
    "methodCliTitle": "方法 1：CLI 重置",
    "methodCliDescription": "在运行 ZavorthGateway 的服务器上运行以下命令：",
    ...
    "waitingForZavorthBridgeAuthorization": "正在等待 ZavorthBridge 授权...",
    "waitingForQoderAuthorization": "正在等待 Qoder 授权...",
    "exchangingCodeForTokens": "正在用授权码换取 Tokens...",
    "nodeIncompatibleTitle": "不兼容的 Node.js 版本",
    "nodeIncompatibleDesc": "你当前运行的是 Node.js {version}，它与 Zavorth 不兼容。原生 SQLite 模块（better-sqlite3）要求使用 Node.js 18–22 LTS。",
    "nodeIncompatibleFixLabel": "修复：安装 Node.js 22 LTS",
    "nodeIncompatibleHint": "Zavorth 要求 Node.js ≥18 且 <24。为保证稳定性，建议使用 Node 22 LTS。"
  },
  "landing": {
    "brandName": "Zavorth",
    "navigateHome": "导航至主页",
    ...
    "featuresSubtitle": "在一个地方管理 AI 基础设施所需的一切，专为规模化而构建。",
    "featureUnifiedEndpointTitle": "统一端点",
    "featureUnifiedEndpointDesc": "通过单一标准 API URL 访问所有提供商。",
    "featureEasySetupTitle": "轻松设置",
    "featureEasySetupDesc": "使用 npx 命令在几分钟内启动并运行。",
    "featureModelFallbackTitle": "模型回退",
    "featureModelFallbackDesc": "发生故障或高延迟时自动切换提供商。",
    "featureUsageTrackingTitle": "使用情况追踪",
    "featureUsageTrackingDesc": "所有模型的详细分析和成本监控。",
    "featureOAuthApiKeysTitle": "OAuth 与 API 密钥",
    ...
    "featureZavorthControlTitle": "仪表板",
    "featureZavorthControlDesc": "用于实时流量分析的可视化仪表板。",
    "howItWorks": "Zavorth 工作原理",
    ...
    "howItWorksStep2Title": "2. Zavorth 中枢",
    ...
    "getStartedDescription": "安装 Zavorth，通过 Web 仪表板配置你的提供商，然后开始路由 AI 请求。",
    "installZavorthGateway": "安装 Zavorth",
    "installStepDescription": "运行 npx 命令立即启动服务器",
    "openZavorthControl": "打开仪表板",
    "openZavorthControlStepDescription": "通过 Web 界面配置提供商和 API 密钥",
    "routeRequests": "路由请求",
    "routeRequestsStepDescription": "将您的 CLI 工具指向 {endpoint}",
    "terminal": "终端",
    "copy": "复制",
    "copied": "✓ 已复制",
    "startingZavorthGateway": "正在启动 Zavorth...",
    "serverRunningOnLabel": "服务器运行于",
    "zavorthControlLabel": "仪表板",
    ...
    "ctaDescription": "加入更多开发者，一起用 Zavorth 简化 AI 集成流程。开源且可免费开始使用。",
    "startFree": "免费开始",
  ...
  "docs": {
    ...
    "docsLabel": "文档",
    "docsHeroDescription": "面向多提供商 LLM 的 AI 网关。一个端点即可统一接入 OpenAI、Anthropic、Gemini、GitHub Copilot、Claude Code、Cursor 等 20+ 提供商。",
    "openZavorthControl": "打开仪表板",
    "endpointPage": "端点页面",
    "github": "GitHub",
    "reportIssue": "报告问题",
    "onThisPage": "在此页面上",
    "documentationVersion": "文档 - v{version}",
    "quickStartStep1Title": "1.安装并运行",
    "quickStartStep1Prefix": "运行",
    "quickStartStep1Middle": "或者从 GitHub 克隆并运行",
    ...
    "featureUsageText": "实时令牌计数、每个提供商/模型的成本计算以及按 API 密钥和帐户划分的详细使用情况细分。",
    "featureAnalyticsTitle": "分析仪表板",
    "featureAnalyticsText": "可视化分析，包含随时间变化的请求、令牌、错误、延迟、成本和模型受欢迎程度的图表。",
    ...
    "clientClaudeBullet1Suffix": "（ZavorthBridge）前缀。",
    "protocolsTitle": "协议：MCP 与 A2A",
    "protocolsDescription": "除了 OpenAI 兼容 API 之外，Zavorth 还提供两类操作协议：用于工具执行的 MCP，以及用于智能体协作工作流的 A2A。",
    "protocolMcpTitle": "MCP（Model Context Protocol）",
    "protocolMcpDesc": "通过 stdio 使用 MCP，让客户端发现并调用 Zavorth 工具，同时具备审计可见性。",
    "protocolMcpStep1": "使用 `zavorth --mcp` 启动 MCP 传输。",
    "protocolMcpStep2": "将你的 MCP 客户端指向 stdio 传输。",
    "protocolMcpStep3": "调用 `ZavorthGateway_get_health` 和 `ZavorthGateway_list_combos` 验证连通性。",
    ...
    "protocolA2aStep2": "向 `POST /a2a` 发送 `message/send` 或 `message/stream` 请求。",
    "protocolA2aStep3": "通过 `tasks/get` 和 `tasks/cancel` 管理任务生命周期。",
    ...
    "protocolTroubleshooting3": "可使用 `/zavorthControl/mcp` 和 `/zavorthControl/a2a` 进行运行控制并查看审计信息。",
  ...
  "legal": {
    ...
    "viewExportAnalytics": "查看和导出使用情况分析",
    "clearHistory": "随时清除使用记录",
    "configureRetention": "配置日志保留策略",
    "backupRestore": "备份和恢复您的数据库",
    "privacyMetadataTitle": "隐私政策 | Zavorth",
    "privacyMetadataDescription": "Zavorth AI API 代理路由器的隐私政策。",
    "termsMetadataTitle": "服务条款 | Zavorth",
    "termsMetadataDescription": "Zavorth AI API 代理路由器的服务条款。",
    "backToHome": "返回首页",
    ...
    "privacySection1Text": "Zavorth 是一款本地优先的应用。所有数据处理和存储都只发生在你的设备上，不存在集中式服务器收集你的信息。",
    ...
    "privacySection3Text": "Zavorth 不收集遥测、分析或崩溃报告。不会向我们或任何第三方发送数据。你的使用模式、API 调用和配置都会保持私密。",
    "privacySection4Title": "4. 第三方 AI 提供商",
    "privacySection4Text": "当你通过 Zavorth 发起 API 调用时，请求会被转发到你配置的 AI 提供商（例如：OpenAI、Anthropic、Google）。这些提供商有各自的隐私政策，请查阅：",
    ...
    "privacyLoggingIntro": "可以通过仪表板设置配置请求日志。您可以：",
    "privacySection7Title": "7. 您的权利",
    ...
    "termsSection1Text": "Zavorth 是一款本地优先的 AI API 代理路由器，完全运行在你的设备上。它通过负载均衡、故障回退和用量跟踪，将请求路由到多个 AI 提供商。",
    "termsSection2Title": "2. 用户的责任",
    "termsResponsibilityApiKeys": "你需要自行负责管理自己的 API 密钥，以及第三方 AI 提供商（OpenAI、Anthropic、Google 等）的凭证。",
    "termsResponsibilityCompliance": "你必须遵守通过 Zavorth 访问的每个 AI 提供商的服务条款。",
    "termsResponsibilitySecurity": "你需要负责本地 Zavorth 安装的安全，包括设置密码和限制网络访问。",
    "termsSection3Title": "3. 工作原理",
    "termsSection3Text": "Zavorth 充当中间代理。发送到 Zavorth 的 API 调用会被转换后转发到你配置的 AI 提供商。除必要的协议转换外，Zavorth 不会修改你的请求或响应内容。",
    "termsSection4Title": "4. 数据处理",
    "termsDataStoredLocally": "所有数据都保存在你本机上的 SQLite 数据库中。",
    "termsNoTransmission": "除非你明确启用云同步功能，否则 Zavorth 不会将任何数据传输到外部服务器。",
    "termsDataLocationText": "使用日志、API 密钥和配置存储在",
    "termsSection5Title": "5. 免责声明",
    "termsSection5Text": "Zavorth 按“原样”提供，不附带任何形式的保证。我们不对 API 使用成本、服务中断或数据丢失造成的任何损失负责。请始终为配置做好备份。",
    "termsSection6Title": "6. 开源",
    "termsSection6Text": "Zavorth 是开源软件。您可以根据其许可条款自由检查、修改和分发它。"
  },
  "agents": {
    "title": "CLI 智能体",
    ...
    "opencodeDesc": "生成可直接使用的 {configFile}，其中会填入你的 ZavorthGateway Base URL 和全部可用模型。将它放到项目根目录后运行 {command} 即可。",
    "downloadConfig": "下载 {file}",
    "downloaded": "已下载！",
    "setupGuideTitle": "设置指南",
    "openCliTools": "打开 CLI Tools",
    "setupGuideDetectCliTitle": "检测已安装的 CLI",
    "setupGuideDetectCliDesc": "安装或更新 CLI 后点击“刷新”，让 ZavorthGateway 重新扫描可执行文件和版本信息。",
  ...
  "cache": {
    ...
    "behaviorTwoTier": "双层存储：内存 LRU（快速）+ SQLite（重启后持久化）。",
    "behaviorTtl": "默认 TTL：30 分钟。可通过 {envVar} 配置。",
    "idempotency": "幂等层",
    ...
    "expires": "到期时间",
    "actions": "操作",
    "deduplicatedRequests": "去重请求数",
    "savedCalls": "节省的 API 调用次数",
    "totalProcessed": "已处理请求总数"
  },
  "memory": {
    "title": "记忆管理",
    "description": "查看并管理已存储的记忆条目",
    "memories": "记忆",
    "totalEntries": "总条目数",
  ...
  "skills": {
    ...
    "sandboxConfig": "沙箱配置",
    "cpuLimit": "CPU 限制",
    "cpuLimitDesc": "单个技能允许的最长执行时间",
    "memoryLimit": "内存限制",
    "memoryLimitDesc": "允许分配的最大内存",
    "timeout": "超时",
