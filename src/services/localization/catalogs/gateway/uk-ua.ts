...
export const gateway_uk_ua: GatewayCatalogSection = {
  "common": {
    "save": "зберегти",
    "cancel": "Скасувати",
    "delete": "Видалити",
  ...
  "sidebar": {
    "home": "додому",
    "zavorthControl": "Приладова панель",
    ...
    "shutdown": "Вимкнути",
    "restart": "Перезапуск",
    "shutdownConfirm": "Вимкнути ZavorthGateway...",
    "restartConfirm": "Перезапустити ZavorthGateway...",
    "version": "v{version}",
    "debug": "Налагодження",
    "system": "система",
    "help": "Довідка",
  ...
  "header": {
    ...
    "home": "додому",
    "homeDescription": "Ласкаво просимо до Zavorth",
    "endpoint": "Endpoints",
  ...
  "cliTools": {
    ...
    "defaultZavorthGatewayKey": "sk_ZavorthGateway (за замовчуванням)",
    ...
    "zavorthBridgeHowWorksDesc": "Антигравітація надсилає запити до кінцевої точки Google. MITM перехоплює та перенаправляє їх на ZavorthGateway.",
    "zavorthBridgeStep1": "1. Запустіть MITM для маршрутизації запитів через ZavorthGateway.",
    "zavorthBridgeStep2Prefix": "2. Додайте",
    "zavorthBridgeStep2Suffix": "у ваш файл hosts як 127.0.0.1.",
    "zavorthBridgeStep3": "3. Відкрийте Антигравітацію, і запити будуть надсилатися через проксі.",
    ...
    "failed": "Не вдалося",
    "resetDone": "Скинути!",
    "ZavorthGatewayConfiguredOpenAiCompatible": "ZavorthGateway налаштовано як постачальник, сумісний з OpenAI",
    "provider": "Провайдер",
    "model": "Модель",
    "providers": "Провайдери",
    "auth": "Авт",
    "noApiKeysAvailable": "Немає доступних ключів API",
    "usingDefaultZavorthGateway": "За замовчуванням: sk_ZavorthGateway",
    ...
    "toolUseCases": {
      ...
      "cline": "Використовуйте, коли ви налаштовуєте агенти кодування в редакторах і бажаєте кероване налаштування за допомогою моделей ZavorthGateway.",
      "kilo": "Використовуйте, коли ваш робочий процес залежить від команд Kilo Code та швидких ітеративних редагувань.",
      "cursor": "Використовуйте під час кодування в Cursor, і вам потрібні власні моделі, сумісні з OpenAI через ZavorthGateway.",
      ...
      "kiro": "Використовуйте під час інтеграції Kiro та централізованого керування маршрутизацією моделі з ZavorthGateway.",
      "zavorthBridge": "Використовуйте, коли трафік ZavorthBridge/Kiro потрібно перехопити через MITM і направити на ZavorthGateway.",
      "copilot": "Використовуйте, коли вам потрібен UX у стилі чату Copilot із застосуванням ключів ZavorthGateway і правил маршрутизації.",
      "external-executor": "Use when you want a governed local or WSL coding executor routed through ZavorthGateway policies."
    },
    "toolDescriptions": {
      "zavorthBridge": "Google ZavorthBridge IDE з MITM",
    ...
    "guides": {
      ...
      "opencode": {
        ...
        "notes": {
          ...
          "1": "Установіть базову URL-адресу для кінцевої точки ZavorthGateway."
        }
      },
      "kiro": {
        "steps": {
  ...
  "health": {
    ...
    "description": "Моніторинг вашого екземпляра ZavorthGateway у реальному часі",
    "healthy": "Здоровий",
    ...
    "configuredProvidersHint": "Постачальники з обліковими даними, збереженими в /zavorthControl/providers, незалежно від стану виконання.",
  ...
  "onboarding": {
    ...
    "goToZavorthControl": "Перейдіть на інформаційну панель →",
    "welcomeDesc": "ZavorthGateway — це ваш локальний проксі-сервер AI API. Він направляє запити до кількох постачальників штучного інтелекту за допомогою балансування навантаження, відновлення після відмови та відстеження використання.",
    ...
    "doneDesc": "Усе готово! Ваш екземпляр ZavorthGateway налаштований і готовий проксі-сервер запитів ШІ.",
  ...
  "translator": {
    "title": "Перекладач",
    "metaTitle": "Ігровий майданчик для перекладачів | ZavorthGateway",
    ...
    "modeDescriptionPlayground": "Вставте будь-яке тіло запиту API та подивіться, як ZavorthGateway перекладає його між форматами постачальників (OpenAI ↔ Claude ↔ Gemini ↔ Responses API)",
    "modeDescriptionChatTester": "Надсилайте реальні запити чату через ZavorthGateway та перевіряйте повний цикл: введення, перекладений запит, відповідь постачальника та перекладений вихід.",
    ...
    "modeDescriptionLiveMonitor": "Переглядайте події перекладу в режимі реального часу, коли запити надходять через ZavorthGateway.",
    "modeDescriptionFallback": "Налагоджуйте, тестуйте та візуалізуйте, як ZavorthGateway перекладає запити API між постачальниками.",
    ...
    "paused": "Призупинено",
    "eventsAppearHint": "Події перекладу з’являються тут, коли запити проходять через ZavorthGateway. Використовуйте будь-який із цих методів для створення подій:",
    ...
    "formatConverterDescription": "Вставте або введіть тіло запиту JSON. Перекладач автоматично визначить вихідний формат і перетворить його на цільовий формат. Використовуйте це, щоб налагодити, як ZavorthGateway перекладає запити між форматами (OpenAI ↔ Claude ↔ Gemini ↔ Responses API).",
    "input": "Введення",
    "output": "Вихід",
    "auto": "Авто",
    ...
    "formatDetectedDescription": "ZavorthGateway автоматично визначає формат API зі структури запиту",
    ...
    "liveMonitorDescriptionPrefix": "Показує події перекладу, коли виклики API проходять через ZavorthGateway. Події надходять із буфера в пам'яті (скидається під час перезавантаження). використання",
  ...
  "usage": {
    ...
    "run": "бігти",
    "runStepDescription": "Виконуйте тестові випадки на кінцевих точках LLM через ZavorthGateway. Кожен випадок надсилається як справжній запит API.",
    "evaluate": "Оцініть",
    ...
    "runEvalHint": "Натисніть «Run Eval», щоб виконати всі кейси щодо вашої кінцевої точки LLM. Кожен тест надсилає реальний запит через ZavorthGateway.",
    ...
    "evalsHeroDescription": "Протестуйте та перевірте свої кінцеві точки LLM, запустивши попередньо визначені пакети оцінок. Кожен набір містить тестові випадки, які надсилають реальні підказки через ZavorthGateway та порівнюють відповіді з очікуваними критеріями, допомагаючи вам виявити регресії, порівняти моделі та забезпечити якість відповіді між провайдерами.",
  ...
  "auth": {
    ...
    "configureInstance": "Давайте налаштуємо ваш екземпляр ZavorthGateway",
    ...
    "stopServer": "Зупиніть роботу сервера ZavorthGateway",
    "processing": "Обробка...",
    ...
    "methodCliDescription": "Виконайте таку команду на сервері, де запущено ZavorthGateway:",
    ...
    "newPasswordPlaceholder": "ваш_новий_пароль",
    ...
    "waitingForZavorthBridgeAuthorization": "Очікування авторизації ZavorthBridge...",
  ...
  "landing": {
    ...
    "featureZavorthControlTitle": "Приладова панель",
    "featureZavorthControlDesc": "Візуальна інформаційна панель для аналізу трафіку в реальному часі.",
    "howItWorks": "Як працює Zavorth",
    ...
    "getStartedDescription": "Встановіть Zavorth, налаштуйте своїх провайдерів за допомогою веб-панелі та почніть маршрутизувати запити ШІ.",
    "installZavorthGateway": "Встановіть Zavorth",
    "installStepDescription": "Виконайте команду npx, щоб миттєво запустити сервер",
    "openZavorthControl": "Відкрийте інформаційну панель",
    "openZavorthControlStepDescription": "Налаштуйте провайдерів і ключі API через веб-інтерфейс",
    "routeRequests": "Запити на маршрут",
    "routeRequestsStepDescription": "Спрямуйте свої інструменти CLI на {endpoint}",
    "terminal": "термінал",
    "copy": "Копія",
    "copied": "✓ Скопійовано",
    "startingZavorthGateway": "Запуск Zavorth...",
    "serverRunningOnLabel": "Сервер працює",
    "zavorthControlLabel": "Приладова панель",
    ...
    "product": "Продукт",
    "zavorthControlLink": "Приладова панель",
    ...
    "copyright": "© {year} Zavorth. Всі права захищені.",
    ...
    "ctaDescription": "Приєднуйтесь до розробників, які оптимізують свою інтеграцію ШІ за допомогою Zavorth. З відкритим вихідним кодом і безкоштовно.",
  ...
  "legal": {
    ...
    "privacyMetadataTitle": "Політика конфіденційності | Zavorth",
    "privacyMetadataDescription": "Політика конфіденційності для проксі-маршрутизатора Zavorth AI API.",
    "termsMetadataTitle": "Умови надання послуг | Zavorth",
    "termsMetadataDescription": "Умови використання проксі-маршрутизатора Zavorth AI API.",
    ...
    "privacySection1Text": "Zavorth створено як локальну програму. Уся обробка та зберігання даних відбувається повністю на вашій машині. Немає централізованого сервера, який би збирав вашу інформацію.",
    ...
    "privacySection3Text": "Zavorth не збирає дані телеметрії, аналітику чи звіти про збої. Жодні дані не надсилаються ні нам, ні будь-якій третій стороні. Ваші моделі використання, виклики API та конфігурації залишаються повністю приватними.",
    "privacySection4Title": "4. Сторонні постачальники штучного інтелекту",
    "privacySection4Text": "Коли ви здійснюєте виклики API через Zavorth, ваші запити пересилаються до налаштованих вами постачальників штучного інтелекту (наприклад: OpenAI, Anthropic, Google). Ці постачальники мають власні політики конфіденційності, які визначають, як вони обробляють ваші дані. Будь ласка, перегляньте:",
    ...
    "termsSection1Text": "Zavorth — це локальний проксі-маршрутизатор API API, який повністю працює на вашому комп’ютері. Він направляє запити до кількох постачальників штучного інтелекту за допомогою балансування навантаження, відновлення після відмови та відстеження використання.",
    ...
    "termsResponsibilityCompliance": "Ви повинні дотримуватися умов обслуговування кожного постачальника штучного інтелекту, до API якого ви отримуєте доступ через Zavorth.",
    "termsResponsibilitySecurity": "Ви несете відповідальність за безпеку локальної інсталяції Zavorth, включаючи встановлення пароля та обмеження доступу до мережі.",
    "termsSection3Title": "3. Як це працює",
    "termsSection3Text": "Zavorth діє як проксі-сервер-посередник. Виклики API, надіслані до Zavorth, перекладаються та пересилаються вашим налаштованим постачальникам AI. Zavorth не змінює вміст ваших запитів або відповідей крім необхідного перекладу протоколу.",
    ...
    "termsNoTransmission": "Zavorth не передає жодних даних на зовнішні сервери, якщо ви явно не активуєте функції хмарної синхронізації.",
    ...
    "termsSection5Text": "Zavorth надається «як є» без будь-яких гарантій. Ми не несемо відповідальності за будь-які витрати, пов’язані з використанням API, перебоями в роботі служби або втратою даних. Завжди створюйте резервні копії вашої конфігурації.",
    "termsSection6Title": "6. Відкритий код",
    "termsSection6Text": "Zavorth — це програмне забезпечення з відкритим кодом. Ви можете вільно перевіряти, змінювати та поширювати його відповідно до умов його ліцензії."
  },
  "agents": {
    "title": "CLI Agents",
