...
export const gateway_bg: GatewayCatalogSection = {
  "common": {
    "save": "Запазване",
    "cancel": "Отказ",
    "delete": "Изтриване",
  ...
  "sidebar": {
    ...
    "shutdownConfirm": "Изключване на ZavorthGateway...",
    "restartConfirm": "Рестартиране на ZavorthGateway...",
    "version": "v{version}",
  ...
  "header": {
    ...
    "home": "Начало",
    "homeDescription": "Добре дошли в Zavorth",
    "endpoint": "Endpoints",
  ...
  "cliTools": {
    ...
    "defaultZavorthGatewayKey": "sk_ZavorthGateway (по подразбиране)",
    ...
    "zavorthBridgeHowWorksDesc": "ZavorthBridge изпраща заявки до крайната точка на Google. MITM ги прихваща и пренасочва към ZavorthGateway.",
    "zavorthBridgeStep1": "1. Стартирайте MITM, за да маршрутизирате заявки през ZavorthGateway.",
    "zavorthBridgeStep2Prefix": "2. Добавете",
    "zavorthBridgeStep2Suffix": "към вашия хост файл като 127.0.0.1.",
    "zavorthBridgeStep3": "3. Отворете ZavorthBridge и заявките ще бъдат проксиирани.",
    ...
    "failed": "Неуспешно",
    "resetDone": "Нулиране!",
    "ZavorthGatewayConfiguredOpenAiCompatible": "ZavorthGateway е конфигуриран като OpenAI-съвместим доставчик",
    "provider": "Доставчик",
    "model": "Модел",
    "providers": "Доставчици",
    "auth": "авт",
    "noApiKeysAvailable": "Няма налични API ключове",
    "usingDefaultZavorthGateway": "Използва се по подразбиране: sk_ZavorthGateway",
    ...
    "toolUseCases": {
      ...
      "cline": "Използвайте, когато конфигурирате кодиращи агенти вътре в редактори и искате насочвана настройка с ZavorthGateway модели.",
      "kilo": "Използвайте, когато вашият работен процес зависи от команди на Kilo Code и бързи итеративни редакции.",
      "cursor": "Използвайте, когато кодирате в Cursor и имате нужда от персонализирани OpenAI-съвместими модели чрез ZavorthGateway.",
      ...
      "kiro": "Използвайте, когато интегрирате Kiro и контролирате маршрутизирането на модела централно от ZavorthGateway.",
      "zavorthBridge": "Използвайте, когато трафикът на ZavorthBridge/Kiro трябва да бъде прихванат чрез MITM и насочен към ZavorthGateway.",
      "copilot": "Използвайте, когато искате UX в стил на чат Copilot, като същевременно налагате ZavorthGateway ключове и правила за маршрутизиране.",
    ...
    "guides": {
      ...
      "opencode": {
        ...
        "notes": {
          ...
          "1": "Задайте основния URL адрес на вашата крайна точка ZavorthGateway."
        }
      },
      "kiro": {
        "steps": {
  ...
  "endpoint": {
    ...
    "openMcpZavorthControl": "Отворено управление на MCP",
    "openA2aZavorthControl": "Отворено управление на A2A",
    "mcpQuickStartTitle": "Button text: start playing a game",
    "mcpQuickStartStep1": "Стартирайте MCP сървъра чрез `ZavorthGateway --mcp`.",
  ...
  "health": {
    ...
    "description": "Мониторинг в реално време на вашето копие ZavorthGateway",
    "healthy": "Здрави",
    "degraded": "Деградирал",
    "down": "Надолу",
    ...
    "configuredProvidersHint": "Доставчици с идентификационни данни, записани в /zavorthControl/providers, независимо от състоянието на изпълнение.",
  ...
  "onboarding": {
    ...
    "goToZavorthControl": "Отидете на таблото →",
    "welcomeDesc": "ZavorthGateway е вашият местен AI API прокси. Той насочва заявки към множество доставчици на AI с балансиране на натоварването, преход при срив и проследяване на използването.",
    ...
    "doneDesc": "Всичко е готово! Вашето копие на ZavorthGateway е конфигурирано и готово за прокси заявки за AI.",
  ...
  "translator": {
    "title": "Преводач",
    "metaTitle": "Площадка за преводачи | ZavorthGateway",
    ...
    "modeDescriptionPlayground": "Поставете произволно тяло на заявка за API и вижте как ZavorthGateway го превежда между формати на доставчик (OpenAI ↔ Claude ↔ Gemini ↔ Responses API)",
    "modeDescriptionChatTester": "Изпращайте реални заявки за чат през ZavorthGateway и проверявайте пълното двупосочно пътуване: въвеждане, преведена заявка, отговор на доставчика и преведен изход.",
    ...
    "modeDescriptionLiveMonitor": "Гледайте събития за превод в реално време, докато заявките преминават през ZavorthGateway.",
    "modeDescriptionFallback": "Отстранете грешки, тествайте и визуализирайте как ZavorthGateway превежда API заявки между доставчици.",
    ...
    "paused": "На пауза",
    "eventsAppearHint": "Събитията за превод се появяват тук, когато заявките преминават през ZavorthGateway. Използвайте някой от тези методи за генериране на събития:",
    ...
    "formatConverterDescription": "Поставете или въведете JSON тяло на заявка. Преводачът автоматично ще открие изходния формат и ще го преобразува в целевия формат. Използвайте това за отстраняване на грешки как ZavorthGateway превежда заявки между формати (OpenAI ↔ Claude ↔ Gemini ↔ Responses API).",
    "input": "Вход",
    "output": "Изход",
    "auto": "Авто",
    ...
    "formatDetectedDescription": "ZavorthGateway автоматично открива формата на API от структурата на заявката",
    ...
    "liveMonitorDescriptionPrefix": "Показва събития за превод, докато извикванията на API протичат през ZavorthGateway. Събитията идват от буфера в паметта (нулира се при рестартиране). Използвайте",
  ...
  "usage": {
    ...
    "run": "Бягай",
    "runStepDescription": "Изпълнете тестови случаи срещу вашите LLM крайни точки чрез ZavorthGateway. Всеки случай се изпраща като истинска заявка за API.",
    "evaluate": "Оценете",
    ...
    "runEvalHint": "Щракнете върху „Run Eval“, за да изпълните всички случаи срещу вашата крайна точка на LLM. Всеки тест изпраща истинска заявка през ZavorthGateway.",
    ...
    "evalsHeroDescription": "Тествайте и валидирайте вашите LLM крайни точки, като стартирате предварително дефинирани пакети за оценка. Всеки пакет съдържа тестови случаи, които изпращат реални подкани чрез ZavorthGateway и сравняват отговорите спрямо очакваните критерии – като ви помагат да откриете регресии, да сравните модели и да гарантирате качество на отговора между доставчиците.",
  ...
  "auth": {
    ...
    "configureInstance": "Нека да конфигурираме вашето копие на ZavorthGateway",
    ...
    "goToZavorthControl": "Отидете на таблото за управление",
    ...
    "stopServer": "Спрете сървъра ZavorthGateway",
    ...
    "methodCliDescription": "Изпълнете следната команда на сървъра, където се изпълнява ZavorthGateway:",
    ...
    "waitingForZavorthBridgeAuthorization": "Изчаква се разрешение за антигравитация...",
  ...
  "landing": {
    ...
    "featureZavorthControlTitle": "Табло",
    "featureZavorthControlDesc": "Визуално табло за анализ на трафика в реално време.",
    "howItWorks": "Как работи Zavorth",
    ...
    "getStartedDescription": "Инсталирайте Zavorth, конфигурирайте вашите доставчици чрез уеб таблото за управление и започнете да маршрутизирате AI заявки.",
    "installZavorthGateway": "Инсталирайте Zavorth",
    "installStepDescription": "Изпълнете командата npx, за да стартирате сървъра незабавно",
    "openZavorthControl": "Отворете таблото за управление",
    "openZavorthControlStepDescription": "Конфигурирайте доставчици и API ключове чрез уеб интерфейс",
    "routeRequests": "Заявки за маршрути",
    "routeRequestsStepDescription": "Насочете вашите CLI инструменти към {endpoint}",
    "terminal": "терминал",
    "copy": "копие",
    "copied": "✓ Копирано",
    "startingZavorthGateway": "Стартиране на Zavorth...",
    "serverRunningOnLabel": "Сървърът работи",
    "zavorthControlLabel": "Табло",
    ...
    "copyright": "© {year} Zavorth. Всички права запазени.",
    ...
    "ctaDescription": "Присъединете се към разработчици, които рационализират своите AI интеграции с Zavorth. Отворен код и безплатен за стартиране.",
  ...
  "docs": {
    ...
    "protocolsDescription": "Zavorth излага два оперативни протокола в допълнение към съвместимите с OpenAI API: MCP за изпълнение на инструменти и A2A за работни процеси от агент към агент.",
    "protocolMcpTitle": "MCP (Model Context Protocol)",
    "protocolMcpDesc": "Използвайте MCP през stdio, за да позволите на клиентите да открият и извикат Zavorth инструменти с видимост на одита.",
    "protocolMcpStep1": "Започнете MCP транспорт с @@PH0 @@.",
    "protocolMcpStep2": "Насочете вашия MCP клиент към stdio Transport.",
    "protocolMcpStep3": "Обадете се на @@ PH0 @@ и `ZavorthGateway_list_combos`, за да потвърдите връзката.",
    ...
    "protocolTroubleshooting3": "Използвайте `/zavorthControl/mcp` и @@ PH1@@ за оперативен контрол и видимост на одита.",
  ...
  "legal": {
    ...
    "privacyMetadataTitle": "Политика за поверителност | Zavorth",
    "privacyMetadataDescription": "Политика за поверителност за Zavorth AI API прокси рутер.",
    "termsMetadataTitle": "Условия за ползване | Zavorth",
    "termsMetadataDescription": "Условия на услугата за Zavorth AI API прокси рутер.",
    ...
    "privacySection1Text": "Zavorth е проектиран като първо локално приложение. Цялата обработка и съхранение на данни се извършва изцяло на вашата машина. Няма централизиран сървър, който да събира вашата информация.",
    ...
    "privacySection3Text": "Zavorth не събира телеметрични данни, анализи или доклади за сривове. Никакви данни не се изпращат до нас или трета страна. Вашите модели на използване, API извиквания и конфигурации остават изцяло лични.",
    "privacySection4Title": "4. Доставчици на AI трети страни",
    "privacySection4Text": "Когато правите API извиквания чрез Zavorth, вашите заявки се препращат към доставчиците на AI, които сте конфигурирали (например: OpenAI, Anthropic, Google). Тези доставчици имат свои собствени правила за поверителност, които управляват начина, по който обработват вашите данни. Моля, прегледайте:",
    ...
    "termsSection1Text": "Zavorth е първи локален AI API прокси рутер, който работи изцяло на вашата машина. Той насочва заявки към множество доставчици на AI с балансиране на натоварването, преход при срив и проследяване на използването.",
    ...
    "termsResponsibilityCompliance": "Трябва да спазвате условията за обслужване на всеки доставчик на AI, до чиито API имате достъп чрез Zavorth.",
    "termsResponsibilitySecurity": "Вие носите отговорност за сигурността на вашата локална инсталация на Zavorth, включително задаване на парола и ограничаване на достъпа до мрежата.",
    "termsSection3Title": "3. Как работи",
    "termsSection3Text": "Zavorth действа като междинен прокси. Извикванията на API, изпратени до Zavorth, се превеждат и препращат към вашите конфигурирани доставчици на AI. Zavorth не променя съдържанието на вашите заявки или отговори извън необходимия превод на протокола.",
    ...
    "termsNoTransmission": "Zavorth не предава никакви данни към външни сървъри, освен ако изрично не активирате функциите за синхронизиране в облак.",
    ...
    "termsSection5Text": "Zavorth се предоставя „както е“ без каквато и да е гаранция. Ние не носим отговорност за каквито и да било разходи, възникнали поради използване на API, прекъсвания на услугата или загуба на данни. Винаги поддържайте резервни копия на вашата конфигурация.",
    "termsSection6Title": "6. Отворен код",
    "termsSection6Text": "Zavorth е софтуер с отворен код. Вие сте свободни да го инспектирате, модифицирате и разпространявате съгласно условията на неговия лиценз."
  },
  "agents": {
    "title": "CLI Agents",
