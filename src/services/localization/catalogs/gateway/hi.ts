...
export const gateway_hi: GatewayCatalogSection = {
  "common": {
    "save": "सहेजें",
    "cancel": "रद्द करें",
    "delete": "हटाएँ",
  ...
  "cliTools": {
    ...
    "defaultZavorthGatewayKey": "sk_ZavorthGateway (डिफ़ॉल्ट)",
    ...
    "zavorthBridgeHowWorksDesc": "एंटीग्रेविटी Google के एंडपॉइंट पर अनुरोध भेजती है। एमआईटीएम उन्हें रोकता है और ओमनीरूट पर पुनर्निर्देशित करता है।",
    "zavorthBridgeStep1": "1. ओमनीरूट के माध्यम से अनुरोधों को रूट करने के लिए एमआईटीएम प्रारंभ करें।",
    "zavorthBridgeStep2Prefix": "2. जोड़ें",
    "zavorthBridgeStep2Suffix": "आपकी होस्ट फ़ाइल में 127.0.0.1 के रूप में।",
    "zavorthBridgeStep3": "3. एंटीग्रेविटी खोलें और अनुरोधों को प्रॉक्सी किया जाएगा।",
    ...
    "ZavorthGatewayConfiguredOpenAiCompatible": "ओम्निरूट को OpenAI-संगत प्रदाता के रूप में कॉन्फ़िगर किया गया है",
    "provider": "प्रदाता",
    "model": "मॉडल",
    "providers": "प्रदाता",
    "auth": "प्रामाणिक",
    "noApiKeysAvailable": "कोई API कुंजी उपलब्ध नहीं है",
    "usingDefaultZavorthGateway": "डिफ़ॉल्ट का उपयोग करना: sk_ZavorthGateway",
    ...
    "toolUseCases": {
      ...
      "zavorthBridge": "इसका उपयोग तब करें जब एंटीग्रेविटी/किरो ट्रैफिक को एमआईटीएम के माध्यम से रोका जाना चाहिए और ओमनीरूट पर भेजा जाना चाहिए।",
    ...
    "toolDescriptions": {
      "zavorthBridge": "एमआईटीएम के साथ गूगल एंटीग्रेविटी आईडीई",
  ...
  "onboarding": {
    ...
    "goToZavorthControl": "डैशबोर्ड → पर जाएँ",
  ...
  "usage": {
    ...
    "defineStepDescription": "सम्‍मिलित, रेगेक्स, या सटीक मिलान जैसी रणनीतियों का उपयोग करके इनपुट संकेतों और अपेक्षित आउटपुट मानदंडों के साथ परीक्षण मामले बनाएं।",
    "run": "भागो",
    ...
    "noEvalSuitesDescription": "इवल सुइट्स को एपीआई या कोड के माध्यम से परिभाषित किया जा सकता है। वे सम्‍मिलित, रेगेक्स, सटीक मिलान और कस्टम फ़ंक्शंस जैसी रणनीतियों का उपयोग करके अपेक्षित परिणामों के विरुद्ध मॉडल आउटपुट का परीक्षण करते हैं।",
    "columnCase": "मामला",
    "columnStatus": "स्थिति",
  ...
  "landing": {
    ...
    "featureZavorthControlTitle": "डैशबोर्ड",
    "featureZavorthControlDesc": "वास्तविक समय ट्रैफ़िक विश्लेषण के लिए विज़ुअल डैशबोर्ड।",
    ...
    "installZavorthGateway": "ओम्निरूट स्थापित करें",
    "installStepDescription": "सर्वर को तुरंत प्रारंभ करने के लिए npx कमांड चलाएँ",
    "openZavorthControl": "डैशबोर्ड खोलें",
    "openZavorthControlStepDescription": "वेब इंटरफ़ेस के माध्यम से प्रदाताओं और एपीआई कुंजियों को कॉन्फ़िगर करें",
    "routeRequests": "मार्ग अनुरोध",
    "routeRequestsStepDescription": "अपने सीएलआई टूल को {endpoint} पर इंगित करें",
    "terminal": "टर्मिनल",
    "copy": "प्रतिलिपि",
    "copied": "✓ कॉपी किया गया",
    "startingZavorthGateway": "ओम्निरूट प्रारंभ हो रहा है...",
    "serverRunningOnLabel": "सर्वर चालू है",
    "zavorthControlLabel": "डैशबोर्ड",
