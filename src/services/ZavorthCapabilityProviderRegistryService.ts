import {
  ...
  type ZavorthCapabilityProviderZavorthControlProjection,
...
export class ZavorthCapabilityProviderRegistryService {
  ...
  }): ZavorthCapabilityProviderZavorthControlProjection {
...
function card(
  ...
  value: string,
  detail: string,
): ZavorthCapabilityProviderZavorthControlProjection['cards'][number] {
