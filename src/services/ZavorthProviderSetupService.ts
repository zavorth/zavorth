...
const PRIVATE_HOST_PATTERN = /^(?:https?:\/\/)?(?:(?:10|127)(?:\.|:)|localhost(?::|\/|$)|(?:172\.(?:1[6-9]|2\d|3[0-1]))\.|192\.168\.|169\.254\.|0\.0\.0\.0|::1)/i;
...
export class ZavorthProviderSetupService {
  public preview(input: ZavorthProviderSetupInput): ZavorthProviderSetupPreview {
    ...
    const localLoopback = Boolean(targetHost && PRIVATE_HOST_PATTERN.test(targetHost));
