...
export const ZAVORTH_NATIVE_SKILL_DEFINITIONS: ZavorthNativeSkillDefinition[] = [
  ...
  skill('channel-response-design', 'Channel Response Design', 'Shape dense, consistent responses for Telegram, WhatsApp, Signal, Discord, iMessage, CLI, and zavorthControl surfaces.', 'channels', 'local-readonly', 'low', ['workflow'], ['basic', 'ops', 'power-user']),
  ...
  skill('zavorthControl-ops', 'ZavorthControl Ops', 'Translate runtime state into dense operational zavorthControl cards, tables, filters, and safe action models.', 'operations', 'local-readonly', 'low', ['workflow', 'data'], ['ops', 'developer', 'power-user']),
