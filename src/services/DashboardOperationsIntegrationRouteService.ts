...
export type DashboardOperationsIntegrationRouteDeps = {
...
export class DashboardOperationsIntegrationRouteService {
  public async handleRequest(
    req: http.IncomingMessage,
    res: http.ServerResponse,
    url: URL,
    pathname: string,
    deps: DashboardOperationsIntegrationRouteDeps,
  ): Promise<boolean> {
