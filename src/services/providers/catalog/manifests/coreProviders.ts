    ...
    families: [
      {
        ...
        secondaryModelNames: ['gemini-2.5-pro'],
    ...
    routes: [
      {
        ...
        modalities: ['text', 'image', 'tool'],
        models: [
          { modelId: 'gpt-4o', label: 'GPT-4o', primary: true },
    ...
    families: [
      {
        ...
        secondaryModelNames: ['claude-3-opus-20240229'],
        fallbackModelNames: [],
        capabilities: ['chat', 'coding', 'reasoning', 'streaming', 'tool_use', 'long_context'],
        modalities: ['text', 'tool'],
      },
    ...
    routes: [
      {
        ...
        modalities: ['text', 'tool'],
        models: [
          { modelId: 'claude-3-5-sonnet-latest', label: 'Claude 3.5 Sonnet', primary: true },
          { modelId: 'claude-3-opus-20240229', label: 'Claude 3 Opus' },
        ],
      },
      {
        routeId: 'claude',
