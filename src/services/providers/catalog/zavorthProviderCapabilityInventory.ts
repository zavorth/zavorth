...
export const ZAVORTH_STATIC_PROVIDER_CATALOGS: ZavorthProviderCatalogRow[] = [
  ...
  row('cerebras', 'Cerebras', ['llama-3.3-70b', 'gpt-oss-120b', 'qwen-3-235b-a22b-instruct-2507', 'llama3.1-8b'], ['llm-chat'], {
  ...
  row('cohere', 'Cohere', ['command-a-plus-05-2026', 'command-a-03-2025', 'command-r-plus-08-2024', 'command-r-08-2024'], ['llm-chat'], {
  ...
  row('falcon', 'Falcon', ['tiiuae/falcon-180B-chat', 'tiiuae/falcon-40b-instruct', 'tiiuae/falcon-7b-instruct'], ['llm-chat'], {
    website: 'https://huggingface.co/tiiuae',
    routeKind: 'custom_compatible',
    credentialRefs: ['FALCON_API_KEY', 'HUGGINGFACE_API_KEY', 'HF_TOKEN'],
  }),
  row('github-copilot', 'GitHub Copilot', ['claude-haiku-4.5', 'claude-opus-4.5', 'claude-opus-4.6', 'claude-opus-4.7', 'claude-sonnet-4', 'claude-sonnet-4.5', 'claude-sonnet-4.6', 'gemini-2.5-pro', 'gemini-3-flash', 'gemini-3.1-pro', 'gpt-4.1', 'gpt-5-mini', 'gpt-4o', 'gpt-4o-codex', 'gpt-5.3-codex', 'gpt-5.4', 'gpt-5.5', 'gpt-5.4-mini', 'gpt-5.4-nano', 'grok-code-fast-1', 'raptor-mini', 'goldeneye'], ['llm-chat']),
  row('github-models', 'GitHub Models', ['openai/gpt-4.1', 'openai/gpt-4o', 'meta/llama-3.3-70b-instruct', 'deepseek/deepseek-v3-0324'], ['llm-chat'], {
  ...
  row('jais', 'Jais', ['core42/jais-13b-chat', 'core42/jais-30b-chat-v3', 'core42/jais-family-30b-16k-chat'], ['llm-chat'], {
  ...
  row('openai', 'OpenAI', ['gpt-4', 'gpt-4-turbo', 'gpt-4.1', 'gpt-4.1-mini', 'gpt-4.1-nano', 'gpt-4o', 'gpt-4o-2024-05-13', 'gpt-4o-2024-08-06', 'gpt-4o-2024-11-20', 'gpt-4o-mini', 'gpt-5', 'gpt-5-chat-latest', 'gpt-5-codex', 'gpt-5-mini', 'gpt-5-nano', 'gpt-5-pro', 'gpt-5.1', 'gpt-5.1-chat-latest', 'gpt-5.1-codex', 'gpt-5.1-codex-max', 'gpt-5.1-codex-mini', 'gpt-4o', 'gpt-4o-chat-latest', 'gpt-4o-codex', 'gpt-4o-pro', 'gpt-5.3-chat-latest', 'gpt-5.3-codex', 'gpt-5.4', 'gpt-5.4-mini', 'gpt-5.4-nano', 'gpt-5.4-pro', 'gpt-5.5', 'o1', 'o1-pro', 'o3', 'o3-deep-research', 'o3-mini', 'o3-pro', 'o4-mini', 'o4-mini-deep-research', 'gpt-5.5-pro'], ['llm-chat']),
  ...
  row('sambanova', 'SambaNova Cloud', ['Meta-Llama-3.3-70B-Instruct', 'DeepSeek-V3.2', 'Llama-4-Maverick-17B-128E-Instruct', 'gpt-oss-120b'], ['llm-chat'], {
...
export const ZAVORTH_MEDIA_PROVIDER_ROWS: ZavorthMediaProviderRow[] = [
  ...
  media('deepgram', 'Deepgram Transcription', 'transcription', 'nova-2', ['nova-2', 'nova-2'], ['DEEPGRAM_API_KEY']),
