...
const CATALOG: ZavorthGuidedMissionCard[] = [
  ...
  },
  {
    ...
    category: 'device-help',
    audience: ['personal', 'developer', 'power'],
    summary: 'Use Android ADB observation/control only when configured and approved.',
    ...
    approvalSummary: 'ADB observe/control requires explicit approval and host readiness.',
