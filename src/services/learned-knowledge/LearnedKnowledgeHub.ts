/**
 * Aggregated hub snapshot for Control / Desktop / CLI status (Phase 5 + 7).
...
/** Phase 7+ story preview — includes full event list for Control/Desktop (Package A). */
...
export type LearnedKnowledgeHubSnapshot = {
  ...
  oneLiner: string;
  docs: string;
  /** Phase 7 — return of buildLearnedKnowledgeAdvanced (defensive). */
  advanced?: LearnedKnowledgeAdvancedStatus;
  /** Phase 7 — short story timeline preview (defensive). */
