...
import {
  ZAVORTH_CONTROL_CONTRACT_ADAPTER_VERSION,
  type ZavorthControlContractAdapterSnapshot,
} from '../contracts/ZavorthControlContractAdapterContract.js';
import type { PermissionStatus } from '../contracts/PermissionRequest.js';

export type ZavorthControlContractAdapterInput = {
...
export class ZavorthControlContractAdapterService {
  constructor(private readonly publicApi: CanonicalPublicApiService) {}

  public async buildSnapshot(input: ZavorthControlContractAdapterInput = {}): Promise<ZavorthControlContractAdapterSnapshot> {
    ...
    return {
      contractVersion: ZAVORTH_CONTROL_CONTRACT_ADAPTER_VERSION,
      schemaVersion: 1,
      surface: 'zavorthControl-contract-adapter',
      generatedAt,
      source: {
