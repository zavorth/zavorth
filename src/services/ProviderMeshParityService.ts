...
} from '../contracts/ProviderMeshParityContract.js';
import { ZAVORTH_PROVIDER_MESH_PARITY_CONTRACT_VERSION } from '../contracts/ProviderMeshParityContract.js';
...
type ProviderMeshParityRuntime = {
  now?: () => Date;
...
export class ProviderMeshParityService {
  ...
  constructor(runtime: ProviderMeshParityRuntime = {}) {
  ...
  public buildSnapshot(input: { sourceProviders?: string[] } = {}): ProviderMeshParitySnapshot {
    ...
    return {
      ...
      contractVersion: ZAVORTH_PROVIDER_MESH_PARITY_CONTRACT_VERSION,
  ...
  public buildEntry(sourceName: string): ProviderMeshParityProviderEntry {
  ...
  private resolveAdapterStrategy(runtimeAdapter: ProviderRuntimeAdapterKind): ProviderMeshParityAdapterStrategy {
  ...
  private buildFindings(input: {
    ...
    return findings.length > 0 ? findings : ['provider has a governed parity route'];
  }
  ...
  private buildSmokeGate(
    ...
    status: ProviderMeshParityStatus,
    runtimeSupported: boolean,
  ): ProviderMeshParityProviderEntry['smokeGate'] {
    return {
