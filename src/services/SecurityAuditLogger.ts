...
export class SecurityAuditLogger {
  ...
  public logWorkspaceEvent(payload: {
    ...
    const validEvents = [
      ...
      'provider_route_fallback_succeeded',
      'provider_route_budget_blocked',
      'memory_mutation_receipt',
      'internal_beta_diagnostics_checked',
      'internal_beta_checklist_viewed',
      'blocked_cross_workspace_config_access'
    ];
