...
export type DashboardOperationsPlaneRouteDeps = {
...
export class DashboardOperationsPlaneRouteService {
  public async handleRequest(
    req: http.IncomingMessage,
    res: http.ServerResponse,
    url: URL,
    pathname: string,
    deps: DashboardOperationsPlaneRouteDeps,
  ): Promise<boolean> {
    ...
    if (pathname === '/api/operations/transports/actions' && req.method === 'POST') {
      ...
      } catch (error: OperationsPlaneDynamic) {
        deps.writeJson(
          res,
