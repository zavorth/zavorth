...
const PROFILE_CATALOG: ZavorthExperienceProfile[] = [
  {
    id: 'personal',
    label: 'Personal',
    audience: 'Daily users who want help with routine, messages, files, documents and reminders.',
    summary: 'Simple daily help with plain language, low-friction approvals and safe defaults.',
    ...
    approvalTone: 'Short, friendly and human: ask before changing, sending or spending.',
    riskBoundary: 'Can read and summarize approved local context; mutations and external sends require approval.',
    naturalAliases: [
      'personal',
      'daily',
      'home',
