...
export type DashboardOperationsNodeRouteDeps = {
...
export class DashboardOperationsNodeRouteService {
  private readonly transportRoutes = new NodeMeshTransportRouteService();
  private readonly onboarding = new NodeOnboardingService();

  private buildRecoveryService(deps: DashboardOperationsNodeRouteDeps): NodeMeshRecoveryService {
  ...
  public async handleRequest(
    ...
    url: URL,
    pathname: string,
    deps: DashboardOperationsNodeRouteDeps,
  ): Promise<boolean> {
