...
export type ToolRuntimeHandsAction = EchoHandsAction;
export type ToolRuntimeHandsRisk = EchoHandsRisk;
export type ToolRuntimeHandsRequest = EchoHandsRequest;
export type ToolRuntimeHandsResult = EchoHandsResult;

export class ToolRuntimeHandsService {
