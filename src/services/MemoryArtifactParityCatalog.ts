...
export type MemoryArtifactSpec = {
  ...
  summary: string;
  targetFiles: MemoryArtifactParityEntry['targetFiles'];
  markers: Array<{
...
export const SPECS: MemoryArtifactSpec[] = [
  {
    ...
    targetFiles: {
      ...
      surface: 'CLI, Telegram, Command Center',
      policy: 'src/security',
    },
    markers: [
  ...
  },
  {
    ...
    targetFiles: {
      ...
      surface: 'Command Center and CLI',
      policy: 'src/security',
    },
    markers: [
  ...
  },
  {
    ...
    targetFiles: {
      ...
      service: 'src/services/GatewaySessionService.ts',
      storage: 'GatewaySessionLedgerService',
      surface: 'session list and Command Center',
      policy: 'src/security',
    },
    markers: [
  ...
  },
  {
    ...
    targetFiles: {
      contract: 'src/contracts/MemoryArtifactParityContract.ts',
