...
import {
  buildRemoteMeshNotebookToolDefinitions,
  exposedRemoteMeshNotebookTools,
} from './RemoteMeshNotebookScopedMcpToolCatalog.js';
...
export class RemoteMeshNotebookScopedMcpServerService {
  ...
  private exposedTools(): RemoteMeshNotebookScopedMcpToolName[] {
    return exposedRemoteMeshNotebookTools(this.config);
  }

  private toolDefinitions(): RemoteMeshJson[] {
    return buildRemoteMeshNotebookToolDefinitions(this.config);
  }
