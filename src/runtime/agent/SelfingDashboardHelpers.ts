...
import type { SelfingDashboardCard, SelfingDashboardSectionId } from './SelfingDashboardService.js';
...
export function sectionFromIdentityFile(path: string): SelfingDashboardSectionId {
...
export function cardActions(section: SelfingDashboardSectionId, cardId: string): SelfingDashboardCard['actions'] {
  return {
...
export function uniqueCards(cards: SelfingDashboardCard[]): SelfingDashboardCard[] {
