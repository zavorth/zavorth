...
const CAPABILITY_CATALOG: CapabilityCatalogEntry[] = [
  ...
  },
  {
    ...
    trustModes: ['protected', 'collaborator', 'overlord'],
    permission: 'none',
    description: 'Skills entram no snapshot frio com trust/quarentena before da exposure de tools.',
    toolIds: [],
  ...
  },
  {
    ...
    trustModes: ['protected', 'collaborator', 'overlord'],
    permission: 'none',
    description: 'MCP entra no snapshot do run com trust/quarentena e exposure filtrada.',
    toolIds: [],
    metadataKeys: ['importedCapabilityTrust', 'coldContext', 'canonicalContextSummary'],
