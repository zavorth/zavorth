...
const CAPABILITY_CATALOG: CapabilityCatalogEntry[] = [
  {
    ...
    statusPath: '/control/runs/:runId#memory',
  ...
  },
  {
    ...
    statusPath: '/control/runs/:runId#tools',
    command: 'zavorth status --run <runId>',
  ...
  },
  {
    ...
    statusPath: '/control/runs/:runId#reply',
    command: 'zavorth status --run <runId>',
  ...
  },
  {
    ...
    statusPath: '/control/runs/:runId#swarm',
    command: 'zavorth status --run <runId>',
  ...
  },
  {
    ...
    statusPath: '/control/runs/:runId#selfmod',
    command: 'zavorth status --run <runId>',
  ...
  },
  {
    ...
    statusPath: '/control/runs/:runId#watch-mode',
    command: 'zavorth status --run <runId>',
  ...
  },
  {
    ...
    statusPath: '/control/runs/:runId#skills',
    command: 'zavorth status --run <runId>',
  ...
  },
  {
    ...
    toolIds: [],
    metadataKeys: ['importedCapabilityTrust', 'coldContext', 'canonicalContextSummary'],
    statusPath: '/control/runs/:runId#mcp',
    command: 'zavorth status --run <runId>',
  ...
  },
  {
    ...
    statusPath: '/control/runs/:runId#channels',
    command: 'zavorth status --run <runId>',
  ...
  },
  {
    ...
    statusPath: '/control/runs/:runId#node-mesh',
    command: 'zavorth status --run <runId>',
  ...
  },
  {
    ...
    statusPath: '/control/runs/:runId#session',
    command: 'zavorth status --run <runId>',
  ...
  },
  {
    ...
    statusPath: '/control/runs/:runId#events',
    command: 'zavorth status --run <runId>',
  ...
  },
  {
    ...
    statusPath: '/control/runs/:runId#policies',
    command: 'zavorth status --run <runId>',
