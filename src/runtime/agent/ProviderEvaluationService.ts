...
export const PROVIDER_EVALUATION_CONTRACT_VERSION = '2026-05-03.provider-evaluation' as const;
export const PROVIDER_ARENA_CONTRACT_VERSION = '2026-05-03.provider-arena' as const;

export type ProviderEvaluationDecisionSource =
  | 'configured'
  | 'profile'
  | 'learned'
  | 'observed'
  | 'unknown';
export type ProviderArenaDecisionSource = ProviderEvaluationDecisionSource;
...
export type ProviderEvaluationCandidate = ProviderArenaCandidate;
export type ProviderEvaluationReceipt = ProviderArenaReceipt;
export type ProviderEvaluationSnapshot = ProviderArenaSnapshot;
export type ProviderEvaluationInput = ProviderArenaInput;
...
export const ProviderArenaService = ProviderEvaluationService;
