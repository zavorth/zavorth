...
export const FIXTURE_RUNTIME_ADAPTER_CAPABILITIES: RuntimeAdapterCapabilityDescriptor[] = [
  {
    id: 'workspace-reader',
...
const FIXTURE_CHANNELS: RuntimeAdapterChannelDescriptor[] = [
  {
...
const FIXTURE_SESSIONS: RuntimeAdapterSessionDescriptor[] = [
  {
...
const FIXTURE_EVENTS: RuntimeAdapterEventEnvelope[] = [
  {
    id: 'foreign-event-1',
    ...
    payload: {
      text: 'summarize an external session using the Zavorth runtime',
      channel: 'api',
      workspace: 'C:/workspace/zavorth-fixture',
...
const FIXTURE_APPROVALS: RuntimeAdapterApprovalEnvelope[] = [
  {
...
const FIXTURE_ARTIFACTS: RuntimeAdapterArtifactEnvelope[] = [
  {
...
export class FixtureRuntimeAdapterAdapter extends RuntimeAdapterSidecarAdapter {
  constructor() {
    super({
      descriptor: {
      ...
      capabilities: FIXTURE_RUNTIME_ADAPTER_CAPABILITIES,
