import {
  createRuntimeAdapterLiveReadinessNoExecutionPolicy,
  normalizeRuntimeAdapterLiveReadinessAssimilationPack,
} from './RuntimeAdapterLiveReadinessAssimilationPack.js';
import type {
  RuntimeAdapterLiveReadinessAssimilationPackNormalization,
  RuntimeAdapterLiveReadinessCapabilitySource,
  RuntimeAdapterLiveReadinessSnapshotSource,
} from './RuntimeAdapterLiveReadinessAssimilationPack.js';
...
function availabilityForSkippedSurface(skipped: boolean): RuntimeAdapterLiveReadinessCapabilitySource['availability'] {
  return skipped ? 'degraded' : 'available';
}

function sourceToAssimilationSource(source: ExternalExecutorRealCapabilitySnapshotReadOnlySource): RuntimeAdapterLiveReadinessSnapshotSource {
...
export function normalizeExternalExecutorRealCapabilitySnapshotReadOnly<TRuntimeId extends string>(
  ...
  const assimilation = normalizeRuntimeAdapterLiveReadinessAssimilationPack({
