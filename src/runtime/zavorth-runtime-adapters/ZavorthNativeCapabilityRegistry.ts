...
export type ZavorthNativeCapabilityRegistryEntry = {
  ...
  category: RuntimeAdapterLiveReadinessCapabilityRowKind | 'message-transport-capability';
  publicLabel: string;
...
function registryKindForRow(rowKind: RuntimeAdapterLiveReadinessCapabilityRowKind): ZavorthNativeCapabilityRegistryEntryKind {
...
function publicLabelForRow(rowKind: RuntimeAdapterLiveReadinessCapabilityRowKind): string {
  const labels: Record<RuntimeAdapterLiveReadinessCapabilityRowKind, string> = {
