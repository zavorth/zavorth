...
import {
  normalizeRuntimeAdapterProviderIdentityCatalog,
} from './RuntimeAdapterProviderIdentityCatalogBoundary.js';
import {
  normalizeRuntimeAdapterProviderSecretRefBoundary,
} from './RuntimeAdapterProviderSecretRefBoundary.js';
import {
  normalizeRuntimeAdapterProviderEmbeddingContracts,
} from './RuntimeAdapterProviderEmbeddingContractsBoundary.js';
import {
  normalizeRuntimeAdapterProviderSpeechTranscriptionContracts,
} from './RuntimeAdapterProviderSpeechTranscriptionBoundary.js';
import {
  normalizeRuntimeAdapterProviderRealtimeVoiceContracts,
} from './RuntimeAdapterProviderRealtimeVoiceBoundary.js';
import {
  normalizeRuntimeAdapterProviderMediaUnderstandingContracts,
} from './RuntimeAdapterProviderMediaUnderstandingBoundary.js';
import {
  normalizeRuntimeAdapterProviderGenerationContracts,
} from './RuntimeAdapterProviderGenerationBoundary.js';
import {
...
export type RuntimeAdapterCanonicalProviderSourceEvidence = {
  sourceRuntimeName: typeof RUNTIME_ADAPTER_CANONICAL_PROVIDER_SOURCE_RUNTIME_NAME;
  sourcePaths: string[];
  observedAt: string;
...
export type RuntimeAdapterCanonicalProviderExecutionGate = {
...
export type RuntimeAdapterCanonicalProviderCatalogFixture = {
  fixtureCase: 'provider-catalog-safe-models' | 'provider-catalog-unavailable-provider';
  sourceEvidence: RuntimeAdapterCanonicalProviderSourceEvidence;
  sourceProviderId: string;
...
export type RuntimeAdapterCanonicalProviderCatalogRecord = {
  id: string;
  label: string;
  status: 'available' | 'unavailable';
...
export type RuntimeAdapterCanonicalProviderIdentityCatalogNormalization = {
  ...
  executionGate: RuntimeAdapterCanonicalProviderExecutionGate;
};

export type RuntimeAdapterCanonicalProviderSecretRefFixture = {
...
export type RuntimeAdapterCanonicalProviderSecretRef = {
  id: string;
  providerId: string;
...
export type RuntimeAdapterCanonicalProviderSecretRefBoundaryNormalization = {
  nativeContract: 'ZavorthProviderSecretRefBoundary/v1';
  generatedAt: string;
  secretRefs: RuntimeAdapterCanonicalProviderSecretRef[];
...
export type RuntimeAdapterCanonicalProviderEmbeddingFixture = {
...
export type RuntimeAdapterCanonicalProviderEmbeddingContract = {
  id: string;
  providerId: string;
  modelFamily: string;
...
export type RuntimeAdapterCanonicalProviderEmbeddingNormalization = {
  nativeContract: 'ZavorthEmbeddingProviderContracts/v1';
  generatedAt: string;
  contracts: RuntimeAdapterCanonicalProviderEmbeddingContract[];
...
export type RuntimeAdapterCanonicalProviderSpeechTranscriptionFixture = {
...
export type RuntimeAdapterCanonicalProviderSpeechTranscriptionContract = {
  id: string;
  providerId: string;
  modes: Array<'speech-to-text' | 'text-to-speech' | 'translation'>;
  audioFormats: string[];
...
export type RuntimeAdapterCanonicalProviderSpeechTranscriptionNormalization = {
  nativeContract: 'ZavorthSpeechTranscriptionProviderContracts/v1';
  generatedAt: string;
  contracts: RuntimeAdapterCanonicalProviderSpeechTranscriptionContract[];
...
export type RuntimeAdapterCanonicalProviderRealtimeVoiceFixture = {
...
export type RuntimeAdapterCanonicalProviderRealtimeVoiceContract = {
  id: string;
  providerId: string;
  voiceModes: Array<'duplex-audio' | 'realtime-transcription'>;
  modelOptions: string[];
...
export type RuntimeAdapterCanonicalProviderRealtimeVoiceNormalization = {
  nativeContract: 'ZavorthRealtimeVoiceProviderContracts/v1';
  generatedAt: string;
  contracts: RuntimeAdapterCanonicalProviderRealtimeVoiceContract[];
...
export type RuntimeAdapterCanonicalProviderMediaUnderstandingFixture = {
...
export type RuntimeAdapterCanonicalProviderMediaUnderstandingContract = {
  id: string;
  providerId: string;
  modalities: Array<'image' | 'audio' | 'video'>;
  attachmentPolicy: {
...
export type RuntimeAdapterCanonicalProviderMediaUnderstandingNormalization = {
  nativeContract: 'ZavorthMediaUnderstandingProviderContracts/v1';
  generatedAt: string;
  contracts: RuntimeAdapterCanonicalProviderMediaUnderstandingContract[];
...
export type RuntimeAdapterCanonicalProviderGenerationFixture = {
...
export type RuntimeAdapterCanonicalProviderGenerationContract = {
  id: string;
  providerId: string;
  modalities: Array<'image' | 'video' | 'music'>;
  modelOptions: string[];
...
export type RuntimeAdapterCanonicalProviderGenerationNormalization = {
  nativeContract: 'ZavorthGenerationProviderContracts/v1';
  generatedAt: string;
  contracts: RuntimeAdapterCanonicalProviderGenerationContract[];
...
export type RuntimeAdapterCanonicalProviderWebSearchFetchFixture = {
...
export type RuntimeAdapterCanonicalProviderWebSearchFetchContract = {
  id: string;
  providerId: string;
  modes: Array<'search' | 'fetch'>;
  networkPolicy: {
...
export type RuntimeAdapterCanonicalProviderWebSearchFetchNormalization = {
  nativeContract: 'ZavorthWebSearchFetchProviderContracts/v1';
  generatedAt: string;
  contracts: RuntimeAdapterCanonicalProviderWebSearchFetchContract[];
  toolExposurePolicyInput: ToolExposurePolicyInput;
...
function sourceEvidence(input: {
  ...
  sourceEndpointIds?: string[];
  notes?: string[];
}): RuntimeAdapterCanonicalProviderSourceEvidence {
  return {
    sourceRuntimeName: RUNTIME_ADAPTER_CANONICAL_PROVIDER_SOURCE_RUNTIME_NAME,
    observedAt: RUNTIME_ADAPTER_CANONICAL_PROVIDER_FIXTURE_NOW,
    ...input,
  };
}

export function createCanonicalProviderExecutionGate(): RuntimeAdapterCanonicalProviderExecutionGate {
  return {
    providerSdkLoaded: false,
    liveProviderCallsAttempted: false,
    sourceModulesCopied: false,
...
export function createCanonicalProviderIdentityCatalogFixtures(): RuntimeAdapterCanonicalProviderCatalogFixture[] {
  return [
    {
...
export function normalizeCanonicalProviderIdentityCatalog(
  fixtures: RuntimeAdapterCanonicalProviderCatalogFixture[] = createCanonicalProviderIdentityCatalogFixtures(),
): RuntimeAdapterCanonicalProviderIdentityCatalogNormalization {
  return normalizeRuntimeAdapterProviderIdentityCatalog({
    records: fixtures,
    generatedAt: RUNTIME_ADAPTER_CANONICAL_PROVIDER_FIXTURE_NOW,
    runtimeId: RUNTIME_ADAPTER_CANONICAL_PROVIDER_RUNTIME_ID,
    publicProviderIdPrefix: 'zavorth-provider:runtime-adapter-v1',
    createExecutionGate: createCanonicalProviderExecutionGate,
  });
}

export function createCanonicalProviderSecretRefFixtures(): RuntimeAdapterCanonicalProviderSecretRefFixture[] {
  return [
    {
      fixtureCase: 'secretref-env-mapping',
      publicProviderId: 'zavorth-provider:runtime-adapter-v1-secret-mapped',
    ...
    },
    {
      ...
      publicProviderId: 'zavorth-provider:runtime-adapter-v1-secret-missing',
      purposes: ['api-key'],
...
export function normalizeCanonicalProviderSecretRefBoundary(
  fixtures: RuntimeAdapterCanonicalProviderSecretRefFixture[] = createCanonicalProviderSecretRefFixtures(),
): RuntimeAdapterCanonicalProviderSecretRefBoundaryNormalization {
  return normalizeRuntimeAdapterProviderSecretRefBoundary({
    records: fixtures,
    generatedAt: RUNTIME_ADAPTER_CANONICAL_PROVIDER_FIXTURE_NOW,
    createExecutionGate: createCanonicalProviderExecutionGate,
  });
...
export function createCanonicalProviderEmbeddingFixtures(): RuntimeAdapterCanonicalProviderEmbeddingFixture[] {
  return [
    {
      fixtureCase: 'embedding-model-metadata',
      publicProviderId: 'zavorth-provider:runtime-adapter-v1-embedding',
...
export function normalizeCanonicalProviderEmbeddingContracts(
  fixtures: RuntimeAdapterCanonicalProviderEmbeddingFixture[] = createCanonicalProviderEmbeddingFixtures(),
): RuntimeAdapterCanonicalProviderEmbeddingNormalization {
  return normalizeRuntimeAdapterProviderEmbeddingContracts({
    records: fixtures,
    generatedAt: RUNTIME_ADAPTER_CANONICAL_PROVIDER_FIXTURE_NOW,
    createExecutionGate: createCanonicalProviderExecutionGate,
  });
...
export function createCanonicalProviderSpeechTranscriptionFixtures(): RuntimeAdapterCanonicalProviderSpeechTranscriptionFixture[] {
  return [
    {
      fixtureCase: 'speech-transcription-audio-metadata',
      publicProviderId: 'zavorth-provider:runtime-adapter-v1-speech',
...
export function normalizeCanonicalProviderSpeechTranscriptionContracts(
  fixtures: RuntimeAdapterCanonicalProviderSpeechTranscriptionFixture[] = createCanonicalProviderSpeechTranscriptionFixtures(),
): RuntimeAdapterCanonicalProviderSpeechTranscriptionNormalization {
  return normalizeRuntimeAdapterProviderSpeechTranscriptionContracts({
    records: fixtures,
    generatedAt: RUNTIME_ADAPTER_CANONICAL_PROVIDER_FIXTURE_NOW,
    createExecutionGate: createCanonicalProviderExecutionGate,
  });
...
export function createCanonicalProviderRealtimeVoiceFixtures(): RuntimeAdapterCanonicalProviderRealtimeVoiceFixture[] {
  return [
    {
      fixtureCase: 'realtime-voice-session-metadata',
      publicProviderId: 'zavorth-provider:runtime-adapter-v1-realtime',
...
export function normalizeCanonicalProviderRealtimeVoiceContracts(
  fixtures: RuntimeAdapterCanonicalProviderRealtimeVoiceFixture[] = createCanonicalProviderRealtimeVoiceFixtures(),
): RuntimeAdapterCanonicalProviderRealtimeVoiceNormalization {
  return normalizeRuntimeAdapterProviderRealtimeVoiceContracts({
    records: fixtures,
    generatedAt: RUNTIME_ADAPTER_CANONICAL_PROVIDER_FIXTURE_NOW,
    createExecutionGate: createCanonicalProviderExecutionGate,
  });
...
export function createCanonicalProviderMediaUnderstandingFixtures(): RuntimeAdapterCanonicalProviderMediaUnderstandingFixture[] {
  return [
    {
      fixtureCase: 'media-understanding-input-metadata',
      publicProviderId: 'zavorth-provider:runtime-adapter-v1-media-understanding',
...
export function normalizeCanonicalProviderMediaUnderstandingContracts(
  fixtures: RuntimeAdapterCanonicalProviderMediaUnderstandingFixture[] = createCanonicalProviderMediaUnderstandingFixtures(),
): RuntimeAdapterCanonicalProviderMediaUnderstandingNormalization {
  return normalizeRuntimeAdapterProviderMediaUnderstandingContracts({
    records: fixtures,
    generatedAt: RUNTIME_ADAPTER_CANONICAL_PROVIDER_FIXTURE_NOW,
    createExecutionGate: createCanonicalProviderExecutionGate,
  });
...
export function createCanonicalProviderGenerationFixtures(): RuntimeAdapterCanonicalProviderGenerationFixture[] {
  return [
    {
      fixtureCase: 'generation-output-artifact-metadata',
      publicProviderId: 'zavorth-provider:runtime-adapter-v1-generation',
...
export function normalizeCanonicalProviderGenerationContracts(
  fixtures: RuntimeAdapterCanonicalProviderGenerationFixture[] = createCanonicalProviderGenerationFixtures(),
): RuntimeAdapterCanonicalProviderGenerationNormalization {
  return normalizeRuntimeAdapterProviderGenerationContracts({
    records: fixtures,
    generatedAt: RUNTIME_ADAPTER_CANONICAL_PROVIDER_FIXTURE_NOW,
    createExecutionGate: createCanonicalProviderExecutionGate,
  });
...
export function createCanonicalProviderWebSearchFetchFixtures(): RuntimeAdapterCanonicalProviderWebSearchFetchFixture[] {
  return [
    {
      fixtureCase: 'web-search-fetch-policy-metadata',
      publicProviderId: 'zavorth-provider:runtime-adapter-v1-web',
      modes: ['search', 'fetch'],
...
export function normalizeCanonicalProviderWebSearchFetchContracts(
  fixtures: RuntimeAdapterCanonicalProviderWebSearchFetchFixture[] = createCanonicalProviderWebSearchFetchFixtures(),
): RuntimeAdapterCanonicalProviderWebSearchFetchNormalization {
  return normalizeRuntimeAdapterProviderWebSearchFetchContracts({
    records: fixtures,
    generatedAt: RUNTIME_ADAPTER_CANONICAL_PROVIDER_FIXTURE_NOW,
    createExecutionGate: createCanonicalProviderExecutionGate,
  });
