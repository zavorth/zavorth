...
export const RUNTIME_ADAPTER_FIRST_GOVERNED_READ_ONLY_GATEWAY_ACTION_NOW = '2026-04-28T23:00:00.000Z' as const;
export const RUNTIME_ADAPTER_FIRST_GOVERNED_READ_ONLY_GATEWAY_ACTION_RUNTIME_ID = 'runtime-adapter-first-governed-read-only-gateway-action' as const;
...
export function normalizeFirstGovernedReadOnlyGatewayActionFixture(): ZavorthFirstGovernedReadOnlyGatewayActionNormalization {
  return normalizeFirstGovernedReadOnlyGatewayAction({
    ...
    generatedAt: RUNTIME_ADAPTER_FIRST_GOVERNED_READ_ONLY_GATEWAY_ACTION_NOW,
    runtimeId: RUNTIME_ADAPTER_FIRST_GOVERNED_READ_ONLY_GATEWAY_ACTION_RUNTIME_ID,
    idPrefix: 'runtime-adapter-first-governed-read-only-gateway-action',
  });
}
