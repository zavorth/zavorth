...
export type ZavorthNativeZavorthControlViewModelRegistrySnapshot = {
  ...
  indexes: {
    ...
    byStatus: Record<RuntimeAdapterZavorthControlOperationalStatus, number>;
...
function emptyStatusIndex(): Record<RuntimeAdapterZavorthControlOperationalStatus, number> {
  return {
    blocked: 0,
    degraded: 0,
    ready: 0,
...
function byStatusIndex(records: ZavorthNativeZavorthControlViewModelRecord[]): Record<RuntimeAdapterZavorthControlOperationalStatus, number> {
