...
export const RUNTIME_ADAPTER_REAL_MESSAGE_TRANSPORT_CAPABILITY_DISCOVERY_NOW = '2026-04-29T00:00:00.000Z' as const;
export const RUNTIME_ADAPTER_REAL_MESSAGE_TRANSPORT_CAPABILITY_DISCOVERY_RUNTIME_ID = 'runtime-adapter-real-message-transport-capability-discovery' as const;
...
export function normalizeMessageTransportCapabilityDiscoveryFixture(): ZavorthMessageTransportCapabilityDiscoveryNormalization {
  return normalizeMessageTransportCapabilityDiscovery({
    generatedAt: RUNTIME_ADAPTER_REAL_MESSAGE_TRANSPORT_CAPABILITY_DISCOVERY_NOW,
    runtimeId: RUNTIME_ADAPTER_REAL_MESSAGE_TRANSPORT_CAPABILITY_DISCOVERY_RUNTIME_ID,
    idPrefix: 'runtime-adapter-real-message-transport-capability-discovery',
    sourceReadiness: {
