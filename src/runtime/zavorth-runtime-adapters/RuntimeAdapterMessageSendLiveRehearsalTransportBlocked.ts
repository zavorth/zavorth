...
} from './RuntimeAdapterFirstLiveMutationMicroSlice.js';
import {
...
export const RUNTIME_ADAPTER_MESSAGE_SEND_LIVE_REHEARSAL_TRANSPORT_BLOCKED_NOW = '2026-04-29T00:00:00.000Z' as const;
export const RUNTIME_ADAPTER_MESSAGE_SEND_LIVE_REHEARSAL_TRANSPORT_BLOCKED_RUNTIME_ID = 'runtime-adapter-message-send-live-rehearsal-transport-blocked' as const;
...
export type ZavorthMessageSendLiveRehearsalTransportBlockedNormalization = {
  ...
  sourceReadiness: {
    ...
    zavorthControlReady: RuntimeAdapterZavorthControlLiveAssimilationNormalization['decision'];
...
export type ZavorthMessageSendLiveRehearsalTransportBlockedOptions<TRuntimeId extends string = string> = {
  ...
  zavorthControl: RuntimeAdapterZavorthControlLiveAssimilationNormalization;
...
export function normalizeMessageSendLiveRehearsalTransportBlockedFixture(): ZavorthMessageSendLiveRehearsalTransportBlockedNormalization {
  return normalizeMessageSendLiveRehearsalTransportBlocked({
    generatedAt: RUNTIME_ADAPTER_MESSAGE_SEND_LIVE_REHEARSAL_TRANSPORT_BLOCKED_NOW,
    runtimeId: RUNTIME_ADAPTER_MESSAGE_SEND_LIVE_REHEARSAL_TRANSPORT_BLOCKED_RUNTIME_ID,
    idPrefix: 'runtime-adapter-message-send-live-rehearsal-transport-blocked',
    sessionHistory: normalizeExternalExecutorSessionHistoryReadOnlyBridgeFixture(),
    zavorthControl: normalizeRuntimeAdapterZavorthControlLiveAssimilationFixture(),
