...
export const RUNTIME_ADAPTER_CONTROLLED_DRY_RUN_ACTION_PLANNER_NOW = '2026-04-28T22:30:00.000Z' as const;
export const RUNTIME_ADAPTER_CONTROLLED_DRY_RUN_ACTION_PLANNER_RUNTIME_ID = 'runtime-adapter-controlled-dry-run-action-planner' as const;
...
export function createZavorthExternalDryRunActionPlannerFixtureIntents(): ZavorthExternalActionIntent[] {
  ...
  const dryRunGatewayIntent: ZavorthExternalActionIntent = {
    ...gatewayIntent,
    id: 'runtime-adapter-controlled-dry-run-action-planner:intent-dry-run-gateway',
  ...
  const commandApprovalIntent: ZavorthExternalActionIntent = {
    ...commandIntent,
    id: 'runtime-adapter-controlled-dry-run-action-planner:intent-command-approval',
  ...
  const unsupportedIntent: ZavorthExternalActionIntent = {
    ...gatewayIntent,
    id: 'runtime-adapter-controlled-dry-run-action-planner:intent-unsupported-worker-node',
    requestedControlLevel: 'dry-run',
...
export function planZavorthExternalDryRunActionsFixture(): ZavorthExternalDryRunActionPlannerNormalization {
  ...
  return planZavorthExternalDryRunActions({
    ...
    generatedAt: RUNTIME_ADAPTER_CONTROLLED_DRY_RUN_ACTION_PLANNER_NOW,
    runtimeId: RUNTIME_ADAPTER_CONTROLLED_DRY_RUN_ACTION_PLANNER_RUNTIME_ID,
    idPrefix: 'runtime-adapter-controlled-dry-run-action-planner',
  });
}
