...
export class FixtureExternalExecutorSidecarClient implements QuarantinedExternalExecutorSidecarClient {
  public readonly dispatchedActions: RuntimeAdapterOutboundActionEnvelope[] = [];
  ...
  public async pullEvents(): Promise<RuntimeAdapterEventEnvelope[]> {
    return [
      {
        id: 'source-event-1',
        runtimeId: RUNTIME_ID,
  ...
  public async dispatchControlledOutboundAction(action: RuntimeAdapterOutboundActionEnvelope): Promise<{
    receiptId: string;
    label: string;
