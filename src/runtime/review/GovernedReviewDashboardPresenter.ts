...
export type GovernedReviewDashboardLaneStatus =
  | 'ready'
  | 'waiting-approval'
  | 'needs-human-review'
  | 'blocked'
...
export type GovernedReviewDashboardSnapshot = {
  ...
  lanes: Array<{
    id: string;
    label: string;
    status: GovernedReviewDashboardLaneStatus;
    detail: string;
  }>;
  findings: Array<{
    id: string;
...
export function buildGovernedReviewDashboardSnapshot(
...
function buildLanes(review: GovernedReviewResult): GovernedReviewDashboardSnapshot['lanes'] {
  return [
    {
      id: 'context',
      label: 'Context',
...
function actionLaneStatus(review: GovernedReviewResult): GovernedReviewDashboardLaneStatus {
