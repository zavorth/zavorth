...
export const EXTERNAL_AGENT_GOVERNED_READ_ONLY_CAPABILITY_REFRESH_NOW = '2026-04-28T23:30:00.000Z' as const;
export const EXTERNAL_AGENT_GOVERNED_READ_ONLY_CAPABILITY_REFRESH_RUNTIME_ID = 'external-agent-governed-read-only-capability-refresh' as const;
...
export function normalizeGovernedReadOnlyCapabilityRefreshFixture(): ZavorthGovernedReadOnlyCapabilityRefreshNormalization {
  return normalizeGovernedReadOnlyCapabilityRefresh({
    ...
    generatedAt: EXTERNAL_AGENT_GOVERNED_READ_ONLY_CAPABILITY_REFRESH_NOW,
    runtimeId: EXTERNAL_AGENT_GOVERNED_READ_ONLY_CAPABILITY_REFRESH_RUNTIME_ID,
    idPrefix: 'external-agent-governed-read-only-capability-refresh',
  });
}
