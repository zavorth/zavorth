...
export type ZavorthNativeConfigStateRegistryNormalization = {
  ...
  sourceReadiness: {
    secretRefResolverBoundary: ExternalAgentSecretResolutionEnvelope['nativeContract'];
...
function sourceReady(source: ZavorthNativeConfigStateRegistrySource): boolean {
  return (
    source.secretRefResolverBoundary.nativeContract === 'ExternalAgentSecretResolutionEnvelope/v1' &&
