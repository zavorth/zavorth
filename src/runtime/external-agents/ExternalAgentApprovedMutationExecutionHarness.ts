...
export const EXTERNAL_AGENT_APPROVED_MUTATION_EXECUTION_HARNESS_NOW = '2026-04-29T00:00:00.000Z' as const;
export const EXTERNAL_AGENT_APPROVED_MUTATION_EXECUTION_HARNESS_RUNTIME_ID = 'external-agent-approved-mutation-execution-harness' as const;
...
export function normalizeApprovedMutationExecutionHarnessFixture(): ZavorthApprovedMutationExecutionHarnessNormalization {
  return normalizeApprovedMutationExecutionHarness({
    generatedAt: EXTERNAL_AGENT_APPROVED_MUTATION_EXECUTION_HARNESS_NOW,
    runtimeId: EXTERNAL_AGENT_APPROVED_MUTATION_EXECUTION_HARNESS_RUNTIME_ID,
    idPrefix: 'external-agent-approved-mutation-execution-harness',
