...
export const EXTERNAL_AGENT_APPROVAL_REQUIRED_MUTATION_REHEARSAL_NOW = '2026-04-29T00:00:00.000Z' as const;
export const EXTERNAL_AGENT_APPROVAL_REQUIRED_MUTATION_REHEARSAL_RUNTIME_ID = 'external-agent-approval-required-mutation-rehearsal' as const;
...
export function normalizeApprovalRequiredMutationRehearsalFixture(): ZavorthApprovalRequiredMutationRehearsalNormalization {
  return normalizeApprovalRequiredMutationRehearsal({
    ...
    generatedAt: EXTERNAL_AGENT_APPROVAL_REQUIRED_MUTATION_REHEARSAL_NOW,
    runtimeId: EXTERNAL_AGENT_APPROVAL_REQUIRED_MUTATION_REHEARSAL_RUNTIME_ID,
    idPrefix: 'external-agent-approval-required-mutation-rehearsal',
  });
}
