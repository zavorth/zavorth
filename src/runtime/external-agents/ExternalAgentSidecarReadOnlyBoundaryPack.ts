...
export type ExternalAgentSidecarReadOnlyStatus =
  | 'degraded'
  | 'offline'
  | 'ready';

export type ExternalAgentSidecarReadOnlySecretPurpose =
  | 'action-dispatch'
  | 'capability-snapshot'
  | 'event-pull'
  | 'health-probe'
...
export type ExternalAgentSidecarReadOnlyExecutionGate = {
...
export type ExternalAgentSidecarReadOnlyProcessSource = {
  commandHint?: string;
  endpointHint?: string;
  transportHint: ExternalAgentSidecarReadOnlyTransport;
  workingDirectoryHint?: string;
};

export type ExternalAgentSidecarReadOnlyCapabilitySource = {
...
export type ExternalAgentSidecarReadOnlyEventSource = {
...
export type ExternalAgentSidecarReadOnlySecretRefSource = {
  publicSecretRefIdSeed: string;
  purpose: ExternalAgentSidecarReadOnlySecretPurpose;
  providerId: string;
};

export type ExternalAgentSidecarReadOnlyFailureSource = {
...
export type ExternalAgentSidecarReadOnlyBlockedActionSource = {
...
export type ExternalAgentSidecarReadOnlyBoundaryPackSource = {
  sourceRuntimeName: string;
  sourceRuntimeVersion?: string;
  process: ExternalAgentSidecarReadOnlyProcessSource;
  healthStatus: ExternalAgentSidecarReadOnlyStatus;
  channels: ExternalAgentChannelDescriptor[];
  capabilities: ExternalAgentSidecarReadOnlyCapabilitySource[];
  events: ExternalAgentSidecarReadOnlyEventSource[];
  secretRefs: ExternalAgentSidecarReadOnlySecretRefSource[];
  configKeyHints: string[];
  statePathHints: string[];
  failures: ExternalAgentSidecarReadOnlyFailureSource[];
  blockedActions: ExternalAgentSidecarReadOnlyBlockedActionSource[];
};
...
export type ZavorthSidecarProcessDescriptor = {
  ...
  runtimeId: string;
  label: string;
  transport: ExternalAgentSidecarReadOnlyTransport;
  optional: true;
...
export type ZavorthSidecarFailureRecord = {
  id: string;
  kind: ExternalAgentSidecarReadOnlyFailureSource['kind'];
  status: ExternalAgentSidecarReadOnlyFailureSource['status'];
  retryable: boolean;
  rollbackRecommended: boolean;
...
export type ExternalAgentSidecarReadOnlyBoundaryPackOptions<TRuntimeId extends string = string> = {
  source: ExternalAgentSidecarReadOnlyBoundaryPackSource;
  generatedAt: string;
  runtimeId: TRuntimeId;
  idPrefix: string;
  executionGate: ExternalAgentSidecarReadOnlyExecutionGate;
};

export type ExternalAgentSidecarReadOnlyBoundaryPackNormalization<TRuntimeId extends string = string> = {
...
function capabilityPolicy(capability: Pick<ExternalAgentSidecarReadOnlyCapabilitySource, 'risk' | 'trustState'>): 'approval-required' | 'allowed' | 'blocked' {
...
function buildDescriptor<TRuntimeId extends string>(
  options: ExternalAgentSidecarReadOnlyBoundaryPackOptions<TRuntimeId>,
...
function buildEventPull<TRuntimeId extends string>(
  options: ExternalAgentSidecarReadOnlyBoundaryPackOptions<TRuntimeId>,
): ExternalAgentSidecarReadOnlyBoundaryPackNormalization<TRuntimeId>['eventPull'] {
...
function buildBlockedDispatch<TRuntimeId extends string>(
  options: ExternalAgentSidecarReadOnlyBoundaryPackOptions<TRuntimeId>,
): ExternalAgentSidecarReadOnlyBoundaryPackNormalization<TRuntimeId>['blockedDispatch'] {
  return {
...
export function normalizeExternalAgentSidecarReadOnlyBoundaryPack<TRuntimeId extends string>(
  options: ExternalAgentSidecarReadOnlyBoundaryPackOptions<TRuntimeId>,
): ExternalAgentSidecarReadOnlyBoundaryPackNormalization<TRuntimeId> {
