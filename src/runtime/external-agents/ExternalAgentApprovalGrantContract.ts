...
export const EXTERNAL_AGENT_APPROVAL_GRANT_CONTRACT_NOW = '2026-04-29T00:00:00.000Z' as const;
export const EXTERNAL_AGENT_APPROVAL_GRANT_CONTRACT_RUNTIME_ID = 'external-agent-approval-grant-contract' as const;
...
export function normalizeApprovalGrantContractFixture(): ZavorthApprovalGrantContractNormalization {
  return normalizeApprovalGrantContract({
    generatedAt: EXTERNAL_AGENT_APPROVAL_GRANT_CONTRACT_NOW,
    runtimeId: EXTERNAL_AGENT_APPROVAL_GRANT_CONTRACT_RUNTIME_ID,
    idPrefix: 'external-agent-approval-grant-contract',
