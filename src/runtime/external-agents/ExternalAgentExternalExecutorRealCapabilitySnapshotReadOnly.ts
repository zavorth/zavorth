...
export type ExternalExecutorRealCapabilitySnapshotReadOnlyNormalization = {
  ...
  commandCenterProjection: ExternalAgentLiveReadinessAssimilationPackNormalization['commandCenterProjection'];
...
export function normalizeExternalExecutorRealCapabilitySnapshotReadOnly<TRuntimeId extends string>(
  ...
  return {
    ...
    commandCenterProjection: assimilation.commandCenterProjection,
