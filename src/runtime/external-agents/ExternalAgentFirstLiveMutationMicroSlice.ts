...
export const EXTERNAL_AGENT_FIRST_LIVE_MUTATION_MICRO_SLICE_NOW = '2026-04-29T00:00:00.000Z' as const;
export const EXTERNAL_AGENT_FIRST_LIVE_MUTATION_MICRO_SLICE_RUNTIME_ID = 'external-agent-first-live-mutation-micro-slice' as const;
...
export function normalizeFirstLiveMutationMicroSliceFixture(): ZavorthFirstLiveMutationMicroSliceNormalization {
  return normalizeFirstLiveMutationMicroSlice({
    generatedAt: EXTERNAL_AGENT_FIRST_LIVE_MUTATION_MICRO_SLICE_NOW,
    runtimeId: EXTERNAL_AGENT_FIRST_LIVE_MUTATION_MICRO_SLICE_RUNTIME_ID,
    idPrefix: 'external-agent-first-live-mutation-micro-slice',
