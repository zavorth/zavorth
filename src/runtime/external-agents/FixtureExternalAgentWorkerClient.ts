...
export type FixtureExternalAgentWorkerClientMode = 'complete' | 'deferred' | 'fail';

export type FixtureExternalAgentWorkerClientOptions = {
  mode?: FixtureExternalAgentWorkerClientMode;
  now?: () => Date;
};

const RUNTIME_ID = 'external-runtime:primary-sidecar';

export class FixtureExternalAgentWorkerClient implements ExternalAgentWorkerBridgeClient {
  public readonly dispatchedTasks: ExternalAgentWorkerTaskEnvelope[] = [];
  ...
  private readonly mode: FixtureExternalAgentWorkerClientMode;
  private readonly now: () => Date;

  constructor(options: FixtureExternalAgentWorkerClientOptions = {}) {
  ...
  public async getNodeDaemonHealth(): Promise<ExternalAgentNodeDaemonHealthSnapshot> {
  ...
  public async dispatchTask(task: ExternalAgentWorkerTaskEnvelope): Promise<ExternalAgentWorkerTaskResult> {
