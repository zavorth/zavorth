  ...
  return {
    ...
    actions: [
      baseWebBrowserAction({
        ...
        aliases: ['web_search', 'search web', 'web search'],
      ...
      baseWebBrowserAction({
        ...
        aliases: ['web_fetch_url', 'fetch_url', 'baixar url', 'obter page', 'web fetch url', 'fetch url'],
      ...
      baseWebBrowserAction({
        ...
        aliases: ['browser_extract', 'extract_text', 'browser extract', 'extract'],
      ...
      baseWebBrowserAction({
        ...
        aliases: ['browser_form_submit', 'submit form'],
