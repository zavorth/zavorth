...
// ZavorthBridge OAuth Configuration (Standard OAuth2 with Google)
export const ZAVORTH_BRIDGE_CONFIG = {
  clientId: process.env.ZAVORTH_BRIDGE_OAUTH_CLIENT_ID || "",
  clientSecret: process.env.ZAVORTH_BRIDGE_OAUTH_CLIENT_SECRET || "",
  authorizeUrl: "https://accounts.google.com/o/oauth2/v2/auth",
  tokenUrl: "https://oauth2.googleapis.com/token",
  userInfoUrl: "https://www.googleapis.com/oauth2/v1/userinfo",
  scopes: [
