...
export function OAuthModalProviderHint({
  ...
  return (
    <div className="rounded-lg border border-blue-500/30 bg-blue-500/10 p-3 text-xs text-blue-200">
      ...
      <strong>Remote access:</strong> Since you&apos;re accessing Zavorth remotely, after
      authorizing you&apos;ll see an error page (localhost not found). That&apos;s expected - just
