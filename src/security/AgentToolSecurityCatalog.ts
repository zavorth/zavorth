...
export const NATIVE_AGENT_TOOL_SECURITY_DEFINITIONS: AgentToolSecurityDefinition[] = [
  ...
  {
    toolName: 'zavorth_macro',
    surface: 'native-tool',
    capabilities: ['skill', 'configuration'],
    defaultRisk: 'safe',
    requiresConfirmation: false,
    description: 'Records, replays, and manages workflow macros.',
  },
  {
    toolName: 'zavorth_checkpoint',
    surface: 'native-tool',
    capabilities: ['local-observation', 'filesystem'],
    defaultRisk: 'safe',
    requiresConfirmation: false,
    description: 'Saves and restores atomic session step checkpoints.',
  },
  {
    toolName: 'zavorth_bm25_search',
    surface: 'native-tool',
    capabilities: ['local-observation', 'filesystem'],
    defaultRisk: 'safe',
    requiresConfirmation: false,
    description: 'Fast BM25 lexical token-level search across workspace.',
  },
  {
    toolName: 'zavorth_lsp_diagnostics',
    surface: 'native-tool',
    capabilities: ['local-observation', 'filesystem'],
    defaultRisk: 'safe',
    requiresConfirmation: false,
    description: 'Inspects TypeScript and language server diagnostics.',
  },
  {
    toolName: 'zavorth_power_lock',
    surface: 'native-tool',
    capabilities: ['local-observation', 'shell'],
    defaultRisk: 'safe',
    requiresConfirmation: false,
    description: 'Acquires and releases OS power wake-locks to prevent system sleep.',
  },
  {
    toolName: 'zavorth_blueprint',
    surface: 'native-tool',
    capabilities: ['configuration', 'local-observation'],
    defaultRisk: 'safe',
    requiresConfirmation: false,
    description: 'Lists and schedules recurring automation blueprints.',
  },
  {
    toolName: 'zavorth_context_meter',
    surface: 'native-tool',
    capabilities: ['local-observation', 'memory'],
    defaultRisk: 'safe',
    requiresConfirmation: false,
    description: 'Tracks real-time context token consumption and cost.',
  },
  {
    toolName: 'zavorth_mcp_doctor',
    surface: 'native-tool',
    capabilities: ['local-observation', 'network', 'configuration'],
    defaultRisk: 'safe',
    requiresConfirmation: false,
    description: 'Inspects and tests health latency of MCP servers.',
  },
  {
    toolName: 'zavorth_stealth_browse',
    surface: 'native-tool',
    capabilities: ['network', 'untrusted-input'],
    defaultRisk: 'safe',
    requiresConfirmation: false,
  ...
  },
  {
    ...
    {
      toolName: 'zavorth_codebase_graph',
      surface: 'native-tool',
      capabilities: ['filesystem', 'local-observation'],
      defaultRisk: 'safe',
      requiresConfirmation: false,
      description: 'AST scope and call graph analysis for symbol resolution and breaking contract impact.',
    },
    {
      toolName: 'zavorth_snapshot_rollback',
      surface: 'native-tool',
      capabilities: ['filesystem'],
      defaultRisk: 'review',
      requiresConfirmation: true,
