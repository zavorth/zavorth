...
Create a Google Play service account JSON key with Google Play Developer API access, then grant that service account access to the Zavorth app in Play Console.
...
```bash
GOOGLE_PLAY_PACKAGE_NAME=dev.zavorth.companion
```
