...
import dev.zavorth.companion.GatewayNodeSummary
import dev.zavorth.companion.GatewayNodesDevicesSummary
import dev.zavorth.companion.GatewayPairedDeviceSummary
import dev.zavorth.companion.GatewayPendingDeviceSummary
...
private fun nodeSubtitle(node: GatewayNodeSummary): String {
  ...
  val version = node.version?.let { "Zavorth $it" }
