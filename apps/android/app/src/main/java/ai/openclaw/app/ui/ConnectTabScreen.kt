      ...
      Surface(
        ...
        Column(
          ...
          if (pairingRequired) {
            ...
            CommandBlock("zavorth devices list")
            CommandBlock("zavorth devices approve <requestId>")
          }
          Text("Zavorth Android ${openClawAndroidVersionLabel()}", style = mobileCaption1, color = mobileTextSecondary)
          Button(
            onClick = {
    ...
    AnimatedVisibility(visible = advancedOpen) {
      Surface(
        ...
        Column(
          ...
          CommandBlock("zavorth qr --setup-code-only")
          CommandBlock("zavorth qr --json")
          Text(
