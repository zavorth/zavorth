...
import dev.zavorth.companion.ui.mobileHeadline
import dev.zavorth.companion.ui.mobileSurface
import dev.zavorth.companion.ui.mobileText
import dev.zavorth.companion.ui.mobileTextSecondary
import dev.zavorth.companion.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = dev.zavorth.companion.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = dev.zavorth.companion.ui.mobileFontFamily,
