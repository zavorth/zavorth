...
enum class ZavorthCanvasCommand(
  val rawValue: String,
) {
...
enum class ZavorthCanvasA2UICommand(
  val rawValue: String,
) {
...
enum class ZavorthCameraCommand(
  val rawValue: String,
) {
  List("camera.list"),
  Snap("camera.snap"),
...
enum class ZavorthLocationCommand(
  val rawValue: String,
) {
  Get("location.get"),
  ;
...
enum class ZavorthDeviceCommand(
  val rawValue: String,
) {
...
enum class ZavorthNotificationsCommand(
  val rawValue: String,
) {
...
enum class ZavorthSystemCommand(
  val rawValue: String,
) {
...
enum class ZavorthPhotosCommand(
  val rawValue: String,
) {
...
enum class ZavorthContactsCommand(
  val rawValue: String,
) {
...
enum class ZavorthCalendarCommand(
  val rawValue: String,
) {
...
enum class ZavorthMotionCommand(
  val rawValue: String,
) {
...
enum class ZavorthCallLogCommand(
  val rawValue: String,
) {
