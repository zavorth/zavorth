...
class NodeForegroundService : Service() {
  ...
  override fun onCreate() {
    super.onCreate()
    ensureChannel()
    val initial = buildNotification(title = "Zavorth Node", text = "Starting…")
    ...
    notificationJob =
      scope.launch {
        combine(
          ...
          val title =
            when {
              state.connected && state.mode == VoiceCaptureMode.TalkMode -> "Zavorth Node · Talk"
              state.connected -> "Zavorth Node · Connected"
              else -> "Zavorth Node"
            }
          val text =
  ...
  private fun ensureChannel() {
    ...
    val channel =
      NotificationChannel(
        ...
        description = "Zavorth node connection status"
        setShowBadge(false)
      }
  ...
  companion object {
    ...
    private const val ACTION_STOP = "dev.zavorth.companion.action.STOP"
    private const val ACTION_SET_VOICE_CAPTURE_MODE = "dev.zavorth.companion.action.SET_VOICE_CAPTURE_MODE"
    private const val EXTRA_VOICE_CAPTURE_MODE = "dev.zavorth.companion.extra.VOICE_CAPTURE_MODE"
