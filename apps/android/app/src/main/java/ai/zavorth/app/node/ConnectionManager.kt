...
import dev.zavorth.companion.gateway.GatewayClientInfo
import dev.zavorth.companion.gateway.GatewayConnectOptions
import dev.zavorth.companion.gateway.GatewayEndpoint
import dev.zavorth.companion.gateway.GatewayTlsParams
...
class ConnectionManager(
  ...
  fun buildUserAgent(): String {
    ...
    return "ZavorthAndroid/$version (Android $releaseLabel; SDK ${Build.VERSION.SDK_INT})"
  }
  ...
  fun buildNodeConnectOptions(): GatewayConnectOptions =
    GatewayConnectOptions(
      ...
      client = buildClientInfo(clientId = "zavorth-android", clientMode = "node"),
  ...
  fun buildOperatorConnectOptions(): GatewayConnectOptions =
    GatewayConnectOptions(
      ...
      commands = emptyList(),
      permissions = emptyMap(),
      client = buildClientInfo(clientId = "zavorth-android", clientMode = "ui"),
      userAgent = buildUserAgent(),
    )
