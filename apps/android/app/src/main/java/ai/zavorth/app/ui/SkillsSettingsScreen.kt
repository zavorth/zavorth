...
internal fun SkillsSettingsScreen(
  ...
  SettingsDetailFrame(
    title = "Skills",
    subtitle = "Installed capabilities available to Zavorth.",
...
private fun skillSourceLabel(skill: GatewaySkillSummary): String =
  when (skill.source) {
    "zavorth-bundled" -> if (skill.bundled) "Built-in" else "Bundled"
    "zavorth-managed" -> "Installed"
    "zavorth-workspace" -> "Workspace"
    "zavorth-extra" -> "Extra"
    else -> "Skill"
  }
