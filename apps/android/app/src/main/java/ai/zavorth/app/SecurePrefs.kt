...
class SecurePrefs(
  ...
  companion object {
    ...
    private const val plainPrefsName = "zavorth.node"
    private const val securePrefsName = "zavorth.node.secure"
  ...
  internal fun getNotificationForwardingPolicy(appPackageName: String): NotificationForwardingPolicy {
    ...
    // Always block Zavorth's own notifications in blocklist mode to prevent forwarding loops.
