 ...
 *
 * Phase 8 / 8.1 / 8.2: Work / Review / Proof / Channels / Sessions / Cron / Agents /
...
export function initControlPages() {
  // Phase 8 / 8.1 / 8.2: React islands for Work / Review / Proof / Channels /
  ...
  // mounted via React islands (Phase 8 / 8.1 / 8.2)
  ...
  // sector-agents + sector-skills: mounted via React islands (Phase 8.2)
  ...
  // sector-config: mounted via React islands (Phase 8.2)
  ...
  // sector-cron: mounted via React islands (Phase 8.1)
