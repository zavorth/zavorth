...
const CONTROL_SURFACE_I18N: Partial<Record<SupportedControlLocale, Record<string, string>>> = {
  'pt-BR': {
    ...
    Live: 'Ao vivo',
    Readiness: 'Prontidão',
    'Risk budget · unavailable': 'Orçamento de risco · indisponível',
    ...
    'Open a patch or artifact with unified-diff text to review hunks here.':
      'Abra um patch ou artefato com diff unificado para revisar trechos aqui.',
...
const STRINGS: Partial<Record<SupportedControlLocale, Record<string, string>>> = {
  'pt-BR': mergeSurfaceI18n('pt-BR', {
    ...
    'Workflows, conversations, about you, and project knowledge.':
      'Fluxos, conversas, sobre você e conhecimento do projeto.',
    'Hub unavailable. Run zavorth knowledge status on this machine.':
      'Hub indisponível. Rode zavorth knowledge status nesta máquina.',
    Ready: 'Pronto',
    Setup: 'Configurar',
    On: 'Ligado',
    Off: 'Desligado',
    ...
    Improved: 'Melhorados',
    Promoted: 'Promovidos',
    'Top tools': 'Ferramentas principais',
    ...
    'Zavorth saves multi-tool workflows as local skill drafts; you promote when ready.':
      'O Zavorth guarda fluxos multi-tool como rascunhos locais; você promove quando quiser.',
    ...
    'skill drafts ready to promote': 'skill drafts prontos para promover',
    Workflows: 'Fluxos',
    ...
    events: 'eventos',
    'No events in this window yet.': 'Ainda sem eventos nesta janela.',
    ...
    'No workflows learned yet': 'Nenhum workflow aprendido ainda',
    'Run zavorth learn for draft counts on this machine.':
      'Rode zavorth learn para contagens de rascunhos nesta máquina.',
    'Zavorth remembers workflows, conversations, who you are, and project knowledge — each in the right store.':
      'O Zavorth lembra fluxos, conversas, quem você é e conhecimento do projeto — cada um no lugar certo.',
    ...
    'Zavorth will surface risky actions here before changing files, tools, or external state.':
      'O Zavorth mostra ações arriscadas aqui antes de alterar arquivos, ferramentas ou estado externo.',
    Review: 'Revisar',
    ...
    'Speech recognition failed. Switching to direct audio recording...':
      'Reconhecimento de voz falhou. Alternando para gravação direta de áudio...',
    'Microphone access is blocked. Allow microphone permission for this site and try again.':
      'Acesso ao microfone bloqueado. Permita o uso do microfone para este site e tente novamente.',
    'Voice is not available in this browser yet. Type or paste the transcribed text.':
      'Função de voz não disponível neste navegador. Digite ou cole o texto.',
    Send: 'Enviar',
    Artifact: 'Artefato',
    Search: 'Pesquisar',
    Ready: 'Pronto',
    ...
    'If this browser needs access, paste the local token. I will mark the runtime connected only after the local bridge confirms it.':
      'Se este navegador precisar de acesso, cole o token local. Vou marcar o runtime como conectado somente depois que a ponte local confirmar.',
    ...
    'The token is stored only in this tab sessionStorage. After validation, the top status changes to Core Unlocked.':
      'O token fica armazenado apenas no sessionStorage desta aba. Depois da validação, o status superior muda para Core desbloqueado.',
    ...
    'Use ready capabilities when they help the current task. Risky work still asks for approval.':
      'Use capacidades prontas quando ajudarem a tarefa atual. Trabalho arriscado ainda pede aprovação.',
    ...
    'Control what Zavorth may remember, which files it can read, and which agents can work alongside it.':
    ...
    'Choose Lite, Velocity, or Shield without exposing every policy field.':
      'Escolha chat, rápido ou seguro sem expor cada campo de política.',
    ...
    'Lite for chat. Velocity for trusted work. Shield for risk.':
    ...
    'Review in Shield before changing files, tools, or external state.':
      'Revise no Shield antes de alterar arquivos, ferramentas ou estado externo.',
    'Local decision selected Shield for risky or mutating work.':
      'A decisao local escolheu Shield para trabalho arriscado ou mutavel.',
    ...
    'Use web, CLI or remote chat naturally. Zavorth steps in only when a message would expose data or trigger an external action.':
      'Use web, CLI ou chat remoto naturalmente. O Zavorth interrompe apenas quando uma mensagem exporia dados ou acionaria uma acao externa.',
    'Fast chat and documents. No operating system changes.':
      'Chat e documentos rapidos. Sem alteracoes no sistema operacional.',
    ...
    'Review attempts, diffs and blocked network calls before anything is applied to your workspace.':
    ...
    'Visual or interface work is easier to review in Z-Canvas before applying changes.':
      'Trabalho visual ou de interface fica mais fácil de revisar no Z-Canvas antes de aplicar mudanças.',
    'Diff or preview work can be reviewed safely in Z-Canvas.':
      'Diffs ou previews podem ser revisados com segurança no Z-Canvas.',
    'Visual, preview, or diff work is safer in the sandbox canvas.':
      'Trabalho visual, preview ou diff fica mais seguro no canvas em sandbox.',
    ...
    'Open a sandbox preview before applying visual or file changes.':
      'Abra uma previa em sandbox antes de aplicar mudancas visuais ou em arquivos.',
  ...
  'es-AR': mergeSurfaceI18n('es-AR', {
    ...
    Reconnect: 'Reconectar',
    'The token is stored only in this tab sessionStorage. After validation, the top status changes to Core Unlocked.':
      'El token se guarda solo en el sessionStorage de esta pestaña. Después de validar, el estado superior cambia a Core desbloqueado.',
    ...
    'Local decision selected Shield for risky or mutating work.':
      'La decision local eligio Shield para trabajo riesgoso o mutable.',
    ...
    'Fast chat and documents. No operating system changes.':
      'Chat y documentos rapidos. Sin cambios en el sistema operativo.',
    'Fast diffs in trusted folders. Policy still decides execution.':
    ...
    'Models, approvals, memory scopes, and channel setup stay readable without exposing raw secrets.':
      'Modelos, aprobaciones, alcances de memoria y canales se mantienen claros sin exponer secretos.',
    ...
    'Open a sandbox preview before applying visual or file changes.':
      'Abre una vista previa en sandbox antes de aplicar cambios visuales o de archivos.',
