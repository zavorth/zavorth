...
const STRINGS: Partial<Record<SupportedControlLocale, Record<string, string>>> = {
  'pt-BR': {
    ...
    'Cancel': 'Cancelar',
    'Confirm': 'Confirmar',
    'Connecting to the core...': 'Conectando ao core...',
    ...
    'Connected to local gateway in 42ms': 'Conectado ao gateway local em 42ms',
    'Zavorth is online. The local gateway is connected.\n\nAsk naturally; I will show preview, risk and approval when an action needs it.': 'O Zavorth está online. O gateway local está conectado.\n\nPeça naturalmente; vou mostrar preview, risco e aprovação quando uma ação precisar.',
    'Zavorth is online. The local gateway is connected.\nAsk naturally; I will show preview, risk and approval when an action needs it.': 'O Zavorth está online. O gateway local está conectado.\nPeça naturalmente; vou mostrar preview, risco e aprovação quando uma ação precisar.',
  ...
  'es-AR': {
    ...
    'Cancel': 'Cancelar',
    'Confirm': 'Confirmar',
    'Connecting to the core...': 'Conectando al core...',
    'Core Protected': 'Protegido',
    'Core Unlocked': 'Listo',
    'Core Connecting': 'Conectando',
    'Core checking': 'Core verificando',
    ...
    'Connected to local gateway in 42ms': 'Conectado al gateway local en 42ms',
    'Zavorth is online. The local gateway is connected.\n\nAsk naturally; I will show preview, risk and approval when an action needs it.': 'Zavorth está online. El gateway local está conectado.\n\nPide naturalmente; mostraré preview, riesgo y aprobación cuando una acción lo necesite.',
    'Zavorth is online. The local gateway is connected.\nAsk naturally; I will show preview, risk and approval when an action needs it.': 'Zavorth está online. El gateway local está conectado.\nPide naturalmente; mostraré preview, riesgo y aprobación cuando una acción lo necesite.',
