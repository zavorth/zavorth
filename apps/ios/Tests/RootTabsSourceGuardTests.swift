...
struct RootTabsSourceGuardTests {
    @Test func `hidden sidebar reveal uses destination header without reserved rail`() throws {
        ...
        #expect(componentSource.contains("ZavorthSidebarHeaderLeadingSlot"))
    ...
    @Test func `sidebar keeps navigation model destination only`() throws {
        ...
        #expect(source.contains("ZavorthProMark(size: 30"))
        #expect(source.contains("Text(\"Zavorth\")"))
    ...
    @Test func `sidebar routes use destination headers instead of repeated product branding`() throws {
        ...
        #expect(!sidebarDetail.contains("headerTitle: \"Zavorth\""))
        #expect(agentOverviewSource.contains("ZavorthAdaptiveHeaderRow("))
        #expect(agentOverviewSource.contains("title: self.headerTitle"))
        #expect(!agentOverviewSource.contains("Text(\"Zavorth\")"))
        #expect(docsSource.contains("ZavorthAdaptiveHeaderRow("))
        #expect(docsSource.contains("title: \"Docs\""))
        #expect(!docsSource.contains("Text(\"Zavorth Docs\")"))
    }
    ...
    @Test func `agents direct route keeps single sidebar control`() throws {
        ...
        #expect(nodesSource.contains("ZavorthSidebarHeaderLeadingSlot(action: headerLeadingAction)"))
        #expect(dreamingSource.contains("ZavorthSidebarHeaderLeadingSlot(action: headerLeadingAction)"))
    }
    ...
    @Test func `routed headers use shared adaptive layout`() throws {
        ...
        #expect(componentsSource.contains("struct ZavorthAdaptiveHeaderRow<Leading: View, Accessory: View>: View"))
        ...
        #expect(featureChromeSource.contains("ZavorthAdaptiveHeaderRow("))
        #expect(docsSource.contains("ZavorthAdaptiveHeaderRow("))
        #expect(overviewSource.contains("ZavorthAdaptiveHeaderRow("))
        #expect(chatSource.contains("ZavorthAdaptiveHeaderRow("))
        #expect(agentOverviewSource.contains("ZavorthAdaptiveHeaderRow("))
        #expect(settingsSource.contains("ZavorthAdaptiveHeaderRow("))
    }
    ...
    @Test func `phone hub keeps docs as destination only`() throws {
        ...
        #expect(source.contains("ZavorthDocsScreen("))
        ...
        #expect(!source.contains("https://docs.zavorth.ai"))
    }
    ...
    @Test func `phone hub header stays task first`() throws {
        ...
        #expect(source.contains("private var phoneDetailBackAction: ZavorthSidebarHeaderAction"))
        #expect(source.contains("accessibilityLabel: \"Back to Control\""))
        #expect(source.contains("accessibilityIdentifier: \"ZavorthPhoneDetailBackButton\""))
    ...
    @Test func `activity screen stays split from task feature screens`() throws {
        ...
        #expect(!taskSource.contains("import ZavorthChatUI"))
    ...
    @Test func `routed feature chrome stays split from task feature screens`() throws {
        ...
        #expect(chromeSource.contains("ZavorthSidebarHeaderLeadingSlot(action: headerLeadingAction)"))
        #expect(chromeSource.contains("ZavorthGatewayCompactPill()"))
    ...
    @Test func `gateway settings keeps pairing trust diagnostics and tailscale actions`() throws {
        ...
        #expect(actionsSource.contains("Run /pair approve in your Zavorth chat"))
    ...
    @Test func `gateway settings preview matrix covers primary states`() throws {
        ...
        #expect(supportSource.contains("Run /pair approve in your Zavorth chat"))
    ...
    private static func proComponentsSourceURL() -> URL {
        URL(fileURLWithPath: #filePath)
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("Sources/Design/ZavorthProComponents.swift")
    }
    ...
    private static func docsSourceURL() -> URL {
        URL(fileURLWithPath: #filePath)
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("Sources/Design/ZavorthDocsScreen.swift")
    }
    ...
    private static func openClawAppSourceURL() -> URL {
        URL(fileURLWithPath: #filePath)
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("Sources/ZavorthApp.swift")
    }
    ...
    private static func sharedChatPreviewSourceURL() -> URL {
        URL(fileURLWithPath: #filePath)
            ...
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("shared/ZavorthKit/Sources/ZavorthChatUI/ChatView+Previews.swift")
    }
    ...
    private static func xcodeProjectSourceURL() -> URL {
        URL(fileURLWithPath: #filePath)
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("Zavorth.xcodeproj/project.pbxproj")
    }
