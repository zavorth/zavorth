...
struct IOSGatewayChatTransport: ZavorthChatTransport {
    static let logger = Logger(subsystem: "dev.zavorth.companion", category: "ios.chat.transport")
    ...
    static func makeChatSendParamsJSON(
        ...
        attachments: [ZavorthChatAttachmentPayload]) throws -> String
    {
        ...
        parentSessionKey: String?) async throws -> ZavorthChatCreateSessionResponse
    {
        ...
        return try JSONDecoder().decode(ZavorthChatCreateSessionResponse.self, from: res)
    }
    ...
    func requestHistory(sessionKey: String) async throws -> ZavorthChatHistoryPayload {
        ...
        return try JSONDecoder().decode(ZavorthChatHistoryPayload.self, from: res)
    }
        ...
        attachments: [ZavorthChatAttachmentPayload]) async throws -> ZavorthChatSendResponse
    {
        ...
        do {
            ...
            let decoded = try JSONDecoder().decode(ZavorthChatSendResponse.self, from: res)
