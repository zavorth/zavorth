...
struct RootTabs: View {
    ...
    private static var initialTab: AppTab {
        ...
        guard let flagIndex = arguments.firstIndex(of: "--zavorth-initial-tab") else {
            return .control
        }
    ...
    private func sidebarNavigationSplitContent(sidebarWidth: CGFloat) -> some View {
        ...
        .background(ZavorthProBackground())
    }
    ...
    private var sidebarIdentityHeader: some View {
        HStack(spacing: 10) {
            ZavorthProMark(size: 30, shadowRadius: 3)
        ...
        .accessibilityLabel("Zavorth \(self.sidebarGatewayStatusTitle)")
    }
    ...
    private var sidebarHeaderLeadingAction: ZavorthSidebarHeaderAction? {
        ...
        if self.isSidebarVisible {
            return ZavorthSidebarHeaderAction(
    ...
    private func makeHomeCanvasPayload() -> RootTabsHomeCanvasPayload {
        ...
        case .connected:
            return RootTabsHomeCanvasPayload(
                ...
                footer: "Zavorth only runs phone-side capabilities while the app is connected and permitted.")
        case .connecting:
            return RootTabsHomeCanvasPayload(
        ...
        case .error, .disconnected:
            return RootTabsHomeCanvasPayload(
                ...
                eyebrow: self.gatewayStatus == .error ? "Gateway needs attention" : "Zavorth iOS",
                ...
                agents: Array(agents.prefix(4)),
                footer:
                "Use Settings to scan a pairing QR code or paste a setup code from your Zavorth gateway.")
        }
    }
