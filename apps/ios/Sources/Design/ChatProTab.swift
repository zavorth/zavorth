...
struct ChatProTab: View {
                ...
                VStack(spacing: 0) {
                    ...
                    if let viewModel {
                        ZavorthChatView(
                            ...
                            assistantAvatarTint: ZavorthBrand.accent,
                    ...
                    Circle()
                        .fill(
                            LinearGradient(
                                colors: [
                                    ZavorthBrand.accent,
                                    ZavorthBrand.accentHot,
                                ],
                                startPoint: .topLeading,
                                endPoint: .bottomTrailing)))
                .overlay(Circle().strokeBorder(.white.opacity(0.18), lineWidth: 1))
                .shadow(color: ZavorthBrand.accent.opacity(0.18), radius: 10, y: 5)
        } else {
            ProIconBadge(systemName: "bubble.left", color: ZavorthBrand.accent)
        }
    }
    ...
    private func syncChatViewModel() {
        ...
        guard let viewModel else {
            ...
            self.viewModel = ZavorthChatViewModel(
    ...
    private var talkControl: ZavorthChatTalkControl {
        ZavorthChatTalkControl(
