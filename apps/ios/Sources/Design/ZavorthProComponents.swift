...
struct ZavorthProBackground: View {
    ...
    var body: some View {
        ...
        shape
            ...
            .overlay {
                if self.isProminent {
                    shape.strokeBorder(
                        ZavorthBrand.accent.opacity(self.colorScheme == .dark ? 0.12 : 0.07),
                        lineWidth: 1)
                        .padding(1)
                }
            }
...
struct ZavorthSidebarRevealButton: View {
    let headerAction: ZavorthSidebarHeaderAction

    init(action: ZavorthSidebarHeaderAction) {
...
struct ZavorthSidebarHeaderLeadingSlot: View {
    let action: ZavorthSidebarHeaderAction

    var body: some View {
        ZavorthSidebarRevealButton(action: self.action)
            .frame(width: 44, height: 44, alignment: .center)
    }
}

struct ZavorthAdaptiveHeaderRow<Leading: View, Accessory: View>: View {
    let title: String
    let subtitle: String
...
struct ZavorthProMark: View {
    ...
    var body: some View {
        Image("ZavorthIcon")
            ...
            .shadow(color: ZavorthBrand.accent.opacity(0.18), radius: self.shadowRadius, y: self.shadowRadius / 3)
            .accessibilityLabel("Zavorth")
    }
}

struct ProProgressBar: View {
    let progress: Double
    var color: Color = ZavorthBrand.accentHot
...
struct ZavorthGatewayCompactPill: View {
