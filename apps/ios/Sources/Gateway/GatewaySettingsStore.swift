...
enum GatewaySettingsStore {
    private static let gatewayService = "dev.zavorth.companion.gateway"
    private static let nodeService = "dev.zavorth.companion.node"
    private static let talkService = "dev.zavorth.companion.talk"
...
enum GatewayDiagnostics {
    ...
    private static let logger = Logger(subsystem: "dev.zavorth.companion", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "dev.zavorth.companion.gateway.diagnostics")
    ...
    private static var fileURL: URL... {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first...
            .appendingPathComponent("zavorth-gateway.log")
    }
