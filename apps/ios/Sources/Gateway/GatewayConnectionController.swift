...
extension GatewayConnectionController {
    ...
    private func currentCaps() -> [String] {
        var caps = [
            ...
            ZavorthCapability.screen.rawValue,
        ]
        ...
        if voiceWakeEnabled { caps.append(ZavorthCapability.voiceWake.rawValue) }

        let locationModeRaw = UserDefaults.standard.string(forKey: "location.enabledMode") ?? "off"
        let locationMode = ZavorthLocationMode(rawValue: locationModeRaw) ?? .off
        if locationMode != .off { caps.append(ZavorthCapability.location.rawValue) }

        caps.append(ZavorthCapability.device.rawValue)
        caps.append(ZavorthCapability.talk.rawValue)
        if WatchMessagingService.isSupportedOnDevice() {
            caps.append(ZavorthCapability.watch.rawValue)
        }
        caps.append(ZavorthCapability.photos.rawValue)
        caps.append(ZavorthCapability.contacts.rawValue)
        caps.append(ZavorthCapability.calendar.rawValue)
        caps.append(ZavorthCapability.reminders.rawValue)
        if Self.motionAvailable() {
            caps.append(ZavorthCapability.motion.rawValue)
        }
    ...
    private func currentCommands() -> [String] {
        var commands: [String] = [
            ...
            ZavorthScreenCommand.record.rawValue,
            ZavorthSystemCommand.notify.rawValue,
            ZavorthChatCommand.push.rawValue,
        ...
        if caps.contains(ZavorthCapability.camera.rawValue) {
            commands.append(ZavorthCameraCommand.list.rawValue)
            commands.append(ZavorthCameraCommand.snap.rawValue)
            commands.append(ZavorthCameraCommand.clip.rawValue)
        }
        if caps.contains(ZavorthCapability.location.rawValue) {
            commands.append(ZavorthLocationCommand.get.rawValue)
        }
        if caps.contains(ZavorthCapability.device.rawValue) {
            commands.append(ZavorthDeviceCommand.status.rawValue)
            commands.append(ZavorthDeviceCommand.info.rawValue)
        }
        if caps.contains(ZavorthCapability.watch.rawValue) {
            commands.append(ZavorthWatchCommand.status.rawValue)
            commands.append(ZavorthWatchCommand.notify.rawValue)
        }
        if caps.contains(ZavorthCapability.photos.rawValue) {
            commands.append(ZavorthPhotosCommand.latest.rawValue)
        }
        if caps.contains(ZavorthCapability.contacts.rawValue) {
            commands.append(ZavorthContactsCommand.search.rawValue)
            commands.append(ZavorthContactsCommand.add.rawValue)
        }
        if caps.contains(ZavorthCapability.calendar.rawValue) {
            commands.append(ZavorthCalendarCommand.events.rawValue)
            commands.append(ZavorthCalendarCommand.add.rawValue)
        }
        if caps.contains(ZavorthCapability.reminders.rawValue) {
            commands.append(ZavorthRemindersCommand.list.rawValue)
            commands.append(ZavorthRemindersCommand.add.rawValue)
        }
        if caps.contains(ZavorthCapability.motion.rawValue) {
            commands.append(ZavorthMotionCommand.activity.rawValue)
            commands.append(ZavorthMotionCommand.pedometer.rawValue)
        }
