...
final class GatewayDiscoveryModel {
    ...
    func start() {
        ...
        for domain in ZavorthBonjour.gatewayServiceDomains {
            let browser = GatewayDiscoveryBrowserSupport.makeBrowser(
                serviceType: ZavorthBonjour.gatewayServiceType,
                domain: domain,
                queueLabelPrefix: "dev.zavorth.companion.gateway-discovery",
    ...
    private static func prettifyInstanceName(_ decodedName: String) -> String {
        ...
        let stripped = normalized.replacingOccurrences(of: " (Zavorth)", with: "")
