...
final class LiveActivityManager {
    ...
    func showConnecting(statusText: String = "Connecting...", agentName: String, sessionKey: String) {
        ...
        let attributes = ZavorthActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<ZavorthActivityAttributes>.activities
    ...
    private func end(activity: Activity<ZavorthActivityAttributes>) {
        Task {
            await activity.end(
                ActivityContent(state: self.disconnectedState(), staleDate: nil),
                dismissalPolicy: .immediate)
    ...
    private func connectingState(statusText: String = "Connecting...") -> ZavorthActivityAttributes.ContentState {
        ZavorthActivityAttributes.ContentState(
    ...
    private func attentionState(statusText: String) -> ZavorthActivityAttributes.ContentState {
        ZavorthActivityAttributes.ContentState(
            statusText: statusText,
            isIdle: false,
            isDisconnected: false,
    ...
    private func disconnectedState() -> ZavorthActivityAttributes.ContentState {
        ZavorthActivityAttributes.ContentState(
