...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: ZavorthPhotosLatestParams) async throws -> ZavorthPhotosLatestPayload {
        ...
        var results: [ZavorthPhotoPayload] = []
        ...
        return ZavorthPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> ZavorthPhotoPayload
    {
