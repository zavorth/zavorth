...
export function buildCommandCenterItems(input: CommandCenterInput): CommandCenterItem[] {
  ...
  return [
    ...settingsItems,
    {
      ...
      keywords: ['workspace', 'files', 'arquivo', 'explorer', 'projeto', 'side rail'],
      statusLabel: 'Rail',
    ...
    },
    {
      ...
      keywords: ['mcp', 'tool', 'trust', 'server', 'permissao'],
    ...
    },
    {
      ...
      keywords: ['automacao', 'scheduler', 'cron', 'recorrente', 'tarefa'],
    ...
    },
    {
      ...
      keywords: ['sessao', 'session', 'thread', 'chat', 'novo'],
      statusLabel: 'Local',
    ...
    },
    {
      ...
      keywords: ['terminal', 'shell', 'pty', 'workspace', 'comando', 'sessao'],
...
function settingsModuleToCommand(module: SettingsModule): CommandCenterItem {
  return {
    ...
    keywords: ['settings', 'configuracao', module.id, module.group, ...module.keywords],
