...
export function LemniscateLoader(props: {
  text?: string;
  size?: number;
  centered?: boolean;
}) {
  ...
  const content = (
    <div className="zvd-lemniscate-loader-container">
      <style>{`
        .zvd-lemniscate-loader-container {
          display: flex;
      ...
      <svg
        ...
        className="zvd-lemniscate-svg"
      >
        <defs>
          <linearGradient id="lemniscateGradient" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        {/* Central glowing hub */}
        <circle cx="50" cy="30" r="10" className="zvd-lemniscate-glow" style={{ transformOrigin: '50px 30px' }} />

        {/* Background track */}
        <path
          d="M 50 30 C 65 15, 85 15, 85 30 C 85 45, 65 45, 50 30 C 35 15, 15 15, 15 30 C 15 45, 35 45, 50 30 Z"
          className="zvd-lemniscate-bg"
        />

        {/* Animated tracing path */}
        <path
          d="M 50 30 C 65 15, 85 15, 85 30 C 85 45, 65 45, 50 30 C 35 15, 15 15, 15 30 C 15 45, 35 45, 50 30 Z"
          className="zvd-lemniscate-path"
        />
      </svg>

      {props.text && (
        <span className="zvd-lemniscate-text">
          {props.text}
        </span>
      )}
    </div>
