  ...
  const groups: SettingsModuleGroup[] = [
    {
      ...
      items: [
        ...
        moduleDef('pets', 'Pets', personal ? 'You' : 'Personal', 'Mascot scale, event behavior, discreet mode, notifications and reduced motion.', ['mascot', 'pet', 'size', 'animation', 'discreet', 'notifications', 'fox'], 'ready', 'Customizable'),
